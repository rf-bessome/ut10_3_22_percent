...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытияФормИСПереопределяемый.УстановитьПараметрыВыбораСвязиПараметровВыбораДоговора(ЭтаФорма, "ДоговорКонтрагента");
...
Процедура ТипХраненияПриИзменении(Элемент)
	...
	НастроитьЗакрепленнуюПлощадь(ЭтаФорма);
...
Процедура ДоговорКонтрагентаПриИзменении(Элемент)
	...
	ОчиститьДатуНомерДоговора(ЭтаФорма);
...
Процедура ДоговорКонтрагентаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиентПереопределяемый.ПриНачалеВыбораДоговораОрганизацииКонтрагента(ЭтаФорма, ДанныеВыбораДоговора, СтандартнаяОбработка, ОписаниеОповещения);
