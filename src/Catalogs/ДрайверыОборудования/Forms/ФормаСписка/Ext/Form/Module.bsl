...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВозможностьДобавленияНовыхДрайверов = НЕ Ложь И МенеджерОборудованияВызовСервераПереопределяемый.ВозможностьДобавленияНовыхДрайверов(); 
...
Процедура ДобавитьНовыйДрайверИзФайла(Команда)
	...
	Оповещение = ОписаниеОповещенияИС("ВыборФайлаДрайвераЗавершение", ЭтаФорма);
