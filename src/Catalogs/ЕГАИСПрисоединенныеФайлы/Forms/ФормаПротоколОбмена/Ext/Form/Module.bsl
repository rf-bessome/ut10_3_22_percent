...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияЕГАИС.УстановитьВидимостьКомандыВыполнитьОбмен(ЭтаФорма, "ВыполнитьОбмен");
...
Процедура ДеревоФайловВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИнтеграцияИСКлиент.ПоказатьСообщенияОперации(ЭтаФорма, "ЕГАИС", ВыбраннаяСтрока);
...
Процедура ПоказатьСообщенияXML(Команда)
	...
	ИнтеграцияИСКлиент.ПоказатьСообщенияОперации(ЭтаФорма, "ЕГАИС", Элементы.ДеревоФайлов.ТекущаяСтрока, Ложь);
...
Процедура Передать(Команда)
	...
	Если ИнтеграцияИСКлиент.ПроверитьВозможностьДействия(ЭтаФорма, "Передать", ДальнейшееДействие) Тогда
...
Процедура Отменить(Команда)
	...
	ДальнейшееДействие = Неопределено;
	Если ИнтеграцияИСКлиент.ПроверитьВозможностьДействия(ЭтаФорма, "Отменить", ДальнейшееДействие) Тогда
		ИнтеграцияЕГАИСКлиент.ПодготовитьКПередаче(
			Элементы.ДеревоФайлов.ТекущиеДанные.Документ,
			ДальнейшееДействие,
			УникальныйИдентификатор);
...
Процедура Подтвердить(Команда)
	...
	ДальнейшееДействие = Неопределено;
	Если ИнтеграцияИСКлиент.ПроверитьВозможностьДействия(ЭтаФорма, "Подтвердить", ДальнейшееДействие) Тогда
		ИнтеграцияЕГАИСКлиент.ПодготовитьКПередаче(
			Элементы.ДеревоФайлов.ТекущиеДанные.Документ,
			ДальнейшееДействие,
			УникальныйИдентификатор);
