...
Процедура ФормаЭлементаПриСозданииНаСервере(Форма) Экспорт
	...
	Если НЕ Пользователи.ЭтоПолноправныйПользователь(, Не ОбъектыРасширений)
	 ...
	 ИЛИ Не ОбъектыРасширений И ОбщегоНазначения.ЭтоПодчиненныйУзелРИБ() Тогда
...
Функция СвойстваОбъектовМетаданных(ОбъектыРасширений, СвойстваКоллекций = Неопределено)
	...
	ИменаПредопределенныхДанных = Метаданные.Справочники.ИдентификаторыОбъектовМетаданных.ПолучитьИменаПредопределенных();
...
Процедура ОбновитьСписокНовыхПодсистем(НовыеПодсистемы)
	...
	Сведения = ОбновлениеИнформационнойБазы.СведенияОбОбновленииИнформационнойБазы();
	ЕстьИзменения = Ложь;
...
Функция ОбъектыМетаданныхПоИдентификаторамБезПопыткиПовтора(Идентификаторы,
	...
	ВсегоИдентификаторов = ИдентификаторыКонфигурации.Количество();
