...
Процедура ЗагрузитьКлассификаторы(Команда)
	...
	ЗапросКлассификаторовЗавершение = Новый ОписаниеОповещения("Подключаемый_ЗапросКлассификаторовЗавершение", ЭтаФорма);
	...
	ИнтеграцияЗЕРНОСлужебныйКлиент.ОткрытьФормуЗапросаСправочника(ПараметрыФормы, ЭтаФорма, ЗапросКлассификаторовЗавершение);
