...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Попытка
		...
		ДанныеКэша = МашиночитаемыеДоверенности.ОбработкаРезультатаКлассификаторПолномочийФНС_МЧД002(ДвоичныеДанныеКлассификатора);
		
		Если ДанныеКэша <> Неопределено Тогда
			МашиночитаемыеДоверенности.ОбновитьКлассификаторПолномочийФНС_МЧД002(ДанныеКэша, ДатаПоследнегоИзменения);
		КонецЕсли;
