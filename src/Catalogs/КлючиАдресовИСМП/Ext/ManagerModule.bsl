...
Функция ТорговыеОбъектыПоКлючам(КлючиАдресов) Экспорт
	...
	ОписаниеТипов = ОпределяемыеТипы().ТорговыйОбъектИСМП.Тип;
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если СопоставленныеОбъекты.Следующий() Тогда
			...
			Если ОпределяемыеТипы().Склад.Тип.СодержитТип(ТипЗнч(СопоставленныеОбъекты.ТорговыйОбъект)) Тогда
				ТекущееЗначение.Склад = СопоставленныеОбъекты.ТорговыйОбъект;
			ИначеЕсли ОпределяемыеТипы().Подразделение.Тип.СодержитТип(ТипЗнч(СопоставленныеОбъекты.ТорговыйОбъект)) Тогда
