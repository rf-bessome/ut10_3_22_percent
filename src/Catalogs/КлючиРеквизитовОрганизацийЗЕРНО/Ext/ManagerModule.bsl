...
Функция КлючиРеквизитовПоСсылкеЗЕРНО(КлючиРеквизитовОрганизаций) Экспорт
	...
	ТаблицаОтбораКлючиРеквизитов.Колонки.Добавить("ОрганизацияКонтрагент", ОпределяемыеТипы().ОрганизацияКонтрагентГосИС.Тип);
	ТаблицаОтбораКлючиРеквизитов.Колонки.Добавить("Подразделение",         ОпределяемыеТипы().Подразделение.Тип);
