...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтаФорма, Параметры.ПараметрыНастройкиОбмена);
	...
	НастроитьЗависимыеОтВидаПродукцииЭлементыФормы(ЭтаФорма);
	ОбновитьНадписьДнейЗагрузки(ЭтаФорма);
