...
Функция НастройкиОтветственногоЗаАктуализациюТокеновАвторизации(ДляПросмотра) Экспорт
	...
	СертификатыПоОрганизациям = ИнтеграцияИС.СертификатыПользователяДляПодписиПоОрганизациям(
		ИнтеграцияИС.ДоступныеОрганизации().ВыгрузитьЗначения(), Истина);
	...
	// токены ИСМП Розница
	ДоступныеОрганизации = ИнтеграцияИС.ДоступныеОрганизации().ВыгрузитьЗначения();
