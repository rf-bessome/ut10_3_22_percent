...
Процедура ВсеРабочиеМестаПриИзменении(Элемент)
	...
	Элементы.СписокУстройств1РабочееМесто.Видимость = ВсеРабочиеМеста;
...
Процедура ВыборРабочегоМеста(Команда)
	...
	Оповещение = ОписаниеОповещенияИС("ВыборРабочегоМестаЗавершение", ЭтаФорма);
...
Процедура СписокРабочихМест(Команда)
	...
	ОткрытьФормуИС("Справочник.РабочиеМеста.ФормаСписка",,,,,,, Режим);
