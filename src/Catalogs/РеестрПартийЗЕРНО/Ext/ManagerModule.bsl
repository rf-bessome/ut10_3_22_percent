...
Функция ДеревоПартий(ПараметрыПостроения) Экспорт
	...
	ДеревоПартий.Колонки.Добавить("Номенклатура",            ОпределяемыеТипы().Номенклатура.Тип);
	ДеревоПартий.Колонки.Добавить("Характеристика",          ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	ДеревоПартий.Колонки.Добавить("Серия",                   ОпределяемыеТипы().СерияНоменклатуры.Тип);
