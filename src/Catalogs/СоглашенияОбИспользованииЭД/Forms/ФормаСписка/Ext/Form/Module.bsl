...
Процедура ОбновитьСтатусыНастроекЭДО(Команда)
	...
	ЭлектронныеДокументыСлужебныйКлиент.ОбновитьСтатусыНастроекЭД();
	Элементы.СписокСоглашенийСКонтрагентами.Обновить();
...
Процедура НастроитьОтображениеСтраницСервер()
	...
	ЭДОМеждуОрганизациями = ЭлектронныеДокументыСлужебныйВызовСервера.ПолучитьЗначениеФункциональнойОпции(
				"ИспользоватьОбменЭДМеждуОрганизациями");
	
	ОтображатьЗакладки = ЭДОМеждуОрганизациями;
