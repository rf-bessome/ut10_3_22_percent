...
Процедура ВнешнееСобытие(Источник, Событие, Данные)
	...
	СобытияФормИСКлиент.ВнешнееСобытиеПолученыШтрихкоды(
		"ПоискПоШтрихкодуЗавершение", ЭтаФорма, Источник, Событие, Данные);
...
Процедура ЗапроситьСправку1(Команда)
	...
	Иначе
		...
		ОткрытьФорму(
			...
			ПараметрыФормы,
			ЭтаФорма,,,,Новый ОписаниеОповещения("ПослеВыполненияЗапросаСправки1", ЭтаФорма),
...
Процедура ПоискПоШтрихкодуВыполнить(Команда)
	...
	ШтрихкодированиеИСКлиент.ПоказатьВводШтрихкода(
		Новый ОписаниеОповещения("ОбработатьВводШтрихкода", ЭтаФорма));
...
Процедура ПослеОбработкиМассиваШтрихкодов(РезультатОбработки)
	...
	Если РезультатОбработки.НовыеДиапазоны.Количество() > 0 Тогда
		...
		ПоказатьВопрос(Новый ОписаниеОповещения("ДобавитьДиапазоны_Подтверждение", ЭтаФорма, РезультатОбработки), ТекстСообщения, Кнопки);
	КонецЕсли;
