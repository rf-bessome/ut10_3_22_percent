...
Процедура ПродолжитьПослеПоискаШтрихкодаУпаковкиПоХешСумме(
	...
	ИспользоватьУточнениеДанных = ИнтеграцияИСПереопределяемый.ИспользоватьУточнениеДанных();
	...
	Иначе
		...
		Иначе
			...
			Если ИспользоватьУточнениеДанных Тогда
				СоздатьШтрихкодНоменклатуры(ДанныеНовойУпаковки);
			КонецЕсли;
...
Функция ПараметрыШтрихкодовУпаковокДляПечати() Экспорт
	...
	Параметры.Вставить("Номенклатура",      ОпределяемыеТипы().Номенклатура.Тип.ПривестиЗначение());
	Параметры.Вставить("Характеристика",    ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип.ПривестиЗначение());
	Параметры.Вставить("Упаковка",          ОпределяемыеТипы().Упаковка.Тип.ПривестиЗначение());
	Параметры.Вставить("Серия",             ОпределяемыеТипы().СерияНоменклатуры.Тип.ПривестиЗначение());
...
//
// Параметры:
//  ДанныеНовойУпаковки - Структура - данные упаковки
//
Процедура СоздатьШтрихкодНоменклатуры(ДанныеНовойУпаковки)
	
	РегистрыСведений.Штрихкоды.ЗаписатьШтрихкодНоменклатуры(ДанныеНовойУпаковки);
