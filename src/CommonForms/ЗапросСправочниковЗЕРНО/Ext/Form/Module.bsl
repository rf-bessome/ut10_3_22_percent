...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьТекущуюСтраницуНавигации(ЭтаФорма);
...
Процедура ТекстОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если СтрНачинаетсяС(НавигационнаяСсылкаФорматированнойСтроки, "ОткрытьРезультат") Тогда
		...
		ОткрытьФорму("ОбщаяФорма.РезультатВыполненияОбменаЗЕРНО", ПараметрыОткрытияФормы, ЭтаФорма);
...
Процедура ВидЗапросаПриИзменении(Элемент)
	...
	НастроитьЗависимыеЭлементыФормы(ЭтаФорма, "ВидЗапроса");
...
Процедура ИдентификаторыПриИзменении(Элемент)
	...
	ИнтеграцияЗЕРНОСлужебныйКлиент.ПронумероватьТаблицу(ЭтаФорма, "ИсходящиеЗапросы");
...
Процедура ЗагрузитьИзВнешнегоФайла(Команда)
	...
	ОткрытьФорму(
		...
		ЭтаФорма,,,,
		Новый ОписаниеОповещения("ОбработатьРезультатЗагрузкиИзВнешнегоФайла", ЭтаФорма));
...
Процедура ОбработатьРезультатОбменаЗЕРНО(РезультатОбмена)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПослеПолученияРезультатОбработкиЗаявки", ЭтаФорма);
	
	ИнтеграцияЗЕРНОСлужебныйКлиент.ОбработатьРезультатОбмена(РезультатОбмена, ЭтаФорма,, ОписаниеОповещения);
...
Процедура Подключаемый_ВыполнитьОбменОбработкаОжидания()
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПослеПолученияРезультатОбработкиЗаявки", ЭтаФорма);
	ИнтеграцияЗЕРНОСлужебныйКлиент.ПродолжитьВыполнениеОбмена(ЭтаФорма,, ОписаниеОповещения, Ложь);
