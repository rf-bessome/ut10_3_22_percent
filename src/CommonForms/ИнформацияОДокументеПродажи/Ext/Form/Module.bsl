...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТипыДокументПродажиИСМП.ЗагрузитьЗначения(ОпределяемыеТипы().ДокументПродажиИСМП.Тип.Типы());
	ТипыОснованиеОтгрузкаТоваровИСМП.ЗагрузитьЗначения(ОпределяемыеТипы().ОснованиеОтгрузкаТоваровИСМП.Тип.Типы());
