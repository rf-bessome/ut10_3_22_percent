...
Процедура ПодключитьМодульКриптографии(Отказ)
	...
	Если Элементы.ПровайдерЭЦП.СписокВыбора.Количество() = 0 Тогда
		Элементы.ПровайдерЭЦП.КнопкаСпискаВыбора = Ложь;
...
Процедура ЗаполнитьСпискиВыбораНаКлиенте()
	...
	УстановитьАлгоритмыПоУмолчанию();
...
&НаКлиенте
Процедура УстановитьАлгоритмыПоУмолчанию()
	...
	ИначеЕсли ПровайдерЭЦП = "Crypto-Pro GOST R 34.10-2001 Cryptographic Service Provider" Тогда
		АлгоритмПодписи = "GOST R 34.10-2001";
		АлгоритмШифрования = "GOST 28147-89";
	...
	ИначеЕсли ПровайдерЭЦП = "Signal-COM CPGOST Cryptographic Provider" Тогда
		АлгоритмПодписи = "ECR3410-CP";
		АлгоритмШифрования = "GOST28147";
		АлгоритмХеширования = "RUS-HASH-CP";
	ИначеЕсли ПровайдерЭЦП = "Microsoft Enhanced Cryptographic Provider v1.0" Тогда
		АлгоритмПодписи = "RSA_SIGN";
		АлгоритмШифрования = "RC2";
