...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияИСПереопределяемый.ЗаполнитьСлужебныеРеквизитыВКоллекции(ЭтаФорма, ОписаниеGTIN);
...
Процедура ОписаниеGTINУпаковкаПриИзменении(Элемент)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриИзмененииКоличества(ЭтаФорма, ДанныеСтроки, КэшированныеЗначения);
...
Процедура ОписаниеGTINСерияПриИзменении(Элемент)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриИзмененииСерии(
		ЭтаФорма, Элементы.ОписаниеGTIN.ТекущиеДанные, КэшированныеЗначения, ПараметрыУказанияСерий);
...
Процедура ОписаниеGTINПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	Если Не (НоваяСтрока И ОтменаРедактирования) Тогда
		...
		Если ТекущиеДанные.КоличествоПотребительскихУпаковок = 1
			...
			ПоказатьВопрос(Новый ОписаниеОповещения("ВопросИзменениеКоличества", ЭтаФорма),
...
Процедура УстановитьУсловноеОформление()
	...
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеЕдиницИзмерения(ЭтаФорма, "ОписаниеGTINЕдиницаИзмерения", "ОписаниеGTIN.Упаковка");
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтаФорма, "ОписаниеGTINХарактеристика", "ОписаниеGTIN.ХарактеристикиИспользуются");
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеСерийНоменклатуры(ЭтаФорма, "ОписаниеGTINСерия", "ОписаниеGTIN.СтатусУказанияСерий", "ОписаниеGTIN.ТипНоменклатуры");
...
Процедура НастроитьЭлементыФормыНаСервере()
	...
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСНоменклатурой(ЭтаФорма,   "ОписаниеGTINХарактеристика", "Элементы.ОписаниеGTIN.ТекущиеДанные.Номенклатура");
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСНоменклатурой(ЭтаФорма,   "ОписаниеGTINУпаковка",       "Элементы.ОписаниеGTIN.ТекущиеДанные.Номенклатура");
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСНоменклатурой(ЭтаФорма,   "ОписаниеGTINСерия",          "Элементы.ОписаниеGTIN.ТекущиеДанные.Номенклатура");
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСХарактеристикой(ЭтаФорма, "ОписаниеGTINСерия",          "Элементы.ОписаниеGTIN.ТекущиеДанные.Характеристика");
...
Процедура ВопросИзменениеКоличества(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат = "ПродолжитьВвод" Тогда
		ЭтаФорма.ТекущийЭлемент = Элементы.ОписаниеGTINКоличествоПотребительскихУпаковок;
