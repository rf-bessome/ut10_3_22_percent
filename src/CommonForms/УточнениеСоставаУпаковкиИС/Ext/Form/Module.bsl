...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСНоменклатурой(ЭтаФорма,   "ДанныеДляУточненияХарактеристика", "Элементы.ДанныеДляУточнения.ТекущиеДанные.Номенклатура");
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСНоменклатурой(ЭтаФорма,   "ДанныеДляУточненияСерия", "Элементы.ДанныеДляУточнения.ТекущиеДанные.Номенклатура");
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСХарактеристикой(ЭтаФорма, "ДанныеДляУточненияСерия", "Элементы.ДанныеДляУточнения.ТекущиеДанные.Характеристика");
...
Процедура ДанныеДляУточненияНоменклатураПриИзменении(Элемент)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ГосИС.ИСМП") Тогда
		...
		Модуль.ПриИзмененииНоменклатуры(ЭтаФорма, ТекущиеДанныеСтруктурой, Неопределено, ПараметрыУказанияСерий);
...
Процедура ДанныеДляУточненияСерияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ПараметрыУказанияСерий <> Неопределено Тогда
		...
		ИнтеграцияИСКлиент.ОткрытьПодборСерий(ЭтаФорма, ПараметрыУказанияСерий, Элемент.ТекстРедактирования, СтандартнаяОбработка, Элементы.ДанныеДляУточнения.ТекущиеДанные);
...
Процедура ОбработатьПереданныеПараметры()
	...
	ИнтеграцияИСПереопределяемый.ЗаполнитьПараметрыУказанияСерий(ПараметрыУказанияСерий, Метаданные.ОбщиеФормы.УточнениеСоставаУпаковкиИС, ЭтаФорма);
	...
	ИнтеграцияИСПереопределяемый.ЗаполнитьСлужебныеРеквизитыВКоллекции(ЭтаФорма, ДанныеДляУточнения);
...
Функция ОбновитьСтрокуТаблицы(СтрокаТаблицы, ДанныеЗаполнения, КэшированныеЗначения)
	...
	Если ТребуетсяВызовПриИзмененииНоменклатуры
		...
		Модуль.ПриИзмененииНоменклатуры(ЭтаФорма, СтрокаТаблицы, КэшированныеЗначения, ПараметрыУказанияСерий);
	КонецЕсли;
	Возврат 1;
