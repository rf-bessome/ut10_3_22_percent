...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытияФормИСКлиентСерверПереопределяемый.УстановитьПараметрыВыбораНоменклатуры(
		ЭтаФорма, ВидПродукции, "НоменклатураЧастичногоВыбытия");
		
	НастроитьЭлементыФормыНаСервере();
	СобытияФормИС.СброситьРазмерыИПоложениеОкна(ЭтаФорма);
	
	СобытияФормИСМППереопределяемый.ПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка);
	СобытияФормИС.ПрименитьУсловноеОформлениеКПолю(ЭтаФорма, "ХарактеристикаЧастичногоВыбытия");
...
Процедура ПередЗакрытием(Отказ,  СтандартнаяОбработка)
	...
	Если Модифицированность
		...
		Отказ = Истина;
		ВопросПередЗакрытиемЗавершение = Новый ОписаниеОповещения("ВопросПередЗакрытиемЗавершение", ЭтаФорма);
		ПоказатьВопрос(
...
Процедура ХарактеристикаЧастичногоВыбытияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриНачалеВыбораХарактеристики(
		Элемент, ЭтаФорма, СтандартнаяОбработка, "НоменклатураЧастичногоВыбытия");
...
Процедура ПотребительскаяУпаковкаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ВыборПотребительскойУпаковкиЗавершение = Новый ОписаниеОповещения("ВыборПотребительскойУпаковкиЗавершение", ЭтаФорма);
	
	СобытияФормИСКлиентПереопределяемый.ПриНачалеВыбораУпаковки(
		ЭтаФорма, ВладелецУпаковок, СтандартнаяОбработка, ВыборПотребительскойУпаковкиЗавершение);
...
Процедура ВариантЧастичногоВыбытияНастроеннаяНоменклатураПриИзмененииСервер()
	...
	ПеренестиСтрокуНастройкиВДанныеФормы(ЭтаФорма);
	НастроитьЭлементыФормыНаСервере();
...
Процедура НоменклатураЧастичногоВыбытияПриИзмененииСервер()
	...
	ПеренестиДанныеФормыВСтроку(ЭтаФорма);
...
Процедура ЗаполнитьПараметрыФормыПриСоздании()
	...
	Для Каждого ЭлементТип Из ОпределяемыеТипы().СборкаРазборкаЧастичноеВыбытиеИСМП.Тип.Типы() Цикл
	...
	Если ВариантЧастичногоВыбытия = Перечисления.ВариантыУчетаЧастичногоВыбытияИС.НастроеннаяНоменклатура Тогда
		...
		ИнтеграцияИСПереопределяемый.ЗаполнитьСлужебныеРеквизитыВКоллекции(ЭтаФорма, ТаблицаНастроекНоменклатуры);
...
Процедура УстановитьУсловноеОформление();
	...
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(
		ЭтаФорма, "НастройкиНоменклатурыХарактеристика", "НастройкиНоменклатуры.ХарактеристикиИспользуются");
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(
		ЭтаФорма, "НастройкиНоменклатурыХарактеристикаЧастичногоВыбытия", "НастройкиНоменклатуры.ХарактеристикиИспользуютсяЧастичноеВыбытие");
	
	//
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(
		ЭтаФорма, "ХарактеристикаЧастичногоВыбытия", "ХарактеристикиИспользуютсяЧастичногоВыбытия");
