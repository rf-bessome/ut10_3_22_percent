...
Процедура Готово(Команда)
	...
	Если УточнениеКоличестваОСУДопустимо Тогда
		...
		Если ВсегоОСУ = 0 И ДобавленоОСУ = 0 И УдаленоОСУ = 0
			И (Не УточнениеПодобранногоКоличестваМерногоТовара(ЭтаФорма)
	...
	Если УточнениеПодобранногоКоличестваМерногоТовара(ЭтаФорма)
	...
	Если УточнениеПодобранногоКоличестваМерногоТовара(ЭтаФорма)
		Или УточнениеПодобранногоКоличестваМерногоТовараОСУ(ЭтаФорма) Тогда
	...
	ПараметрыЗакрытия.Вставить("УточнениеПодобранногоКоличестваМерногоТовара", УточнениеПодобранногоКоличестваМерногоТовара(ЭтаФорма));
...
Процедура ЗаполнитьДанныеФормыПриСозданииНаСервере()
	...
	ИнтеграцияИСПереопределяемый.ЗаполнитьПараметрыУказанияСерий(ПараметрыУказанияСерий,
		Метаданные.ОбщиеФормы.ФормаУточненияПодобраннойПродукцииИСМП, ЭтаФорма);
	Количество = 1;
...
Процедура ОбновитьОтображениеПоляКоличество()
	...
	Элементы.ГруппаКоличество.Видимость = УточнениеПодобранногоКоличестваМерногоТовара(ЭтаФорма)
		Или УточнениеПодобранногоКоличестваМерногоТовараОСУ(ЭтаФорма);
...
Функция МассивЗначенийGTINДляВыбора()
	...
	Возврат ИнтеграцияИСМП.МассивЗначенийGTINДляВыбора(ПараметрыВыбора, ЭтаФорма, Ложь, ДопустимыеВидыУпаковок);
