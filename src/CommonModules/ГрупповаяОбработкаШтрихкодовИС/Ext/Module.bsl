...
Процедура УпорядочитьДанныеТСДПоРезультатамОбработкиШтрихкодов(ДанныеТСД, РезультатыОбработки, ЗаменыШтрихкодов = Неопределено) Экспорт
	...
	ТаблицаСоответствия.Колонки.Добавить("Номенклатура",   ОпределяемыеТипы().Номенклатура.Тип);
	ТаблицаСоответствия.Колонки.Добавить("Характеристика", ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	ТаблицаСоответствия.Колонки.Добавить("Серия",          ОпределяемыеТипы().СерияНоменклатуры.Тип);
	ТаблицаСоответствия.Колонки.Добавить("GTIN",           ОпределяемыеТипы().GTIN.Тип);
