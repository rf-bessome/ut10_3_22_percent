...
Функция ИменаПараметровРаботыКлиентаВыборТипаПодписиБСП() Экспорт
	...
	ВозвращаемоеЗначение.Вставить(
		"ИмяПараметраПриложения",
		"ЗЕРНО_ВыборТипаПодписиБСП");
	
	ВозвращаемоеЗначение.Вставить(
		"ЗначениеПараметраВыборТипаПодписиНеПоддерживается",
		"ИнтеграцияЗЕРНО.ВыборТипаПодписиБСП.ВыборТипаПодписиНеПоддерживается");
	ВозвращаемоеЗначение.Вставить(
		"ЗначениеПараметраВыборТипаПодписиИспользуетКонструктор",
		"ИнтеграцияЗЕРНО.ВыборТипаПодписиБСП.ВыборТипаПодписиИспользуетКонструктор");
	ВозвращаемоеЗначение.Вставить(
		"ЗначениеПараметраВыборТипаПодписиЗадаетсяПеречислением",
		"ИнтеграцияЗЕРНО.ВыборТипаПодписиБСП.ВыборТипаПодписиЗадаетсяПеречислением");
