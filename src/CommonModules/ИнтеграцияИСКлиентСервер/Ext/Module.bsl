...
Функция ДатаИзСтрокиUNIX(Знач Значение, Делитель = 1000, ПриводитьКМестномуВремени = Истина) Экспорт
	...
	ПриведениеКЧислуЗначения = ОписаниеТипаЧисло.ПривестиЗначение(Значение);
	
	Значение = '19700101' + Цел(ПриведениеКЧислуЗначения / Делитель);
...
Функция ЭтоПродукцияПодконтрольнаяВЕТИС(ВидПродукции) Экспорт
	Возврат ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПодконтрольнаяПродукцияВЕТИС")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.МолочнаяПродукцияПодконтрольнаяВЕТИС")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.МорепродуктыПодконтрольныеВЕТИС")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЗерноВЕТИС")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПродуктыПереработкиЗернаВЕТИС")
		;
КонецФункции
...
Функция ПрисутствуетВидПродукцииНабор(ВидыПродукции) Экспорт
	...
	Для Каждого ВидПродукции Из ВидыПродукции Цикл
		Если ВидПродукцииИспользуетНаборы(ВидПродукции) Тогда
			Возврат Истина;
		КонецЕсли;
	КонецЦикла;
...
Функция ПрисутствуетВидПродукцииИспользующийГрупповыеУпаковки(ВидыПродукции) Экспорт
	...
	Для Каждого ВидПродукции Из ВидыПродукции Цикл
		Если ВидПродукцииИспользуетГрупповыеУпаковки(ВидПродукции) Тогда
			Возврат Истина;
		КонецЕсли;
	КонецЦикла;
...
Функция ПрисутствуетМолочнаяПродукция(ВидыПродукции) Экспорт
	...
	Для Каждого ВидПродукции Из ВидыПродукции Цикл
		Если ЭтоМолочнаяПродукцияИСМП(ВидПродукции) Тогда
			Возврат Истина;
		КонецЕсли;
	КонецЦикла;
...
Функция КодТНВЭДДляПередачиВИСМП(Значение, ВидПродукции = Неопределено) Экспорт
	Если ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Духи") Тогда
		Возврат Значение;
	ИначеЕсли ЭтоПродукцияМОТП(ВидПродукции)
...
Функция ИспользованиеПараметровОписанияОстатковПоВидуПродукции(ВидПродукции, КодТНВЭД = Неопределено) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Духи") Тогда
		СтруктураПараметров.ИспользоватьНаименование = Истина;
	ИначеЕсли ЭтоПродукцияМОТП(ВидПродукции) Тогда
		СтруктураПараметров.ИспользоватьНаименование = Истина;
	КонецЕсли;
...
//  * Ключ - Строка - Код ошибки (7 цифр строкой)
