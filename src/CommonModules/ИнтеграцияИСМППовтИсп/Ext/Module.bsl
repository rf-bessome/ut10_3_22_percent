...
Функция ДанныеНастройкиАварийногоРежима() Экспорт
	...
	ДанныеАварийногоРежима.ДатаОкончания = 
		ИнтеграцияИСМПВызовСервера.НастройкиСканированияКодовМаркировки().АварийноеОтключенияРазрешительногоРежимаДоУниверсальнаяДата;
...
Функция КоличествоКодовВПакетеДляЗапросаСтатусов() Экспорт
	...
	КоличествоКодовВПакетеДляЗапросаСтатусов = ИнтеграцияИСМПКлиентСерверПовтИсп.НастройкиСканированияКодовМаркировки().КоличествоКодовВПакетеДляЗапросаСтатусов;
