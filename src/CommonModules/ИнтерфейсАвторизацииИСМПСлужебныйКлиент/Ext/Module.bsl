...
Процедура Подписать(Сообщения, ПараметрыЗапроса, ОповещениеПриЗавершении) Экспорт
	...
	ПодписатьЗавершение = Новый ОписаниеОповещения("ПодписатьЗавершение", интерфейсавторизацииисмпслужебныйклиент, ДанныеДляОповещения);
	ИнтеграцияИСКлиент.Подписать(ОписаниеДанных, интерфейсавторизацииисмпслужебныйклиент, ПодписатьЗавершение);
