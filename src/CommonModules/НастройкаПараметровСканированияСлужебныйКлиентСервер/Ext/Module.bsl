...
Функция ПредставлениеПараметраБезСинонима(ИмяПараметра) Экспорт
	...
	Возврат ИнтеграцияИСКлиентСервер.ПредставлениеВстроенногоИмени(ИмяПараметра);
...
Процедура ИсключитьДействующиеТоварныеГруппыОбязательногоРозничногоКонтроля(ГруппаПараметровНастройки)
	...
	ДействующиеТоварныеГруппыОбязательногоРозничногоКонтроля = ИнтеграцияИСМПВызовСервера.СписокУчитываемойПродукцииТребующейОбязательнойПроверкиПриПродажеВРозницуНаДату();
