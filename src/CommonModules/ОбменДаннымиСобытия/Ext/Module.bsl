...
Процедура МеханизмРегистрацииОбъектов(ИмяПланаОбмена,
	...
	Попытка
		...
		ОбъектМодифицирован = Объект.ДополнительныеСвойства.Свойство("ОтложеннаяЗапись") Или Объект.ДополнительныеСвойства.Свойство("ОтложенноеПроведение")
			Или ОбъектМодифицированДляПланаОбмена(Объект, ОбъектМетаданных, ИмяПланаОбмена, РежимЗаписи, ЗарегистрироватьОбъектКВыгрузке);
