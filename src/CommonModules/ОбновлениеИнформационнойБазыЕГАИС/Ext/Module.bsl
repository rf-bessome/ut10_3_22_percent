...
// Обновление до версии ЕГАИС производится здесь
...
Процедура ДокументыАктПостановкиНаБалансЕГАИСОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияЗаполнениеАкцизныхМарок() Экспорт
	...
	ДанныеКОбработке = Документы.АктПостановкиНаБалансЕГАИС.ЗарегистрироватьДанныеКОбработкеДляГенерацииАкцизныхМарок(Неопределено);
	Документы.АктПостановкиНаБалансЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок(ДанныеКОбработке);
...
Процедура ДокументыАктСписанияЕГАИСОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияЗаполнениеАкцизныхМарок() Экспорт
	...
	ДанныеКОбработке = Документы.АктСписанияЕГАИС.ЗарегистрироватьДанныеКОбработкеДляГенерацииАкцизныхМарок(Неопределено);
	Документы.АктСписанияЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок(ДанныеКОбработке);
...
Процедура ДокументыЧекЕГАИСВозвратОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияЗаполнениеАкцизныхМарок() Экспорт
	...
	ДанныеКОбработке = Документы.ЧекЕГАИСВозврат.ЗарегистрироватьДанныеКОбработкеДляГенерацииАкцизныхМарок();
	Документы.ЧекЕГАИСВозврат.ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок(ДанныеКОбработке);
...
Процедура ДокументыЧекЕГАИСОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияЗаполнениеАкцизныхМарок() Экспорт
	...
	ДанныеКОбработке = Документы.ЧекЕГАИС.ЗарегистрироватьДанныеКОбработкеДляГенерацииАкцизныхМарок(Неопределено);
	Документы.ЧекЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок(ДанныеКОбработке);
