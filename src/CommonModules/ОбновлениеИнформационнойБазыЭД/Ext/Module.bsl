...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.20.3";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыЭД.ПроверитьКонтрагентовБЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.21.3";
	Обработчик.Процедура = "Справочники.СоглашенияОбИспользованииЭД.УдалитьОтветныеТитулы";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.21.3";
	Обработчик.Процедура = "Справочники.СоглашенияОбИспользованииЭД.НастроитьАвтоПереходНаНовыеВерсииФорматовЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.22.5";
	Обработчик.Процедура = "Справочники.ПрофилиНастроекЭДО.ЗаполнитьРегламентЭДО";
	Обработчик.НачальноеЗаполнение = Ложь;

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.22.12";
	Обработчик.Процедура = "Справочники.ЭДПрисоединенныеФайлы.ЗаполнитьСвойстваЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.22.12";
	Обработчик.Процедура = "Справочники.ЭДПрисоединенныеФайлы.УстановитьСостоянияОбменЗавершен";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.23.1";
	Обработчик.Процедура = "Справочники.СертификатыЭЦП.ПеренестиОграниченияПоПользователюВСписок";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.1";
	Обработчик.Процедура = "ЭлектронныеДокументыСлужебный.ВключитьИспользованиеОзнакомленийСЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.1";
	Обработчик.Процедура = "Справочники.СоглашенияОбИспользованииЭД.ЗаполнитьВходящиеДокументыНастроек";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.1";
	Обработчик.Процедура = "РегистрыСведений.СостоянияЭД.ЗаполнитьОписаниеОснованийЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.1";
	Обработчик.Процедура = "Справочники.ЭДПрисоединенныеФайлы.ПеревестиНаНовуюАрхитектуруЭДО";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.1";
	Обработчик.Процедура = "Документы.УдалитьПроизвольныйЭД.ПеревестиНаНовуюАрхитектуруПроизвольныхЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.1";
	Обработчик.Процедура = "Документы.ПакетЭД.ПеревестиНаНовуюАрхитектуруПакетыЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.17";
	Обработчик.Процедура = "Документы.ПакетЭД.ПометитьНаУдалениеПрисоединенныеФайлыПакетовЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.21";
	Обработчик.Процедура = "Справочники.ЭДПрисоединенныеФайлы.ЗаполнитьТипЭлементаВерсииЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.23";
	Обработчик.Процедура = "Справочники.ЭДПрисоединенныеФайлы.СкорректироватьЗаписиСостоянияУПД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.25";
	Обработчик.Процедура = "Справочники.ЭДПрисоединенныеФайлы.ПеревестиНаНовуюАрхитектуруЭДО_1_1_25_25";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.29";
	Обработчик.Процедура = "Справочники.ЭДПрисоединенныеФайлы.СкорректироватьЗаписиСостоянияЭД";
	Обработчик.НачальноеЗаполнение = Ложь;

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.47";
	Обработчик.Процедура = "ЭлектронныеДокументыСлужебный.ВключитьИспользованиеОзнакомленийСЭД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.58";
	Обработчик.Процедура = "Справочники.ЭДПрисоединенныеФайлы.СинхронизироватьСостояниеЭДО";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.67";
	Обработчик.Процедура = "Документы.ЭлектронныйДокументВходящий.ПеренестиВходящиеЭлектронныеДокументы";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.67";
	Обработчик.Процедура = "Документы.ЭлектронныйДокументИсходящий.ПеренестиИсходящиеЭлектронныеДокументы";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.25.67";
	Обработчик.Процедура = "Справочники.ПакетЭДПрисоединенныеФайлы.ПеренестиДанныеПрисоединенныхФайловПакетов";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.26.12";
	Обработчик.Процедура = "Документы.ЭлектронныйДокументВходящий.ЗаполнитьНомерДокумента";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.26.18";
	Обработчик.Процедура = "Справочники.СоглашенияОбИспользованииЭД.УстановитьИспользованиеДляОтправки";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.27.7";
	Обработчик.Процедура = "Справочники.СоглашенияОбИспользованииЭД.УстановитьВариантЗаполненияКодаТовараПоУмолчанию";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.27.11";
	Обработчик.Процедура = "Справочники.ПрофилиНастроекЭДО.ДобавитьВидЭлектронногоДокумента_АктОРасхождениях";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.27.34";
	Обработчик.Процедура = "Справочники.ПрофилиНастроекЭДО.ПереименоватьДокументУчетаДляКаталогаТоваров";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: переименование документа учета для католога товаров в профилях ЭДО.'");
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.27.34";
	Обработчик.Процедура = "Справочники.СоглашенияОбИспользованииЭД.ПереименоватьДокументУчетаДляКаталогаТоваров";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: переименование документа учета для католога товаров в настройках ЭДО.'");
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.28.18";
	Обработчик.Процедура = "Справочники.ПрофилиНастроекЭДО.УстановитьТребованиеОтветнойПодписиДляТОРГ12";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.28.18";
	Обработчик.Процедура = "Справочники.СоглашенияОбИспользованииЭД.УстановитьТребованиеОтветнойПодписиДляТОРГ12";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.29.11";
	Обработчик.Процедура = "Справочники.ПрофилиНастроекЭДО.ДобавитьВидыЭлектронногоДокумента_СведенияОРеализацииЗакупкеКомиссионером";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.3";
	Обработчик.Процедура = "Справочники.ПрофилиНастроекЭДО.ДобавитьВидЭлектронногоДокумента_МашиночитаемаяДоверенность";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: добавление электронного документа вида ""Машиночитаемая доверенность"".'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.3";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыЭД.ЗаполнитьНастройкиМЧД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.5";
	Обработчик.Процедура = "Справочники.ПрофилиНастроекЭДО.ДобавитьВидЭлектронногоДокумента_ЭлектроннаяТранспортнаяНакладная";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: добавление электронного документа вида ""Электронная транспортная накладная"".'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.7";
	Обработчик.Процедура = "Справочники.ПрофилиНастроекЭДО.ДобавитьВидЭлектронногоДокумента_ЭлектронныйПутевойЛист";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: добавление электронного документа вида ""Электронный путевой лист"".'");

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.7";
	Обработчик.Процедура = "Справочники.КлассификаторПолномочийФНСМЧД002.ОбработатьДанныеДляПереходаНаНовуюВерсиюНачальноеЗаполнение";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: обновление классификатора полномочий ФНС (МЧД 002) (начальное заполнение).'");

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.7";
	Обработчик.Процедура = "Справочники.КлассификаторПолномочийФНСМЧД003.ОбработатьДанныеДляПереходаНаНовуюВерсиюНачальноеЗаполнение";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: обновление классификатора полномочий ФНС (МЧД 003) (начальное заполнение).'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.7";
	Обработчик.Процедура = "МашиночитаемыеДоверенности.ОбработатьДанныеДляПереходаНаНовуюВерсию";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: обновление машиночитаемых доверенностей.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.9";
	Обработчик.Процедура = "Справочники.ПрофилиНастроекЭДО.ДобавитьВидЭлектронногоДокумента_АктСверкиВзаиморасчетов";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: добавление электронного документа вида ""Акт сверки взаиморасчетов"".'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.11";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыЭД.ОбработатьПроверкуНовыхЭД";
	Обработчик.ОбщиеДанные  = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.1.30.15";
	Обработчик.Процедура = "Справочники.МЧД003.ОбработатьДанныеДляПереходаНаНовуюВерсию";
	Обработчик.Комментарий = НСтр("ru = 'Обмен с контрагентами: Заполнение сведений по передоверию.'");
...
Процедура ПервыйЗапуск() Экспорт
	...
	СтруктураАдресаСервераМЧД = МашиночитаемыеДоверенности.СтруктураАдресаСервераМЧД();
	МашиночитаемыеДоверенности.ЗаписатьАдресРеестраМЧД(СтруктураАдресаСервераМЧД);	
	Константы.ИспользоватьРеестрДоверенностейФНСЭДО.Установить(Истина);
...
//
// Параметры:
//  ВидыЭД - Массив, ЗначениеПеречисления - значение перечисления ВидыЭД или массив значений перечисления.
//
Процедура ОбновитьНастройкиЭДО(Знач ВидыЭД) Экспорт
	
	Если ТипЗнч(ВидыЭД) <> Тип("Массив") Тогда
		ВидЭД = ВидыЭД;
		ВидыЭД = Новый Массив;
		ВидыЭД.Добавить(ВидЭД);
	КонецЕсли;
	...
	Пока Результат.Следующий() Цикл
		...
		Для каждого ВидЭД Из ВидыЭД Цикл
			...
			Если СтрокаВидЭД <> Неопределено Тогда
				...
				Если Не ЗначениеЗаполнено(СтрокаВидЭД.ДокументУчета) Тогда
					СтрокаВидЭД.ДокументУчета = ЭлектронныеДокументыПовтИсп.ПредставлениеОснованияДляВидаЭД(СтрокаВидЭД.ИсходящийДокумент);
			...
			Если ВидЭД = Перечисления.ВидыЭД.ПроизвольныйЭД
				Или ВидЭД = Перечисления.ВидыЭД.МашиночитаемаяДоверенность Тогда
				
				ВерсияФормата = "";
			Иначе
				ВидЭДДляЗапросаФормата = ВидЭД;
				Если ВидЭД = Перечисления.ВидыЭД.АктЗаказчик Тогда
					ВидЭДДляЗапросаФормата = Перечисления.ВидыЭД.АктИсполнитель;
				КонецЕсли;
				Если ВидЭД = Перечисления.ВидыЭД.ТОРГ12Покупатель Тогда
					ВидЭДДляЗапросаФормата = Перечисления.ВидыЭД.ТОРГ12Продавец;
				КонецЕсли;
				Если ВидЭД = Перечисления.ВидыЭД.СоглашениеОбИзмененииСтоимостиПолучатель Тогда
					ВидЭДДляЗапросаФормата = Перечисления.ВидыЭД.СоглашениеОбИзмененииСтоимостиОтправитель;
				КонецЕсли;
				ВерсияФормата = ЭлектронныеДокументыСлужебный.АктуальнаяВерсияФорматаЭД(ВидЭДДляЗапросаФормата);
			...
			Если НоваяСтрока.ИсходящийДокумент = Перечисления.ВидыЭД.АктОРасхождениях Тогда
			...
			Если НоваяСтрока.ИсходящийДокумент = Перечисления.ВидыЭД.СведенияОРеализацииКомиссионером Тогда
				НоваяСтрока.Приоритет = 17;
				НоваяСтрока.ТребуетсяОтветнаяПодпись = Ложь;
			ИначеЕсли НоваяСтрока.ИсходящийДокумент = Перечисления.ВидыЭД.СведенияОЗакупкеКомиссионером Тогда
				НоваяСтрока.Приоритет = 18;
				НоваяСтрока.ТребуетсяОтветнаяПодпись = Ложь;
			ИначеЕсли НоваяСтрока.ИсходящийДокумент = Перечисления.ВидыЭД.КорректировкаСведенийОРеализацииКомиссионером Тогда
				НоваяСтрока.Приоритет = 19;
				НоваяСтрока.ТребуетсяОтветнаяПодпись = Ложь;
			ИначеЕсли НоваяСтрока.ИсходящийДокумент = Перечисления.ВидыЭД.КорректировкаСведенийОЗакупкеКомиссионером Тогда
				НоваяСтрока.Приоритет = 20;
				НоваяСтрока.ТребуетсяОтветнаяПодпись = Ложь;
			КонецЕсли;
			
			Если Не ЗначениеЗаполнено(НоваяСтрока.ДокументУчета) Тогда
				НоваяСтрока.ДокументУчета = ЭлектронныеДокументыПовтИсп.ПредставлениеОснованияДляВидаЭД(НоваяСтрока.ИсходящийДокумент);
			КонецЕсли;
		...
		Если ЗаписатьОбъект Тогда
			ИскомыйПрофильНастройек.ОбменДанными.Загрузка = Истина;
	...
	|			ИЛИ СоглашенияОбИспользованииЭД.СпособОбменаЭД = ЗНАЧЕНИЕ(Перечисление.СпособыОбменаЭД.ЧерезСервис1СЭДО)
	...
	ТаблицаВходящих = ЭлектронныеДокументыСлужебный.ТаблицаПредопределенногоПрофиля("ПервоначальноеЗаполнение");
	...
	Пока Результат.Следующий() Цикл
		...
		Для каждого ВидЭД Из ВидыЭД Цикл
			...
			ИначеЕсли Не ЗначениеЗаполнено(СтрокаВидЭД.ДокументУчета) Тогда
				СтрокаВидЭД.ДокументУчета = ЭлектронныеДокументыПовтИсп.ПредставлениеОснованияДляВидаЭД(СтрокаВидЭД.ИсходящийДокумент);
				ЗаписатьОбъект = Истина;
			КонецЕсли;
			
			// Входящие.
			СтрокаВходящие = ИскомаяНастройка.ВходящиеДокументы.Найти(ВидЭД, "ВходящийДокумент");
			Если СтрокаВходящие = Неопределено Тогда
				
				СтрокаПоУмолчанию = ТаблицаВходящих.Найти(ВидЭД, "ВходящийДокумент");
				Если СтрокаПоУмолчанию <> Неопределено Тогда
					СтрокаВходящие = ИскомаяНастройка.ВходящиеДокументы.Добавить();
					ЗаполнитьЗначенияСвойств(СтрокаВходящие, СтрокаПоУмолчанию);
					ЗаписатьОбъект = Истина;
				КонецЕсли;
		...
		Если ЗаписатьОбъект Тогда
			ОбновлениеИнформационнойБазы.ЗаписатьДанные(ИскомаяНастройка);
		КонецЕсли;
	...
	Пока Результат.Следующий() Цикл
		...
		Если ЗаписатьОбъект Тогда
			ИскомыйСертификат.ОбменДанными.Загрузка = Истина;
...
// Обработчик заполнения настроек МЧД.
//
Процедура ЗаполнитьНастройкиМЧД() Экспорт
...
Процедура ПроверитьКонтрагентовБЭД() Экспорт
	...
	Если НЕ ЭтоОбновлениеИБВМоделиСервиса
		...
		ЭлектронныеДокументыСлужебный.ПроверитьНепроверенныхКонтрагентов(ЭтоОбновлениеИБВМоделиСервиса);
	КонецЕсли;
	
КонецПроцедуры

// Обработчик проверки рег задания НаличиеНовыхЭД.
//
Процедура ОбработатьПроверкуНовыхЭД() Экспорт
	
	ЗаданиеНаличиеНовыхЭД = РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.НаличиеНовыхЭД);
	Если Не ЗаданиеНаличиеНовыхЭД.Использование Тогда
		Возврат;
	КонецЕсли;
	...
	Если Не Результат.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Если ЭлектронныеДокументыСлужебный.УведомленияПодключены(ИдентификаторОрганизации) Тогда
				Возврат;
			КонецЕсли;	
		КонецЦикла;
	КонецЕсли;
	...
	ЗаданиеНаличиеНовыхЭД.Использование = Ложь;
	ЗаданиеНаличиеНовыхЭД.Записать();
