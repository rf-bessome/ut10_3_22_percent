...
Процедура ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры) Экспорт
	...
	Если Не ЭтоВерсияЗащищенногоПрограммногоКомплекса(ВерсияПлатформы) Тогда
		...
		ИначеЕсли ВерсияПлатформыБезНомераСборки = "8.3.17" Тогда
			ВерсияПлатформы = "8.3.17.2757";
			ОбщиеПараметры.РаботаВПрограммеЗапрещена = Истина;
		ИначеЕсли ВерсияПлатформыБезНомераСборки = "8.3.18" Тогда
			ВерсияПлатформы = "8.3.18.1957";
			ОбщиеПараметры.РаботаВПрограммеЗапрещена = Истина;
		ИначеЕсли ВерсияПлатформыБезНомераСборки = "8.3.19" Тогда
			ВерсияПлатформы = "8.3.19.1723";
			ОбщиеПараметры.РаботаВПрограммеЗапрещена = Истина;
		ИначеЕсли ВерсияПлатформыБезНомераСборки = "8.3.20" Тогда
			ВерсияПлатформы = "8.3.20.2180";
			ОбщиеПараметры.РаботаВПрограммеЗапрещена = Истина;
		ИначеЕсли ВерсияПлатформыБезНомераСборки = "8.3.21" Тогда
			ВерсияПлатформы = "8.3.21.1622";
			ОбщиеПараметры.РаботаВПрограммеЗапрещена = Истина;
		ИначеЕсли ВерсияПлатформыБезНомераСборки = "8.3.22" Тогда
			ВерсияПлатформы = "8.3.22.1704";
			ОбщиеПараметры.РаботаВПрограммеЗапрещена = Истина;
		КонецЕсли;
		
	КонецЕсли;
	
	НерекомендуемыеВерсииПлатформы = НедопустимыеВерсииПлатформы();
	
	Если СтрНайти(НерекомендуемыеВерсииПлатформы, СистемнаяИнформация.ВерсияПриложения) Тогда
		ОбщиеПараметры.ИспользуетсяНедопустимаяВерсияПлатформы = Истина;
...
Процедура ПриДобавленииПараметровРаботыКлиента(Параметры) Экспорт
	...
	ИнтеграцияЗЕРНО.ПриДобавленииПараметровРаботыКлиента(Параметры);
		
КонецПроцедуры

Функция НедопустимыеВерсииПлатформы() Экспорт
	
	Возврат "8.3.17.2733; 8.3.17.2665; 8.3.18.1902; 8.3.18.1894; 8.3.19.1665; 8.3.19.1659; 8.3.20.2076; 8.3.20.2039; 8.3.21.1607; 8.3.21.1508; 8.3.21.1484; 8.3.22.1672; 8.3.22.1603";
