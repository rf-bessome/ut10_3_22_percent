...
Процедура НачатьПодключениеУстройства(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ДополнительныеПараметры) Экспорт
	...
	ОповещениеПриУстановкеПараметров = ОписаниеОповещенияИС("НачатьПодключениеУстройства_УстановкаПараметровЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПодключениеУстройства_УстановкаПараметровЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ОповещениеПолучитьОписаниеЗавершение = ОписаниеОповещенияИС("НачатьПодключениеУстройства_ПолучитьОписаниеЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка
	...
	Исключение
		...
		Если ДополнительныеПараметры.ОповещениеПриЗавершении <> Неопределено Тогда
			...
			ВыполнитьОбработкуОповещенияИС(ДополнительныеПараметры.ОповещениеПриЗавершении, Результат);
		КонецЕсли;
	КонецПопытки;
...
Процедура НачатьПодключениеУстройства_ПолучитьОписаниеЗавершение(РезультатВыполнения, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	ОповещениеПодключитьЗавершение = ОписаниеОповещенияИС("НачатьПодключениеУстройства_ПодключитьЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка
...
Процедура НачатьПодключениеУстройства_ПодключитьЗавершение(РезультатВыполнения, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	Если НЕ РезультатВыполнения Тогда
		...
		ОповещениеПодключитьЗавершение = ОписаниеОповещенияИС("ПолучениеОшибкиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
		Попытка
	...
	Иначе
		...
		Если ПараметрыПодключения.ТипОборудования = "ПринтерЧеков" 
			...
			ОповещениеЗавершение = ОписаниеОповещенияИС("НачатьПодключениеУстройства_ПолучениеШириныСтрокиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОтключениеУстройства(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры) Экспорт
	...
	ОповещениеМетода = ОписаниеОповещенияИС("НачатьОтключениеУстройства_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ПараметрыКоманды);
	...
	Исключение
		...
		Если ОповещениеПриЗавершении <> Неопределено Тогда
			Результат = Новый Структура("Результат, ВыходныеПараметры", Ложь, ВыходныеПараметры);
			ВыполнитьОбработкуОповещенияИС(ОповещениеПриЗавершении, Результат);
		КонецЕсли;
	КонецПопытки;
...
Процедура ВыполнениеМетодаЗавершение(РезультатВыполнения, Параметры, ДополнительныеПараметры) Экспорт
	...
	Иначе
		ОписаниеОшибки = "";
		ОповещениеПриОшибке = ОписаниеОповещенияИС("ПолучениеОшибкиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПолучениеШириныСтроки(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры) Экспорт 
	...
	Попытка
		Оповещение = ОписаниеОповещенияИС("ВыполнениеМетодаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьАннулированиеЧека(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТипЧека, ФискальныйЧек, ВходныеПараметры, ВыходныеПараметры);
	...
	Если ПараметрыПодключения.ТипОборудования = "ФискальныйРегистратор" Тогда
		...
		Оповещение = ОписаниеОповещенияИС("НачатьАннулированиеЧека_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьТекста(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, СтрокаТекста, ВыходныеПараметры) Экспорт
	...
	ИначеЕсли ПараметрыПодключения.ТипОборудования = "ФискальныйРегистратор" Тогда
		Оповещение = ОписаниеОповещенияИС("НачатьПечатьТекста_ОткрытиеЧекаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьЧекаКоррекции(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВходныеПараметры, ВыходныеПараметры) Экспорт
	...
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьПечатьЧекаКоррекции_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОперациюСоСменой_ПослеПолучениеПараметровККТ(РезультатВыполнения, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВыполнения.Результат Тогда
		...
		Попытка
			...
			Оповещение = ОписаниеОповещенияИС("НачатьОперациюСоСменой_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	...
	Иначе
		Если ДополнительныеПараметры.ОповещениеПриЗавершении <> Неопределено Тогда
			ВыполнитьОбработкуОповещенияИС(ДополнительныеПараметры.ОповещениеПриЗавершении, РезультатВыполнения);
		КонецЕсли;        
	КонецЕсли;
...
Процедура НачатьОткрытиеСмены(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВходныеПараметры, ВыходныеПараметры)
	...
	Если ПараметрыПодключения.ТипОборудования = "ККТ" Тогда
		...
		Оповещение = ОписаниеОповещенияИС("НачатьОперациюСоСменой_ПослеПолучениеПараметровККТ", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	...
	ИначеЕсли ПараметрыПодключения.ТипОборудования = "ФискальныйРегистратор"  Тогда
		Попытка
			Оповещение = ОписаниеОповещенияИС("НачатьОткрытиеСмены_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПолучениеТекущееСостояние(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ПараметрыСостояния = "";
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьПолучениеТекущееСостояние_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПолучениеПараметровККТ(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВходныеПараметры, ВыходныеПараметры);
	...
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьПолучениеПараметровККТ_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьФискализациюЧека(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВходныеПараметры, ВыходныеПараметры) Экспорт
	...
	Если ПараметрыПодключения.ТипОборудования = "ФискальныйРегистратор" Тогда
		...
		Иначе
			Оповещение = ОписаниеОповещенияИС("НачатьПечатьЧекаПоШаблону_ОткрытиеЧекаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	...
	ИначеЕсли ПараметрыПодключения.ТипОборудования = "ККТ" Тогда 
		...
		Оповещение = ОписаниеОповещенияИС("НачатьФискализациюЧека_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
		Попытка
...
Процедура НачатьПечатьЧекаПоШаблону_ПечатьСтрокиЗавершение(РезультатВыполнения, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВыполнения.Результат Или ДополнительныеПараметры.ПечатьШтрихкода Тогда
		...
		Оповещение = ОписаниеОповещенияИС("НачатьПечатьЧекаПоШаблону_ПечатьСтрокиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьТекста_ПечатьСтрокиЗавершение(РезультатВыполнения, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВыполнения.Результат Или ДополнительныеПараметры.ПечатьШтрихкода Тогда
		...
		Оповещение = ОписаниеОповещенияИС("НачатьПечатьТекста_ПечатьСтрокиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОткрытиеЧека(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТипЧека, ФискальныйЧек, ВыходныеПараметры) Экспорт
	...
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьОткрытиеЧека_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьЗакрытиеЧека(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТаблицаОплат, ВыходныеПараметры) Экспорт
	...
	ДополнительныеПараметры.Вставить("ОчисткаПараметров"      , Ложь);
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьПечать_ПечатьЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечать_ПечатьЗавершение(РезультатВыполнения, Параметры, ДополнительныеПараметры) Экспорт
	...
	Иначе
		ОписаниеОшибки = "";
		ОповещениеПриОшибке = ОписаниеОповещенияИС("НачатьПечать_ОшибкаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
		ДополнительныеПараметры.ОбъектДрайвера.НачатьВызовПолучитьОшибку(ОповещениеПриОшибке, ОписаниеОшибки);
	КонецЕсли;
...
Процедура НачатьПечать_ОшибкаЗавершение(РезультатВыполнения, Параметры, ДополнительныеПараметры) Экспорт
	...
	Оповещение = ОписаниеОповещенияИС("НачатьПечать_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьКвитанцийНаТерминале(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьПечатьКвитанцийНаТерминале_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьФормированиеИтоговДняПоКартам(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры);
	...
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьФормированиеИтоговДняПоКартам_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОплатуПлатежнойКартой(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения,
	...
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьОперациюПоКарте_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОтменуПреавторизацииПоПлатежнойКарте(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения,
	...
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьОперациюПоКарте_ЗавершениеБезПараметров", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьВыгрузкуТаблицы(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТаблицаВыгрузки, ПолнаяВыгрузка, ВыходныеПараметры)
	...
	Попытка
		...
		ОповещениеПриЗавершении = ОписаниеОповещенияИС("НачатьВыгрузкуТаблицы_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьЗагрузкуТаблицы(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	Попытка
		...
		ДополнительныеПараметры.Вставить("ВыходныеПараметры"      , ВыходныеПараметры);
		ДополнительныеПараметры.Вставить("ОповещениеПриЗавершении", ОповещениеПриЗавершении);
		ОповещениеПриЗавершении = ОписаниеОповещенияИС("НачатьЗагрузкуТаблицы_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОчисткуТаблицу(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	Попытка
		...
		ДополнительныеПараметры.Вставить("ВыходныеПараметры"      , ВыходныеПараметры);
		ДополнительныеПараметры.Вставить("ОповещениеПриЗавершении", ОповещениеПриЗавершении);
		ОповещениеПриЗавершении = ОписаниеОповещенияИС("ВыполнениеМетодаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьВыгрузкуТоваровВВесы(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТаблицаВыгрузки, ЧастичнаяВыгрузка, ВыходныеПараметры)
	...
	Попытка
		...
		МенеджерОборудованияКлиент.СостояниеПроцесса(НСтр("ru='Выгрузка данных...'"), Окр(ТекущийПакет * ПроцентИнкремент));
		Оповещение = ОписаниеОповещенияИС("НачатьВыгрузкуТоваровВВесы_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьЭтикеток(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ШаблонЭтикетки, МассивЭтикеток, ВыходныеПараметры)
	...
	Попытка
		...
		Оповещение = ОписаниеОповещенияИС("НачатьПечатьЭтикеток_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПолучениеВерсииДрайвера(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры) Экспорт
	...
	ПараметрыКоманды.Вставить("ПараметрыПодключения"   , ПараметрыПодключения);
	ПараметрыКоманды.Вставить("ВыходныеПараметры"      , ВыходныеПараметры);
	ОповещениеМетода = ОписаниеОповещенияИС("НачатьПолучениеВерсииДрайвера_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ПараметрыКоманды);
...
Процедура НачатьУстановкуПараметров_Завершение(РезультатВыполнения, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	Если ДополнительныеПараметры.ПараметрыДляУстановки.Количество() > 0  Тогда
		Для Каждого Параметр Из ДополнительныеПараметры.ПараметрыДляУстановки Цикл
			...
			ОповещениеМетода = ОписаниеОповещенияИС("НачатьУстановкуПараметров_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	...
	Иначе
		Если ДополнительныеПараметры.ОповещениеПриУстановкеПараметров <> Неопределено Тогда
			ВыполнитьОбработкуОповещенияИС(ДополнительныеПараметры.ОповещениеПриУстановкеПараметров, ДополнительныеПараметры);
		КонецЕсли;   
	КонецЕсли;
...
Процедура НачатьТестУстройства(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ОповещениеПриУстановкеПараметров = ОписаниеОповещенияИС("НачатьТестУстройства_УстановкаПараметровЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	НачатьУстановкуПараметров(ОповещениеПриУстановкеПараметров, ДополнительныеПараметры);
...
Процедура НачатьТестУстройства_УстановкаПараметровЗавершение(Результат, Параметры) Экспорт
	...
	Попытка
		Оповещение = ОписаниеОповещенияИС("НачатьТестУстройства_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", Параметры);
	...
	Исключение
		...
		Если Параметры.ОповещениеПриЗавершении <> Неопределено Тогда
			Результат = Новый Структура("Результат, ВыходныеПараметры", Ложь, ВыходныеПараметры);
			ВыполнитьОбработкуОповещенияИС(Параметры.ОповещениеПриЗавершении, Результат);
		КонецЕсли;
	КонецПопытки;
...
Процедура НачатьВыполнитьДополнительноеДействие(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ИмяДействия, ВыходныеПараметры);
	...
	ОповещениеПриУстановкеПараметров = ОписаниеОповещенияИС("НачатьВыполнитьДополнительноеДействие_УстановкаПараметровЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	НачатьУстановкуПараметров(ОповещениеПриУстановкеПараметров, ДополнительныеПараметры);
...
Процедура НачатьВыполнитьДополнительноеДействие_УстановкаПараметровЗавершение(Результат, Параметры) Экспорт
	...
	ОповещениеЗавершение = ОписаниеОповещенияИС("НачатьВыполнитьДополнительноеДействие_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", Параметры);
	Попытка
...
Процедура НачатьВыполнитьДополнительноеДействие_Завершение(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВызова Тогда
		...
		КонецЕсли;
	Иначе
		ОповещениеПриЗавершении = ОписаниеОповещенияИС("ПолучениеОшибкиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
		Попытка
			ТекстОшибки = "";
...
Процедура НачатьПолучениеОписаниеДрайвера(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ОповещениеМетода = ОписаниеОповещенияИС("НачатьПолучениеОписаниеДрайвера_ПолучитьНомерВерсииЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ПараметрыКоманды);
	Попытка
		ОбъектДрайвера.НачатьВызовПолучитьНомерВерсии(ОповещениеМетода);
	Исключение
...
Процедура НачатьПолучениеОписаниеДрайвера_ПолучитьНомерВерсииЗавершение(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	ОповещениеМетода = ОписаниеОповещенияИС("НачатьПолучениеОписаниеДрайвера_ПолучитьОписаниеЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка
...
Процедура НачатьПолучениеОписаниеДрайвера_ПолучитьОписаниеЗавершение(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	ПараметрыДрайвера = "";
	ОповещениеМетода = ОписаниеОповещенияИС("НачатьПолучениеОписаниеДрайвера_ПолучитьПараметрыЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка
...
Процедура НачатьПолучениеОписаниеДрайвера_ПолучитьПараметрыЗавершение(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	ОповещениеМетода = ОписаниеОповещенияИС("НачатьПолучениеОписаниеДрайвера_ПолучитьДополнительныеДействияЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка                                    
