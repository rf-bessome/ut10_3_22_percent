...
Процедура ЗаполнитьОтчетОбОперациях(ПараметрыОтчета, Контейнер) Экспорт
	...
	Запрос.УстановитьПараметр("Организация", 
		Новый ФиксированныйМассив(ПараметрыОтчета.Организация));
	...
	|	ПрослеживаемыеОперации.Номенклатура КАК Номенклатура,
	|	СУММА(ПрослеживаемыеОперации.Количество) КАК Количество,
	|	МАКСИМУМ(ПрослеживаемыеОперации.СуммаБезНДС) КАК СуммаБезНДС,
	...
	|	СведенияОНоменклатуре.КодТНВЭД КАК КодТНВЭД,
	|	СведенияОНоменклатуре.КодОКПД2 КАК КодОКПД2,
	|	СведенияОНоменклатуре.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	...
	|	ПрослеживаемыеОперации.Номенклатура,
	...
	|	СведенияОНоменклатуре.КодТНВЭД,
	|	СведенияОНоменклатуре.КодОКПД2,
			...
			Пока ВыборкаКодОперации.Следующий() Цикл
				...
				Пока ВыборкаКонтрагент.Следующий() Цикл
					...
					Пока ВыборкаНоменклатура.Следующий() Цикл
						...
						СтруктураДанныхОперации.Вставить("П1000002", ВыборкаНоменклатура.ДатаОперации);
						СтруктураДанныхОперации.Вставить("П1000003", ВыборкаНоменклатура.КодОперации);
						СтруктураДанныхОперации.Вставить("П1000004", ВыборкаНоменклатура.КодТипаДокументаВПрослеживаемости);
						СтруктураДанныхОперации.Вставить("П1000005", ВыборкаНоменклатура.НомерДокумента);
						СтруктураДанныхОперации.Вставить("П1000006", ВыборкаНоменклатура.ДатаДокумента);
						СтруктураДанныхОперации.Вставить("П1000007", ВыборкаНоменклатура.НаименованиеКонтрагента);
						СтруктураДанныхОперации.Вставить("П1000008", ВыборкаНоменклатура.ИНН);
						СтруктураДанныхОперации.Вставить("П1000009", ВыборкаНоменклатура.КПП);
						...
						ВыборкаРНПТ = ВыборкаНоменклатура.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
...
Процедура ПолучитьСведенияОПоказателяхОтчетаОбОперациях(ПоказателиОтчета) Экспорт
	...
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1000010", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1000011", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1000012", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1000013", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1000014", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1000015", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1000016", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1100017", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1100018", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П1100019", Истина, Ложь);
