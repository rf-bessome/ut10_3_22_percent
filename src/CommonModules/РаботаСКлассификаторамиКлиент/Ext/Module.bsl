...
//
Процедура ОбновитьКлассификаторы() Экспорт // Проверено
...
//
Функция ИмяСобытияОповещенияОЗагрузки() Экспорт  // Проверено
...
//
Процедура ИнтернетПоддержкаИСервисы_ОбработкаОповещения(Форма, ИмяСобытия, Параметр, Источник) Экспорт  // Проверено
...
//
Процедура ИнтернетПоддержкаИСервисы_ОбновлениеКлассификаторов(Форма, Команда) Экспорт // Провереео
...
Процедура ИнтернетПоддержкаИСервисы_БИПФайлКлассификаторовНачалоВыбора(
			...
			Элемент,
			ДанныеВыбора,
			СтандартнаяОбработка) Экспорт // Проверено
...
//
Функция ВерсииКлассификаторовВФайле(ИмяФайла) Экспорт  // Проверено
	
	#Если Не ВебКлиент Тогда
	
	ВерсииКлассификаторов = Новый Массив;
	
	Если ПроцедурыОбменаДанными.ПолучитьРасширениеИмениФайла(ИмяФайла) <> "zip" Тогда
...
//
Процедура ФайлКлассификаторовПослеВыбораФайла(ВыбранныеФайлы, ДополнительныеПараметры) Экспорт  // Проверено
...
//
Процедура ПриОтветеНаВопросПодключенияИнтернетПоддержки(Результат, ДополнительныеПараметры) Экспорт  // Проверено
...
//
Процедура ПослеПодключенияИнтернетПоддержки(Результат, ДополнительныеПараметры) Экспорт   // Проверено
...
//
Процедура ПриИзмененииРасписания(Расписание, Форма) Экспорт // Проверено
...
//  Строка - имя события.
//
Функция ИмяСобытияЖурналаРегистрации() Экспорт // Проверено
