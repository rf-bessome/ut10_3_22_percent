...
//
Функция ФайлИмеетРасширениеИзображения(Знач ИмяФайла) Экспорт
	
	РасширенияИзображения = "BMP,DIB,RLE,JPG,JPEG,TIF,GIF,PNG,ICO,WMF,EMF";
	
	Возврат Найти(РасширенияИзображения, ВРег(ПолучитьРасширениеФайла(ИмяФайла))) > 0;
	
КонецФункции // ФайлИмеетРасширениеИзображения
...
Функция ДобавитьФайл(ПараметрыФайла,
	...
	Возврат ПрисоединенныеФайлы.ДобавитьПрисоединенныйФайл(ПараметрыФайла, АдресФайлаВоВременномХранилище, АдресВременногоХранилищаТекста, Описание, НоваяСсылкаНаФайл);
...
Функция ДвоичныеДанныеФайла(Знач ПрисоединенныйФайл) Экспорт
	...
	Возврат ПрисоединенныеФайлы.ПолучитьДвоичныеДанныеФайла(ПрисоединенныйФайл);
