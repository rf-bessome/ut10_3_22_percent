...
Функция ЭтоДокументПоддерживающийСтатусОформления(Источник) Экспорт
	...
	Возврат ОпределяемыеТипы().ДокументыЕГАИСПоддерживающиеСтатусыОформленияОбъект.Тип.СодержитТип(ТипЗнч(Источник))
		Или ОпределяемыеТипы().ДокументыЕГАИСПоддерживающиеСтатусыОформления.Тип.СодержитТип(ТипЗнч(Источник));
...
Функция ИменаДокументовДляДокументаОснования(ДокументОснование) Экспорт
	...
	Возврат РасчетСтатусовОформленияИС.ИменаДокументовДляДокументаОснования(ДокументОснование,
		ОпределяемыеТипы().ДокументыЕГАИСПоддерживающиеСтатусыОформления.Тип);
...
Функция ТипОснование() Экспорт
	...
	Возврат ОпределяемыеТипы().ОснованиеСтатусыОформленияДокументовЕГАИС.Тип;
	
КонецФункции

Функция ТипДокумент() Экспорт
	
	Возврат ОпределяемыеТипы().ДокументыЕГАИС.Тип;
