...
Функция ЭтоДокументПоддерживающийСтатусОформления(Источник) Экспорт
	...
	Возврат ОпределяемыеТипы().ДокументыИСМППоддерживающиеСтатусыОформленияОбъект.Тип.СодержитТип(ТипЗнч(Источник))
		ИЛИ ОпределяемыеТипы().ДокументыИСМППоддерживающиеСтатусыОформления.Тип.СодержитТип(ТипЗнч(Источник));
...
Функция ТипОснование() Экспорт
	...
	Возврат ОпределяемыеТипы().ОснованиеСтатусыОформленияДокументовИСМП.Тип;
...
Функция ТипДокумент() Экспорт
	...
	Возврат ОпределяемыеТипы().ДокументыИСМППоддерживающиеСтатусыОформления.Тип;
