...
Функция ИнициализацияТаблицыШтрихкодыУпаковок(ИспользоватьРасхождения = Ложь) Экспорт
	...
	ТЗ.Колонки.Добавить("Номенклатура",      ОпределяемыеТипы().Номенклатура.Тип);
	ТЗ.Колонки.Добавить("Характеристика",    ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	...
	Если ИспользоватьРасхождения Тогда
		ТЗ.Колонки.Добавить("ТипРасхождения", ОпределяемыеТипы().ТипРасхожденияИСМП.Тип);
		ТЗ.Колонки.Добавить("Признан",        ОпределяемыеТипы().ВариантДействийПоРасхождениямКодовМаркировкиИСМП.Тип);
	КонецЕсли;
