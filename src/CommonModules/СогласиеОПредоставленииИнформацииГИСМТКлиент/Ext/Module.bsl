...
Процедура ОбработатьРезультатОбновленияИнформацииПоДействующемуДокументуСогласияОПредоставленииИнформации(Результат, ПараметрыВыполнения, ОписаниеЗавершения)
	...
	Иначе
		...
		ДлительныеОперацииКлиент.ОжидатьЗавершение(
			...
			Новый ОписаниеОповещения("ПослеЗавершенияДлительнойОперацииДляПолученияИнформацииПоДействующемуДокументуСогласияОПредоставленииИнформацииПродолжение", согласиеопредоставленииинформациигисмтклиент, ПараметрыЗавершенияДлительнойОперации),
			ПараметрыОжидания);
