...
Процедура ОткрытьФормуСРезультатомПроверкиДокументаНаСоответствиеТребованиямГИСМТ(Форма) Экспорт
	...
	Если Форма.Модифицированность Тогда
		...
		Оповещение = Новый ОписаниеОповещения("ОткрытьФормуСРезультатомПроверкиДокументаНаСоответствиеТребованиямГИСМТПродолжить", соответствиетребованиямгисмтклиент, ПараметрыОповещения);
...
Процедура ОбработатьРезультатПроверкиДокумента(Результат, ПараметрыПроверки, Форма, ОписаниеЗавершения)
	...
	Иначе
		...
		ДлительныеОперацииКлиент.ОжидатьЗавершение(
			...
			Новый ОписаниеОповещения("ПослеЗавершенияДлительнойОперации", соответствиетребованиямгисмтклиент, ПараметрыЗавершенияДлительнойОперации),
			ПараметрыОжидания);
