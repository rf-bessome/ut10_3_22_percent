...
// Возвращает признак использования обмена РИБ в текущей базе данных.
//
// Параметры:
//  нет
//
// Возвращаемое значение:
//   Булево - признак использования РИБ.
//
Функция ИспользуетсяРИБ() Экспорт
...
// Возвращает список используемых в информационной базе узлов РИБ.
//
// Параметры:
//  нет
//
// Возвращаемое значение:
//   СписокЗначений - найденные узлы.
//
Функция УзлыРИБ()
