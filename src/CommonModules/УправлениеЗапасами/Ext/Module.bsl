...
// Очистить состав акцизных марок в документе
//
// Параметры:
//  СтрокаТабличнойЧасти - строка табличной части документа,
//  ДокументОбъект       - объект редактируемого документа.
//
Процедура ОчиститьАкцизныеМарки(СтрокаТабличнойЧасти, ДокументОбъект) Экспорт
	
	ТабличнаяЧасть = ДокументОбъект.АкцизныеМарки;
