...
Процедура ПоказатьПомещениеФайлаПриПодключенииРасширенияРаботыСФайлами(РасширениеПодключено, Контекст) Экспорт
	...
	Если РасширениеПодключено Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения(
			"ОбработатьРезультатПомещенияФайлов", файловаясистемаслужебныйклиент, ПараметрыОбработкиРезультата);
	...
	Иначе 
		...
		Обработчик = Новый ОписаниеОповещения(
			"ОбработатьРезультатПомещенияФайла", файловаясистемаслужебныйклиент, ПараметрыОбработкиРезультата);
...
Процедура ПоказатьПолучениеФайловПриПодключенииРасширенияРаботыСФайлами(РасширениеПодключено, Контекст) Экспорт
	...
	Если РасширениеПодключено Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения("ОповеститьОЗавершенииПолученияФайлов", файловаясистемаслужебныйклиент, Контекст);
...
Процедура ОткрытьФайлПослеСохранения(СохраненныеФайлы, ПараметрыОткрытия) Экспорт
	...
	Иначе
		...
		ОбработчикЗавершения = Новый ОписаниеОповещения(
			"ОткрытьФайлПослеЗавершенияРедактирования", файловаясистемаслужебныйклиент, ПараметрыОткрытия);
...
Процедура ОткрытьФайлВПрограммеПросмотра(ПутьКФайлу, Знач Оповещение = Неопределено,
	...
	Оповещение = Новый ОписаниеОповещения(
		"ОткрытьФайлВПрограммеПросмотраПослеПроверкиРасширенияРаботыСФайлами", файловаясистемаслужебныйклиент, Контекст);
...
Процедура ОткрытьФайлВПрограммеПросмотраПослеПроверкиРасширенияРаботыСФайлами(РасширениеПодключено, Контекст) Экспорт
	...
	Если РасширениеПодключено Тогда
		...
		Оповещение = Новый ОписаниеОповещения(
			"ОткрытьФайлВПрограммеПросмотраПослеПроверкиСуществования", файловаясистемаслужебныйклиент, Контекст,
			"ОткрытьФайлВПрограммеПросмотраПриОбработкеОшибки", файловаясистемаслужебныйклиент);
...
Процедура ОткрытьФайлВПрограммеПросмотраПослеПроверкиСуществования(Существует, Контекст) Экспорт
	...
	Если Существует Тогда
		...
		Оповещение = Новый ОписаниеОповещения(
			"ОткрытьФайлВПрограммеПросмотраПослеПроверкиЭтоФайл", файловаясистемаслужебныйклиент, Контекст,
			"ОткрытьФайлВПрограммеПросмотраПриОбработкеОшибки", файловаясистемаслужебныйклиент);
...
Процедура ОткрытьФайлВПрограммеПросмотраПослеПроверкиЭтоФайл(ЭтоФайл, Контекст) Экспорт
	...
	Если ЭтоФайл Тогда
		...
		Оповещение = Новый ОписаниеОповещения(
			"ОткрытьФайлВПрограммеПросмотраПослеЗапускаПриложения", файловаясистемаслужебныйклиент, Контекст,
			"ОткрытьФайлВПрограммеПросмотраПриОбработкеОшибки", файловаясистемаслужебныйклиент);
...
Процедура ОткрытьФайлПослеЗавершенияРедактирования(ПриложениеЗапущено, ПараметрыОткрытия) Экспорт
	...
	Если ПриложениеЗапущено
		...
		Оповещение = Новый ОписаниеОповещения(
			"ОткрытьФайлПослеОбновленияДанныхВХранилище", файловаясистемаслужебныйклиент, ПараметрыОткрытия);
...
Процедура ОткрытьФайлПослеОбновленияДанныхВХранилище(ДанныеОбновлены, АдресДанных, ИмяФайла,
	...
	Если ПараметрыОткрытия.Свойство("УдалятьПослеОбновленияДанных") Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения(
			"ОткрытьФайлПослеУдаленияВременногоФайла", файловаясистемаслужебныйклиент, ДополнительныеПараметры);
...
Процедура ОткрытьПроводникПослеПроверкиРасширенияРаботыСФайлами(РасширениеПодключено, Контекст) Экспорт
	...
	Если РасширениеПодключено Тогда
		Оповещение = Новый ОписаниеОповещения(
			"ОткрытьПроводникПослеПроверкиСуществования", файловаясистемаслужебныйклиент, Контекст, 
			"ОткрытьПроводникПриОбработкеОшибки", файловаясистемаслужебныйклиент);
		ФайлИнфо.НачатьПроверкуСуществования(Оповещение);
	Иначе
...
Процедура ОткрытьПроводникПослеПроверкиСуществования(Существует, Контекст) Экспорт 
	...
	Если Существует Тогда 
		Оповещение = Новый ОписаниеОповещения(
			"ОткрытьПроводникПослеПроверкиЭтоФайл", файловаясистемаслужебныйклиент, Контекст, 
			"ОткрытьПроводникПриОбработкеОшибки", файловаясистемаслужебныйклиент);
		ФайлИнфо.НачатьПроверкуЭтоФайл(Оповещение);
	Иначе 
		ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
...
Процедура ОткрытьПроводникПослеПроверкиЭтоФайл(ЭтоФайл, Контекст) Экспорт 
	...
	Оповещение = Новый ОписаниеОповещения(,,, "ОткрытьПроводникПриОбработкеОшибки", файловаясистемаслужебныйклиент);
	Если ЭтоФайл Тогда
...
Процедура ОткрытьНавигационнуюСсылкуПослеПроверкиРасширенияРаботыСФайлами(РасширениеПодключено, Контекст) Экспорт
	...
	Если РасширениеПодключено Тогда
		...
		Оповещение = Новый ОписаниеОповещения(
			"ОткрытьНавигационнуюСсылкуПослеЗапускаПриложения", файловаясистемаслужебныйклиент, Контекст,
...
Процедура ЗапуститьПрограммуПослеПроверкиРасширенияРаботыСФайлами(РасширениеПодключено, Контекст) Экспорт
	...
	Если РасширениеПодключено Тогда
		...
		Иначе 
			...
			Оповещение = Новый ОписаниеОповещения(
				"ЗапуститьПрограммуПослеПроверкиСуществования", файловаясистемаслужебныйклиент, Контекст,
				"ЗапуститьПрограммуПриОбработкеОшибки", файловаясистемаслужебныйклиент);
			ФайлИнфо.НачатьПроверкуСуществования(Оповещение);
		КонецЕсли;
...
Процедура ЗапуститьПрограммуПослеПроверкиСуществования(Существует, Контекст) Экспорт
	...
	Если Существует Тогда 
		Оповещение = Новый ОписаниеОповещения(
			"ЗапуститьПрограммуПослеПроверкиЭтоКаталог", файловаясистемаслужебныйклиент, Контекст,
			"ЗапуститьПрограммуПриОбработкеОшибки", файловаясистемаслужебныйклиент);
...
Процедура ЗапуститьПрограммуНачатьЗапуск(Контекст)
	...
	Иначе
		...
		Оповещение = Новый ОписаниеОповещения(
			"ЗапуститьПрограммуПослеЗапускаПриложения", файловаясистемаслужебныйклиент, Контекст,
			"ЗапуститьПрограммуПриОбработкеОшибки", файловаясистемаслужебныйклиент);
...
Процедура ВыбратьКаталогПриПодключенииРасширенияРаботыСФайлами(РасширениеПодключено, Контекст) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ВыбратьКаталогПриОкончанииВыбора", файловаясистемаслужебныйклиент, Контекст.ОбработчикЗавершения);
...
Процедура СоздатьВременныйКаталогПослеПроверкиРасширенияРаботыСФайлами(РасширениеПодключено, Контекст) Экспорт
	...
	Если РасширениеПодключено Тогда
		...
		Оповещение = Новый ОписаниеОповещения(
			"СоздатьВременныйКаталогПослеПолученияВременногоКаталога", файловаясистемаслужебныйклиент, Контекст,
			"СоздатьВременныйКаталогПриОбработкеОшибки", файловаясистемаслужебныйклиент);
