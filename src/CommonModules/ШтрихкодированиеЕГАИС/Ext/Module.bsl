...
Процедура ЗаполнитьТаблицуДанныеКодовМаркировкиСпецификой(ДанныеКодовМаркировки, СпецификаАкцизныхМарок)
	...
	ТаблицаНоменклатуры.Колонки.Добавить("Серия",          ОпределяемыеТипы().СерияНоменклатуры.Тип);
...
Процедура ДобавитьКолонкиТаблицыДанныеКодовМаркировки(ДанныеПоШтрихкодам, ПараметрыСканирования = Неопределено, ДанныеКодовМаркировки = Неопределено) Экспорт
	...
	Если ПараметрыСканирования <> Неопределено
		...
		ОбязательныеКолонки.Вставить("ЧастичноеВыбытиеНоменклатура",        ОпределяемыеТипы().Номенклатура.Тип);
		ОбязательныеКолонки.Вставить("ЧастичноеВыбытиеХарактеристика",      ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
...
Процедура НормализоватьКолонкиДереваУпаковок(Коллекция) Экспорт
	...
	КоллекцияОбязательныхКолонок.Вставить("ЧастичноеВыбытиеНоменклатура",   ОпределяемыеТипы().Номенклатура.Тип);
	КоллекцияОбязательныхКолонок.Вставить("ЧастичноеВыбытиеХарактеристика", ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
