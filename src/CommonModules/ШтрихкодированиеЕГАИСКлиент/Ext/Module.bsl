...
Функция ЗавершитьОбработкуШтрихкода(ПараметрыЗавершенияВводаШтрихкода) Экспорт
	...
	Если РезультатОбработкиШтрихкода.ТребуетсяВыборНоменклатуры Тогда
		...
		ОткрытьФорму(
			...
			Форма,,,,
			Новый ОписаниеОповещения("ВыборНоменклатурыЗавершение", штрихкодированиеегаисклиент, ПараметрыЗавершенияВводаШтрихкода),
	...
	Если РезультатОбработкиШтрихкода.ТребуетсяВыборСправки2 Тогда
		...
		ОткрытьФорму(
			...
			Форма,,,,
			Новый ОписаниеОповещения("ВыборСправки2Завершение", штрихкодированиеегаисклиент, ПараметрыЗавершенияВводаШтрихкода),
			РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
