...
Процедура ДобавитьКолонкиТаблицыДанныеКодовМаркировки(ДанныеПоШтрихкодам, ПараметрыСканирования = Неопределено, ДанныеКодовМаркировки = Неопределено) Экспорт
	...
	ОбязательныеКолонки.Вставить("ИдентификаторПроисхожденияВЕТИС",  ОпределяемыеТипы().ИдентификаторПроисхожденияВЕТИС.Тип);
...
Функция ПредставлениеОстаточныхШтрихкодов(СтрокиТаблицыДанных, ПараметрыСканирования) Экспорт
	...
	ТаблицаПредставлениеОстаточныхШтрихкодов.Колонки.Добавить("Номенклатура",             ОпределяемыеТипы().Номенклатура.Тип);
	ТаблицаПредставлениеОстаточныхШтрихкодов.Колонки.Добавить("GTIN",                     ОпределяемыеТипы().GTIN.Тип);
...
Процедура ЗаполнитьДанныеИдентификатораРозничнойПродажиПоОбязательнымТоварнымГруппам(ДанныеПоШтрихкодам, ПараметрыСканирования) Экспорт
	...
	Для Каждого СтрокаДанных Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		ПроверкаПродажиПиваВРозницуСЧастичнымВыбытием = (СтрокаДанных.ВидПродукции = Перечисления.ВидыПродукцииИС.Пиво
			...
			И (ПараметрыСканирования.ВидОперацииИСМП = Перечисления.ВидыОперацийИСМП.ВыводИзОборотаРозничнаяПродажа Или ПараметрыСканирования.ЭтоПроверкаКодовМаркировкиИСМП));
		...
		ПолучатьДанныеГИСМТ = ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(
			...
			Или ПроверкаПродажиПиваВРозницуСЧастичнымВыбытием;
...
Функция НормализоватьСвойстваКоллекцииВложенныхШтрихкодов(Коллекция, ПараметрыСканирования = Неопределено) Экспорт
	...
	КоллекцияОбязательныхКолонок.Вставить("GTIN",                            ОпределяемыеТипы().GTIN.Тип);
	КоллекцияОбязательныхКолонок.Вставить("EAN",                             ОпределяемыеТипы().GTIN.Тип);
	...
	КоллекцияОбязательныхКолонок.Вставить("ИдентификаторПроисхожденияВЕТИС", ОпределяемыеТипы().ИдентификаторПроисхожденияВЕТИС.Тип);
