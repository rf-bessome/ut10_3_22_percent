...
Функция ОбщиеНастройки() Экспорт
	...
	ОбщиеНастройки.Вставить("ИспользоватьЭлектронныеПодписи",
		Константы.ИспользоватьЭлектронныеЦифровыеПодписи.Получить());
...
Функция ТипыВладельцев(ТолькоСсылки = Ложь) Экспорт
	...
	Типы = ОпределяемыеТипы().ПодписанныйОбъект.Тип.Типы();
...
Функция ОшибкаПоКлассификатору(ТекстДляПоискаВКлассификаторе, ОшибкаНаСервере) Экспорт
	...
	КлассификаторОшибок = КлассификаторОшибокКриптографии();
...
Функция АккредитованныеУдостоверяющиеЦентры() Экспорт
	...
	Возврат ЭлектроннаяПодписьСлужебный.АккредитованныеУдостоверяющиеЦентры();
