...
Процедура Подключаемый_ОбработчикОжиданияЭДО(ЭтаФорма) Экспорт
	
	ПараметрыОбработчика = ЭлектронныеДокументыКлиент.ПараметрыОбработчикаОжиданияЭДО();
	ПараметрыОбработчика.ПодменюЭДО = ЭтаФорма.ЭлементыФормы.ДействияФормы.Кнопки.ЭД;
	ЭлектронныеДокументыКлиент.ОбработчикОжиданияЭДО(ЭтаФорма, ПараметрыОбработчика);
	
КонецПроцедуры

Процедура ОбработкаОповещения_ФормаСписка(ИмяСобытия, Параметр, Источник, ЭтаФорма) Экспорт
	
	Если ИмяСобытия = "ОбновитьОСобытияхЭДО" Тогда
		ПараметрыОповещения = ЭлектронныеДокументыКлиент.ПараметрыОповещенияЭДО_ФормаСписка();
		ПараметрыОповещения.Форма = ЭтаФорма;
		ПараметрыОповещения.ИмяДинамическогоСписка = "ДокументСписок";
		ПараметрыОповещения.ПодменюЭДО = ЭтаФорма.ЭлементыФормы.ДействияФормы.Кнопки.ЭД;
		ЭлектронныеДокументыКлиент.ОбработкаОповещения_ФормаСписка(ИмяСобытия, Параметр, Источник, ПараметрыОповещения);
	КонецЕсли;
	
КонецПроцедуры

Процедура ОбработкаОповещения_ФормаДокумента(ИмяСобытия, Параметр, Источник, ЭтаФорма) Экспорт
	
	Если ИмяСобытия = "ОбновитьОСобытияхЭДО" Тогда
		ПараметрыОповещения = ЭлектронныеДокументыКлиент.ПараметрыОповещенияЭДО_ФормаДокумента();
		ПараметрыОповещения.Форма = ЭтаФорма;
		ПараметрыОповещения.ПодменюЭДО = ЭтаФорма.ЭлементыФормы.ДействияФормы.Кнопки.ЭД;
		ЭлектронныеДокументыКлиент.ОбработкаОповещения_ФормаДокумента(ИмяСобытия, Параметр, Источник, ПараметрыОповещения);
	КонецЕсли;
