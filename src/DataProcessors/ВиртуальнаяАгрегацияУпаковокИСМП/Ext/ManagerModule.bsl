...
Функция НовоеДеревоУпаковок() Экспорт
	...
	ДеревоУпаковок.Колонки.Добавить("ТипНоменклатуры",           ОпределяемыеТипы().ТипНоменклатуры.Тип);
	ДеревоУпаковок.Колонки.Добавить("Номенклатура",              ОпределяемыеТипы().Номенклатура.Тип);
	ДеревоУпаковок.Колонки.Добавить("Характеристика",            ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	ДеревоУпаковок.Колонки.Добавить("Серия",                     ОпределяемыеТипы().СерияНоменклатуры.Тип);
	ДеревоУпаковок.Колонки.Добавить("GTIN",                      ОпределяемыеТипы().GTIN.Тип);
	...
	ДеревоУпаковок.Колонки.Добавить("Упаковка",                  ОпределяемыеТипы().Упаковка.Тип);
...
Функция НоваяСоставУпаковки() Экспорт
	...
	СоставУпаковки.Колонки.Добавить("Номенклатура",              ОпределяемыеТипы().Номенклатура.Тип);
	СоставУпаковки.Колонки.Добавить("Характеристика",            ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	СоставУпаковки.Колонки.Добавить("Серия",                     ОпределяемыеТипы().СерияНоменклатуры.Тип);
	СоставУпаковки.Колонки.Добавить("Количество",                ОбщегоНазначения.ОписаниеТипаЧисло(10));
	СоставУпаковки.Колонки.Добавить("GTIN",                      ОпределяемыеТипы().GTIN.Тип);
...
Функция НоваяВложенныеЕдиницы() Экспорт
	...
	ВложенныеЕдиницы.Колонки.Добавить("Номенклатура",   ОпределяемыеТипы().Номенклатура.Тип);
	ВложенныеЕдиницы.Колонки.Добавить("Характеристика", ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
...
Процедура ЗаполнитьСлужебныеРеквизиты(Таблица)
	...
	Таблица.Колонки.Добавить("ЕдиницаИзмерения", ОпределяемыеТипы().Упаковка.Тип);
...
Процедура ЗаполнитьНаборы(Параметры, ОстаткиПродукции)
	...
	ТаблицаДанных.Колонки.Добавить("Упаковка",            ОпределяемыеТипы().Упаковка.Тип);
...
Функция НоваяОстаткиПродукции()
	...
	ОстаткиПродукции.Колонки.Добавить("ТипНоменклатуры",            ОпределяемыеТипы().ТипНоменклатуры.Тип);
	ОстаткиПродукции.Колонки.Добавить("Номенклатура",               ОпределяемыеТипы().Номенклатура.Тип);
	ОстаткиПродукции.Колонки.Добавить("GTIN",                       ОпределяемыеТипы().GTIN.Тип);
	ОстаткиПродукции.Колонки.Добавить("Шаблон",                     Новый ОписаниеТипов("ПеречислениеСсылка.ШаблоныКодовМаркировкиСУЗ"));
	ОстаткиПродукции.Колонки.Добавить("Характеристика",             ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
...
Функция НовоеСоставИсторическихУпаковок()
	...
	СоставИсторическихУпаковок.Колонки.Добавить("Номенклатура",     ОпределяемыеТипы().Номенклатура.Тип);
	СоставИсторическихУпаковок.Колонки.Добавить("Характеристика",   ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	СоставИсторическихУпаковок.Колонки.Добавить("Серия",            ОпределяемыеТипы().СерияНоменклатуры.Тип);
	СоставИсторическихУпаковок.Колонки.Добавить("Количество",       ОбщегоНазначения.ОписаниеТипаЧисло(10));
	СоставИсторическихУпаковок.Колонки.Добавить("GTIN",             ОпределяемыеТипы().GTIN.Тип);
