...
Процедура КоличествоВУпаковкахПриИзменении(Элемент)
	...
	Если КоличествоВУпаковках = 0 Тогда
		ЭтаФорма.ТекущийЭлемент = Элементы.ФормироватьТолькоВложенныеЕдиницы;
	Иначе
...
Процедура ФормироватьТолькоВложенныеЕдиницыПриИзменении(Элемент)
	...
	Если ФормироватьТолькоВложенныеЕдиницы Тогда
		...
		КоличествоВУпаковках = КоличествоКУпаковке;
		ЭтаФорма.ТекущийЭлемент = Элементы.КоличествоВУпаковках;
	Иначе
		КоличествоВУпаковках = 0;
	КонецЕсли;
...
Процедура НачальноеЗаполнениеФормы()
	...
	ЗаполнитьЗначенияСвойств(ЭтаФорма, Параметры, СтрСоединить(ИменаРеквизитов, ","));
	...
	СтрокаДляРасчетаХеша = ИнтеграцияИСКлиентСервер.СтрокаДляРасчетаХешаСоставаУпаковки(ЭтаФорма);
...
Процедура ЗаписатьДанныеВИсторию(Упаковки)
	...
	Для Каждого Упаковка Из Упаковки Цикл
		Если Упаковка.Черновик Тогда
			...
			ЗаполнитьЗначенияСвойств(СтрокаТаблицы, ЭтаФорма, СписокСвойств);
...
Процедура ОткрытьФормуСозданияУпаковки()
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПриСозданииУпаковки", ЭтаФорма);
...
Процедура УдалениеУпаковки()
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ОтветНаВопросПередУдалениемУпаковки", ЭтаФорма, ТекущаяСтрока);
