...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НастройкиЗаполнения = ШаблонНастроекЗаполнения(ЭтаФорма);
	...
	УстановитьДоступностьХарактеристики(ЭтаФорма);
...
Процедура ЦифраРасширенияПриИзменении(Элемент)
	Если КэшКлючТекущегоНумератораШтрихкода <> КлючТекущегоНумератораШтрихкодаДляКэша(ЭтаФорма) Тогда
		СерийныйНомерSSCC = 0;
	КонецЕсли;
...
Процедура ПолучитьВес(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПолучитьВесЗавершение", ЭтаФорма, ДополнительныеПараметры);
...
Процедура Готово(Команда)
	...
	Если ВозвращатьАдресВременногоХранилища
	   И ВладелецФормы <> Неопределено Тогда
		...
		ТекущийКлючНумератора     = КлючТекущегоНумератораШтрихкодаДляКэша(ЭтаФорма);
...
Процедура ОткрытьФормуПодбораИдентификаторовПрименения()
	...
	ОткрытьФорму("Обработка.ГенерацияШтрихкодовУпаковок.Форма.ФормаПодбораИдентификаторов", ПараметрыОткрываемойФормы, ЭтаФорма, УникальныйИдентификатор);
КонецПроцедуры
...
Процедура ЗаполнениеПоНастройкамЗаполнения(НастройкиЗаполнения)
	...
	КэшКлючТекущегоНумератораШтрихкода = КлючТекущегоНумератораШтрихкодаДляКэша(ЭтаФорма);
