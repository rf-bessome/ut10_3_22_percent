...
Процедура ВыполнитьОбновление() Экспорт
	...
	Если ТекущийНомерРелиза = "10.2.13"
	 Или (ТекущийНомерРелиза = "10.3.1" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		Если ТекущийНомерРелиза = "10.2.13" Тогда
			...
			СписокПредопределенныхЭлементов.Добавить(Справочники.ВидыКонтактнойИнформации.АдресЭлектроннойПочтыКонтрагентаДляОтправкиЧеков);
	...
	ТекущаяВерсияИБ  = Константы.НомерВерсииКонфигурации.Получить();
	ТекущаяВерсияИБЧисло  = Число(СтрЗаменить(ТекущаяВерсияИБ, ".", ""));
	НомерРелиза      = ПолучитьНомерРелиза(ТекущаяВерсияИБ);
	НоваяВерсияИБ    = "10.3.47.2";
	НоваяВерсияИБЧисло  = Число(СтрЗаменить(НоваяВерсияИБ, ".", ""));
	НовыйНомерРелиза = ПолучитьНомерРелиза(НоваяВерсияИБ);
	СтрокаВерсии     = "Версия" + СтрЗаменить(НовыйНомерРелиза, ".", "");
	СтрокаШапки      = "Шапка"  + СтрЗаменить(НовыйНомерРелиза, ".", "");
	
	Если (ТекущаяВерсияИБ = "10.3.47.1")
		ИЛИ (НомерРелиза = "10.3.47" И ТекущаяВерсияИБ <> НоваяВерсияИБ И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	ТекущаяВерсияИБ  = Константы.НомерВерсииКонфигурации.Получить();
	НомерРелиза      = ПолучитьНомерРелиза(ТекущаяВерсияИБ);
	НоваяВерсияИБ    = "10.3.47.3";
	НовыйНомерРелиза = ПолучитьНомерРелиза(НоваяВерсияИБ);
	СтрокаВерсии     = "Версия" + СтрЗаменить(НовыйНомерРелиза, ".", "");
	СтрокаШапки      = "Шапка"  + СтрЗаменить(НовыйНомерРелиза, ".", "");
	
	Если (ТекущаяВерсияИБ = "10.3.47.2")
		ИЛИ (НомерРелиза = "10.3.47" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
	...
	ТекущаяВерсияИБ  = Константы.НомерВерсииКонфигурации.Получить();
	НомерРелиза      = ПолучитьНомерРелиза(ТекущаяВерсияИБ);
	НоваяВерсияИБ    = "10.3.48.1";
	НовыйНомерРелиза = ПолучитьНомерРелиза(НоваяВерсияИБ);
	СтрокаВерсии     = "Версия" + СтрЗаменить(НовыйНомерРелиза, ".", "");
	СтрокаШапки      = "Шапка"  + СтрЗаменить(НовыйНомерРелиза, ".", "");
	
	Если (ТекущаяВерсияИБ = "10.3.47.3")
		ИЛИ (НомерРелиза = "10.3.48" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.49.1")
		ИЛИ (НомерРелиза = "10.3.49" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.49.2")
		ИЛИ (НомерРелиза = "10.3.49" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.49.3")
		ИЛИ (НомерРелиза = "10.3.49" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	ТекущаяВерсияИБ  = Константы.НомерВерсииКонфигурации.Получить();
	НомерРелиза      = ПолучитьНомерРелиза(ТекущаяВерсияИБ);
	НоваяВерсияИБ    = "10.3.50.1";
	НовыйНомерРелиза = ПолучитьНомерРелиза(НоваяВерсияИБ);
	СтрокаВерсии     = "Версия" + СтрЗаменить(НовыйНомерРелиза, ".", "");
	СтрокаШапки      = "Шапка"  + СтрЗаменить(НовыйНомерРелиза, ".", "");
	
	Если (ТекущаяВерсияИБ = "10.3.49.4")
		ИЛИ (НомерРелиза = "10.3.50" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.50.1")
		ИЛИ (НомерРелиза = "10.3.50" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.50.2")
		ИЛИ (НомерРелиза = "10.3.50" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	ТекущаяВерсияИБ  = Константы.НомерВерсииКонфигурации.Получить();
	НомерРелиза      = ПолучитьНомерРелиза(ТекущаяВерсияИБ);
	НоваяВерсияИБ    = "10.3.51.1";
	НовыйНомерРелиза = ПолучитьНомерРелиза(НоваяВерсияИБ);
	СтрокаВерсии     = "Версия" + СтрЗаменить(НовыйНомерРелиза, ".", "");
	СтрокаШапки      = "Шапка"  + СтрЗаменить(НовыйНомерРелиза, ".", "");
	
	Если (ТекущаяВерсияИБ = "10.3.50.3")
		ИЛИ (НомерРелиза = "10.3.51" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
	...
	ТекущаяВерсияИБ  = Константы.НомерВерсииКонфигурации.Получить();
	НомерРелиза      = ПолучитьНомерРелиза(ТекущаяВерсияИБ);
	НоваяВерсияИБ    = "10.3.52.1";
	НовыйНомерРелиза = ПолучитьНомерРелиза(НоваяВерсияИБ);
	СтрокаВерсии     = "Версия" + СтрЗаменить(НовыйНомерРелиза, ".", "");
	СтрокаШапки      = "Шапка"  + СтрЗаменить(НовыйНомерРелиза, ".", "");
	
	Если (ТекущаяВерсияИБ = "10.3.51.1")
		ИЛИ (НомерРелиза = "10.3.52" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.52.1")
		ИЛИ (НомерРелиза = "10.3.52" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	ТекущаяВерсияИБ  = Константы.НомерВерсииКонфигурации.Получить();
	НомерРелиза      = ПолучитьНомерРелиза(ТекущаяВерсияИБ);
	НоваяВерсияИБ    = "10.3.53.1";
	НовыйНомерРелиза = ПолучитьНомерРелиза(НоваяВерсияИБ);
	СтрокаВерсии     = "Версия" + СтрЗаменить(НовыйНомерРелиза, ".", "");
	СтрокаШапки      = "Шапка"  + СтрЗаменить(НовыйНомерРелиза, ".", "");
	
	Если (ТекущаяВерсияИБ = "10.3.52.1")
		ИЛИ (НомерРелиза = "10.3.53" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.53.1")
		ИЛИ (НомерРелиза = "10.3.53" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.53.1")
		ИЛИ (НомерРелиза = "10.3.54" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.54.1")
		ИЛИ (НомерРелиза = "10.3.54" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.54.1")
		ИЛИ (НомерРелиза = "10.3.55" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.55.1")
		ИЛИ (НомерРелиза = "10.3.55" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.55.1")
		ИЛИ (НомерРелиза = "10.3.56" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.56.1")
		ИЛИ (НомерРелиза = "10.3.57" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.58.1")
		ИЛИ (НомерРелиза = "10.3.58" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.58.2")
		ИЛИ (НомерРелиза = "10.3.58" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.59.1")
		ИЛИ (НомерРелиза = "10.3.59" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.59.2")
		ИЛИ (НомерРелиза = "10.3.59" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.59.3")
		ИЛИ (НомерРелиза = "10.3.59" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.59.4")
		ИЛИ (НомерРелиза = "10.3.59" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.60.1")
		ИЛИ (НомерРелиза = "10.3.60" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.60.2")
		ИЛИ (НомерРелиза = "10.3.60" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.60.3")
		ИЛИ (НомерРелиза = "10.3.60" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.61.1")
		ИЛИ (НомерРелиза = "10.3.61" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.61.2")
		ИЛИ (НомерРелиза = "10.3.61" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.62.1")
		ИЛИ (НомерРелиза = "10.3.62" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.62.2")
		ИЛИ (НомерРелиза = "10.3.62" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.63.1")
		ИЛИ (НомерРелиза = "10.3.63" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.64.1")
		ИЛИ (НомерРелиза = "10.3.64" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.64.2")
		ИЛИ (НомерРелиза = "10.3.64" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.64.3")
		ИЛИ (НомерРелиза = "10.3.64" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.64.4")
		ИЛИ (НомерРелиза = "10.3.64" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.65.1")
		ИЛИ (НомерРелиза = "10.3.65" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.66.1")
		ИЛИ (НомерРелиза = "10.3.66" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.66.2")
		ИЛИ (НомерРелиза = "10.3.66" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.66.3")
		ИЛИ (НомерРелиза = "10.3.66" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.67.1")
		ИЛИ (НомерРелиза = "10.3.67" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.67.2")
		ИЛИ (НомерРелиза = "10.3.67" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.67.3")
		ИЛИ (НомерРелиза = "10.3.67" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.68.1")
		ИЛИ (НомерРелиза = "10.3.68" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.68.2")
		ИЛИ (НомерРелиза = "10.3.68" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.68.3")
		ИЛИ (НомерРелиза = "10.3.68" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.69.1")
		ИЛИ (НомерРелиза = "10.3.69" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.69.2")
		ИЛИ (НомерРелиза = "10.3.69" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.70.1")
		ИЛИ (НомерРелиза = "10.3.70" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.70.2")
		ИЛИ (НомерРелиза = "10.3.70" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.70.3")
		ИЛИ (НомерРелиза = "10.3.70" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.70.4")
		ИЛИ (НомерРелиза = "10.3.70" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.71.1")
		ИЛИ (НомерРелиза = "10.3.71" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.71.2")
		ИЛИ (НомерРелиза = "10.3.71" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.71.3")
		ИЛИ (НомерРелиза = "10.3.71" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.72.1")
		ИЛИ (НомерРелиза = "10.3.72" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.72.2")
		ИЛИ (НомерРелиза = "10.3.72" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.72.3")
		ИЛИ (НомерРелиза = "10.3.72" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.73.1")
		ИЛИ (НомерРелиза = "10.3.73" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.73.2")
		ИЛИ (НомерРелиза = "10.3.73" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.73.3")
		ИЛИ (НомерРелиза = "10.3.73" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.74.1")
		ИЛИ (НомерРелиза = "10.3.74" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.74.2")
		ИЛИ (НомерРелиза = "10.3.74" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.74.3")
		ИЛИ (НомерРелиза = "10.3.74" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.75.1")
		ИЛИ (НомерРелиза = "10.3.75" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.75.2")
		ИЛИ (НомерРелиза = "10.3.75" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.75.3")
		ИЛИ (НомерРелиза = "10.3.75" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.76.1")
		ИЛИ (НомерРелиза = "10.3.76" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.76.2")
		ИЛИ (НомерРелиза = "10.3.76" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.77.1")
		ИЛИ (НомерРелиза = "10.3.77" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.77.2")
		ИЛИ (НомерРелиза = "10.3.77" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.78.1")
		ИЛИ (НомерРелиза = "10.3.78" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.78.2")
		ИЛИ (НомерРелиза = "10.3.78" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.78.3")
		ИЛИ (НомерРелиза = "10.3.78" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.79.1")
		ИЛИ (НомерРелиза = "10.3.79" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.79.2")
		ИЛИ (НомерРелиза = "10.3.79" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.80.1")
		ИЛИ (НомерРелиза = "10.3.80" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.81.1")
		ИЛИ (НомерРелиза = "10.3.81" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.82.1")
		ИЛИ (НомерРелиза = "10.3.82" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.82.2")
		ИЛИ (НомерРелиза = "10.3.82" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.83.1")
		ИЛИ (НомерРелиза = "10.3.83" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.84.1")
		ИЛИ (НомерРелиза = "10.3.84" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.84.2")
		ИЛИ (НомерРелиза = "10.3.84" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.85.1")
		ИЛИ (НомерРелиза = "10.3.85" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.86.1")
		ИЛИ (НомерРелиза = "10.3.86" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.86.2")
		ИЛИ (НомерРелиза = "10.3.86" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.87.1")
		ИЛИ (НомерРелиза = "10.3.87" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.87.2")
		ИЛИ (НомерРелиза = "10.3.87" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.87.3")
		ИЛИ (НомерРелиза = "10.3.87" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.88.1")
		ИЛИ (НомерРелиза = "10.3.88" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.88.2")
		ИЛИ (НомерРелиза = "10.3.88" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	Если (ТекущаяВерсияИБ = "10.3.88.3")
		ИЛИ (НомерРелиза = "10.3.88" И ТекущаяВерсияИБЧисло < НоваяВерсияИБЧисло) Тогда
	...
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.32.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.32.3", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.33.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.33.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.34.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.34.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.34.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.34.2", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	мОбработчики.Добавить("ОбновлениеИнформационнойБазыЕГАИС.УстановитьПризнакВыгрузкиПродажНемаркируемойПродукции");
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.35.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.35.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.35.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.35.2", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.36.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.36.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	мОбработчики.Добавить("Документы.СчетФактураВыданный.УстановитьКодВидаОперацииНаУменьшение");
	мОбработчики.Добавить("Документы.СчетФактураПолученный.УстановитьКодВидаОперацииНаУменьшение");
	мОбработчики.Добавить("Обработки.ОбновлениеИнформационнойБазы.УстановитьЗначениеКонстантыВыгружатьПродажиНеМаркируемойПродукцииВЕГАИС");
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.2", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.3", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.4", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.4", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.5", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.37.5", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.38.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.38.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.39.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.39.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.40.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.40.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.41.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.41.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.42.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.42.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	мОбработчики.Добавить("Справочники.ТорговоеОборудование.ЗаполнитьСпособФЛК");
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.43.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.43.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.43.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.43.2", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	мОбработчики.Добавить("Обработки.ОбновлениеИнформационнойБазы.УстановитьРеквизитыВидаКонтактнойИнформации");
	ПараметрыОбработчика = Новый Массив;
	ПараметрыОбработчика.Добавить(Справочники.ВидыКонтактнойИнформации.АдресЭлектроннойПочтыКонтрагентаДляОтправкиЧеков);
	ПараметрыОбработчика.Добавить(Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты);
	ПараметрыОбработчика.Добавить(Перечисления.ВидыОбъектовКонтактнойИнформации.Контрагенты);
	мПараметрыОбработчиков = Новый Массив;
	мПараметрыОбработчиков.Добавить(ПараметрыОбработчика);
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.44.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений, , мПараметрыОбработчиков);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.44.1", мОбработчики, , , , мПараметрыОбработчиков);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.45.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.45.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.45.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.45.2", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.45.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.45.3", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.45.4", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.45.4", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	мОбработчики.Добавить("Обработки.ОбновлениеИнформационнойБазы.ЗаполнитьКодТНВЭД_ВозратТоваровПоставщику");
	мОбработчики.Добавить("Обработки.ОбновлениеИнформационнойБазы.ЗаполнитьКодТНВЭД_КорректировкаРеализации");
	мОбработчики.Добавить("Обработки.ОбновлениеИнформационнойБазы.ЗаполнитьКодТНВЭД_ОтчетКомиссионераОПродажах");
	мОбработчики.Добавить("Обработки.ОбновлениеИнформационнойБазы.ЗаполнитьКодТНВЭД_РеализацияТоваровИУслуг");
	мОбработчики.Добавить("Справочники.НомераГТД.ОпределитьРегистрационныйНомерИСтрануВвоза");
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.46.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.46.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.46.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.46.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.46.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.46.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.47.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.47.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.47.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.47.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.47.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.47.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	мОбработчики.Добавить("ОбновлениеИнформационнойБазыЕГАИС.РегистрыНакопленияОстаткиАлкогольнойПродукцииЕГАИСОбработатьДанныеДляПереходаНаНовуюВерсию");
	мОбработчики.Добавить("Справочники.КлассификаторОрганизацийЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсию");
	мОбработчики.Добавить("Справочники.КлассификаторАлкогольнойПродукцииЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсию");
	мОбработчики.Добавить("Документы.АктПостановкиНаБалансЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсию");
	мОбработчики.Добавить("Документы.АктСписанияЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсию");
	мОбработчики.Добавить("Документы.ВозвратИзРегистра2ЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсию");
	мОбработчики.Добавить("Документы.ПередачаВРегистр2ЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсию");
	мОбработчики.Добавить("ОбновлениеИнформационнойБазыЕГАИС.УдалитьОбработчикОбновленияАктаСписания");
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.48.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.48.1", мОбработчики);
	#КонецЕсли
		
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.48.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.48.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.49.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.49.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.49.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.49.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.49.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.49.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.49.4", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.49.4", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.50.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.50.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.50.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.50.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.50.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.50.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.51.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.51.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.52.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.52.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.52.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.52.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.53.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.53.1", мОбработчики);
	#КонецЕсли

	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.53.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.53.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.54.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.54.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.54.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.54.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.54.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.54.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.54.4", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.54.4", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.55.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.55.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.55.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.55.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.55.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.55.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.56.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.56.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.57.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.57.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.57.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.57.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.57.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.57.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.58.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.58.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.58.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.58.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.59.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.59.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.59.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.59.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.59.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.59.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.59.4", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.59.4", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.60.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.60.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.60.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.60.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.60.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.60.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.61.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.61.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.61.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.61.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.62.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.62.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.62.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.62.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	мОбработчики.Добавить("Обработки.ОбновлениеИнформационнойБазы.НоменклатураОбработатьДанныеДляПереходаНаНовуюВерсиюЗаполнениеВидПродукцииИС");
	мОбработчики.Добавить("ОбновлениеИнформационнойБазыИСМП.СправочникиШтрихкодыУпаковокТоваровОбработатьДанныеДляПереходаНаНовуюВерсиюЗаполнениеХешСуммаЗначенияШтрихкодаGS1");
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.63.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.63.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.64.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.64.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.64.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.64.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.64.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.64.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.64.4", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.64.4", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.65.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.65.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.66.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.66.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.66.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.66.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.66.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.66.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.67.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.67.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.67.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.67.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	мОбработчики.Добавить("Обработки.ОбновлениеИнформационнойБазы.ОбновитьБанковскиеСчетаГосударственныхОрганов");
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.67.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.67.3", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.68.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.68.1", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.68.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.68.2", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.68.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.68.3", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.69.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.69.1", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.69.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.69.2", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.70.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.70.1", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.70.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.70.2", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.70.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.70.3", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.70.4", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.70.4", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.71.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.71.1", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.71.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.71.2", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.71.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.71.3", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.72.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.72.1", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.72.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.72.2", мОбработчики);
	#КонецЕсли
	...
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.72.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.72.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.73.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.73.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.73.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.73.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.73.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.73.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.74.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.74.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.74.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.74.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.74.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.74.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.75.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.75.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.75.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.75.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.75.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.75.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.76.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.76.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.76.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.76.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.77.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.77.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.77.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.77.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.78.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.78.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.78.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.78.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.78.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.78.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.79.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.79.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.79.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.79.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.80.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.80.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.81.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.81.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	мОбработчики.Добавить("Обработки.ОбновлениеИнформационнойБазы.УстановитьВидКИдляСкладов");
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.82.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.82.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.82.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.82.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.83.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.83.1", мОбработчики);
	#КонецЕсли
		
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.84.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.84.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.84.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.84.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.85.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.85.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	мОбработчики.Добавить("Справочники.ПрофилиНастроекЭДО.ДобавитьВидЭлектронногоДокумента_АктСверкиВзаиморасчетов");
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.86.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.86.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.86.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.86.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.87.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.87.1", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.87.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.87.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.87.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.87.3", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.88.1", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.88.1", мОбработчики);
	#КонецЕсли
		
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.88.2", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.88.2", мОбработчики);
	#КонецЕсли
	
	мОбработчики = Новый Массив;
	#Если Клиент Тогда
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.88.3", мОбработчики, ДокументОписаниеОбновлений, МакетОписаниеОбновлений);
	#Иначе
		ВыполнитьОбновлениеНаНовыйРелиз("10.3.88.3", мОбработчики);
	#КонецЕсли
...
//////////////////////////////////////////////////////////////////////////
	...
	СписокИсключений = "10.3.4,10.3.35,10.3.47,10.3.49,10.3.51,10.3.53,10.3.56,10.3.57,10.3.58,10.3.59,10.3.60,10.3.61,
						|10.3.62,10.3.63,10.3.64,10.3.65,10.3.66,10.3.67,10.3.68,10.3.69,10.3.70,10.3.71,10.3.72,10.3.73,
						|10.3.74,10.3.75,10.3.76,10.3.77,10.3.78,10.3.79,10.3.80,10.3.81,10.3.82,10.3.83,10.3.84,10.3.85,10.3.86,10.3.87,10.3.88";
...
Процедура ВыполнитьОбновлениеНаНовыйРелиз(НоваяВерсияИБ, мОбработчики, ДокументОписаниеОбновлений = "", МакетОписаниеОбновлений = "", ОбновлениеЗавершено = Ложь, мПараметрыОбработчиков = Неопределено)
	...
	Если ОбновлениеИнформационнойБазы.НеобходимоОбновлениеИнформационнойБазы(НоваяВерсияИБ) Тогда
		...
		Если Не Отказ Тогда
			...
			Если мПараметрыОбработчиков = Неопределено Тогда
				мПараметрыОбработчиков = Новый Массив;
			КонецЕсли;
			Индекс = 0;
			ПараметрыОбработчика = Новый Массив;
			Для Каждого ИмяОбработчика Из мОбработчики Цикл
				...
				Если Индекс <= мПараметрыОбработчиков.ВГраница() Тогда
					ПараметрыОбработчика = мПараметрыОбработчиков.Получить(Индекс);
				Иначе
					ПараметрыОбработчика.Очистить();
				КонецЕсли;
...
// Процедура заполняет пустые значения измерения "Орг\анизация" движений регистров документов:
...
Процедура ЗаполнитьСправочникВидыКонтактнойИнформации()
	...
	Пока Выборка.Следующий() Цикл
		...
		ИначеЕсли Выборка.Ссылка = Справочники.ВидыКонтактнойИнформации.АдресИнострКонтрагентаУчред Тогда
		...
		ИначеЕсли Выборка.ссылка = Справочники.ВидыКонтактнойИнформации.АдресЭлектроннойПочтыКонтрагентаДляОтправкиЧеков Тогда				
...
Процедура ЗаполнитьПустуюИБ(ДокументОписаниеОбновлений, МакетОписаниеОбновлений) Экспорт
	...
	// Заполнение параметров справочника Драйверы оборудования
	...
	УстановитьКонстанту("ДатаНачалаПримененияПриказа164"            , Дата(2016, 1, 1));
	УстановитьКонстанту("ДатаНачалаРегистрацииРозничныхПродажВЕГАИС", Дата(2016, 7, 1));
