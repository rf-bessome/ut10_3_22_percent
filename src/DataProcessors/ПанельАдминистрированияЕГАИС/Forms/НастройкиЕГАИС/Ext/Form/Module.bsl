...
Процедура НастроитьОтправкуПолучениеЕГАИС(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ИзменитьРасписаниеОтправкиПолученияЕГАИС", ЭтаФорма);
...
Процедура НастроитьСверткуРегистраСоответствияНоменклатурыЕГАИС(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ИзменитьРасписаниеСверткиРегистраСоответствияЕГАИС", ЭтаФорма);
...
Процедура СохранитьЗначениеРеквизита(РеквизитПутьКДанным, Результат)
	...
	Если СтрокаДополнительнаяКонстанта.Количество() Тогда
		...
		СобытияФормИСПереопределяемый.ОбновитьФормуНастройкиПриЗаписиПодчиненныхКонстант(ЭтаФорма, ИмяДополнительнойКонстанты, КонстантаЗначение);
