...
Процедура НастройкиСканированияКодовМаркировкиНажатие(Элемент)
	...
	ОткрытьФорму("Обработка.ПанельАдминистрированияИСМП.Форма.НастройкиСканированияКодовМаркировки",,ЭтаФорма);
...
Процедура НастройкаОбменаИСМП(Команда)
	...
	ОткрытьФорму("ОбщаяФорма.НастройкаСертификатовДляАвтоматическогоОбменаИС",,ЭтаФорма);
...
Процедура НастроитьОтправкуПолучениеИСМП(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ИзменитьРасписаниеОтправкиПолученияИСМП", ЭтаФорма);
...
Процедура НастроитьЗагрузкуСведенийОбОтклонениях(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ИзменитьРасписаниеЗагрузкиСведенийОбОтклоненияхИСМП", ЭтаФорма);
...
Процедура НастроитьОчисткуПулаКодовМаркировкиИСМП(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ИзменитьРасписаниеОчисткиПулаКодовМаркировкиИСМП", ЭтаФорма);
...
Процедура НастроитьПроверкуСтатусовДокументовГИСМТ(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ИзменитьРасписаниеПроверкаДокументовВГИСМТ", ЭтаФорма);
...
Процедура НастроитьАвтоматическоеУдалениеНеиспользованныхКодовМаркировки(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ИзменитьРасписаниеАвтоматическогоУдаленияНеиспользованныхКодовМаркировки", ЭтаФорма);
...
Процедура ПараметрыПодключенияКСУЗ(Команда)
	...
	ОткрытьФорму("РегистрСведений.НастройкиОбменаСУЗ.ФормаСписка", , ЭтаФорма);
...
Процедура СохранитьЗначениеКонстанты(КонстантаИмя, Знач КонстантаЗначение = Неопределено)
	...
	Если КонстантаИмя <> "" Тогда
		...
		СобытияФормИСПереопределяемый.ОбновитьФормуНастройкиПриЗаписиПодчиненныхКонстант(ЭтаФорма, КонстантаИмя, КонстантаЗначение);
...
Процедура ОбработатьРезультатОбновленияНастроек(РезультатОбмена) Экспорт
	...
	Если РезультатОбмена <> Неопределено Тогда
		...
		ДлительныеОперацииКлиент.ОжидатьЗавершение(
			РезультатОбмена,
			Новый ОписаниеОповещения("ПослеЗавершенияДлительнойОперации", ЭтаФорма),
			ПараметрыОжидания);
