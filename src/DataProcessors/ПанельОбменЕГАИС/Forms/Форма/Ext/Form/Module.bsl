...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияЕГАИС.УстановитьВидимостьКомандыВыполнитьОбмен(ЭтаФорма, "ФормаВыполнитьОбмен");
...
Процедура КлассификаторАлкогольнойПродукцииЕГАИС(Команда)
	...
	ОткрытьФорму("Справочник.КлассификаторАлкогольнойПродукцииЕГАИС.ФормаСписка", , ЭтаФорма);
...
Процедура КлассификаторОрганизацийЕГАИС(Команда)
	...
	ОткрытьФорму("Справочник.КлассификаторОрганизацийЕГАИС.ФормаСписка", , ЭтаФорма);
...
Процедура Справки1ЕГАИС(Команда)
	...
	ОткрытьФорму("Справочник.Справки1ЕГАИС.ФормаСписка", , ЭтаФорма);
...
Процедура Справки2ЕГАИС(Команда)
	...
	ОткрытьФорму("Справочник.Справки2ЕГАИС.ФормаСписка", , ЭтаФорма);
	...
	ИначеЕсли ОрганизацииЕГАИС.Количество() > 1 Тогда
		...
		ОрганизацииЕГАИС.ПоказатьВыборЭлемента(
			Новый ОписаниеОповещения(
				"ОбработатьВыборОрганизацииЕГАИСДляОткрытияWebИнтерфейсаФРАПУТМ", ЭтаФорма),
...
Процедура ОткрытьWebИнтерфейсУТМ(Команда)
	...
	ИначеЕсли ОрганизацииЕГАИС.Количество() > 1 Тогда
		...
		ОрганизацииЕГАИС.ПоказатьВыборЭлемента(
			Новый ОписаниеОповещения(
				"ОбработатьВыборОрганизацииЕГАИСДляОткрытияWebИнтерфейсаУТМ", ЭтаФорма),
				НСтр("ru = 'Выбор организации ЕГАИС'"),
				ОрганизацииЕГАИС.Получить(0).Значение);
