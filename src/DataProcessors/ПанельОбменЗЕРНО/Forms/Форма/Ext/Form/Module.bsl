...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияИС.УстановитьВидимостьКомандыВыполнитьОбмен(ЭтаФорма, ОпределяемыеТипы().ДокументыЗЕРНО, "ВыполнитьОбмен");
...
Процедура ОтборОрганизацииПриИзменении(Элемент)
	...
	ИнтеграцияЗЕРНОКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, Организации, Ложь, "Отбор");
	ОбновитьСпискиДокументов();
...
Процедура ОтборОрганизацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ИнтеграцияЗЕРНОКлиент.ОткрытьФормуВыбораОрганизаций(ЭтаФорма, "Отбор", , ОповещениеВыбораОрганизаций());
...
Процедура ОтборОрганизацииОчистка(Элемент, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ИнтеграцияЗЕРНОКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, Неопределено, Ложь, "Отбор");
	ОбновитьСпискиДокументов();
...
Процедура ОтборОрганизацииОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ИнтеграцияЗЕРНОКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, ВыбранноеЗначение, Ложь, "Отбор");
	ОбновитьСпискиДокументов();
...
Процедура ОтборОрганизацияПриИзменении(Элемент)
	...
	ИнтеграцияЗЕРНОКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, Организация, Ложь, "Отбор");
	ОбновитьСпискиДокументов();
...
Процедура НадписьСостояниеОбменаНажатие(Элемент)
	...
	Если ЕстьТолькоСообщенияОжидающиеОтправки Тогда
		...
		ОткрытьФорму("РегистрСведений.ОчередьСообщенийЗЕРНО.ФормаСписка", ПараметрыОткрытияФормы, ЭтаФорма);
...
Процедура ПанельАдминистрирования(Команда)
	...
	ОткрытьФорму("Обработка.ПанельАдминистрированияЗЕРНО.Форма",, ЭтаФорма);
...
Процедура ОткрытьКлассификаторы(Команда)
	...
	ОткрытьФорму("Обработка.ПанельОбменЗЕРНО.Форма.ВыборКлассификатора",, ЭтаФорма);
...
Процедура ОткрытьЗемельныеУчастки(Команда)
	...
	ИнтеграцияИСКлиент.ОткрытьФормуСпискаЗемельныхУчастков(ЭтаФорма);
...
Процедура ОткрытьДоговорыХраненияПартий(Команда)
	...
	ОткрытьФорму("Справочник.ДоговорыХраненияПартийЗЕРНО.ФормаСписка",, ЭтаФорма);
...
Процедура ОткрытьКодыРАФПЗЕРНО(Команда)
	...
	ОткрытьФорму("РегистрСведений.КодыРАФПЗЕРНО.ФормаСписка",, ЭтаФорма);
...
Процедура ОбновитьСпискиДокументов()
	...
	ОтобразитьСостояниеОбмена();
	ОбновитьКоличествоСообщенийКПодписанию();
	СобытияФормЗЕРНО.ДоступностьКомандыВыполнитьОбмен(ЭтаФорма, "ВыполнитьОбмен");
