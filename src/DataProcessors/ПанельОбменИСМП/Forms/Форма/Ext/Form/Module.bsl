...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияИС.УстановитьВидимостьКомандыВыполнитьОбмен(ЭтаФорма, ОпределяемыеТипы().ДокументыИСМП, "ВыполнитьОбмен");
...
Процедура ОткрытьВходящиеДокументыЭДО(Команда)
	...
	Если ВерсияАПИ = 1 Тогда
		...
		ОткрытьФорму(ИмяФормыОбработкиОбменаПоЭДО(), ПараметрыОткрытия, ЭтаФорма);
	Иначе
...
Процедура ПодготовкаСведенийВКаталогGS46(Команда)
	...
	ОткрытьФорму("Обработка.ПодготовкаСведенийВКаталогGS46.Форма.Форма", , ЭтаФорма);
...
Процедура ОткрытьКассыНеПередающиеДанныеВИСМП(Команда)
	...
	ОткрытьФорму("РегистрСведений.КассыНеПередающиеДанныеВИСМП.ФормаСписка", , ЭтаФорма);
...
Процедура НастройкаИСМП(Команда)
	...
	ОткрытьФорму("Обработка.ПанельАдминистрированияИСМП.Форма.НастройкиИСМП", , ЭтаФорма);
...
Процедура ШтрихкодыУпаковок(Команда)
	...
	ОткрытьФорму("Справочник.ШтрихкодыУпаковокТоваров.ФормаСписка", , ЭтаФорма);
...
Процедура ГрупповаяГенерацияИПечатьШтрихкодовЛогистическихУпаковок(Команда)
	...
	ОткрытьФорму("ОбщаяФорма.ГенерацияИПечатьШтрихкодовЛогистическихУпаковок", , ЭтаФорма);
...
Процедура ОтборОрганизацииПриИзменении(Элемент)
	...
	ИнтеграцияИСМПКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, Организации, Ложь, "Отбор");
	ОбновитьСпискиДокументов();
...
Процедура ОтборОрганизацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ИнтеграцияИСМПКлиент.ОткрытьФормуВыбораОрганизаций(ЭтаФорма, "Отбор", , ОповещениеВыбораОрганизаций());
...
Процедура ОтборОрганизацииОчистка(Элемент, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ИнтеграцияИСМПКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, Неопределено, Ложь, "Отбор");
	ОбновитьСпискиДокументов();
...
Процедура ОтборОрганизацииОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ИнтеграцияИСМПКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, ВыбранноеЗначение, Ложь, "Отбор");
	ОбновитьСпискиДокументов();
...
Процедура ОтборОрганизацияПриИзменении(Элемент)
	...
	ИнтеграцияИСМПКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, Организация, Ложь, "Отбор");
	ОбновитьСпискиДокументов();
...
Процедура НадписьАварийныйРежимНажатие(Элемент)
	...
	ПослеЗакрытияФормы   = Новый ОписаниеОповещения("ПослеОбработкиФормыУточненияАварийногоРежима", ЭтаФорма);
...
Процедура НадписьСостояниеОбменаНажатие(Элемент)
	...
	Если ЕстьТолькоСообщенияОжидающиеОтправки Тогда
		...
		ОткрытьФорму("РегистрСведений.ОчередьСообщенийИСМП.ФормаСписка", ПараметрыОткрытияФормы, ЭтаФорма);
...
Процедура ОбработкаНавигационнойСсылкиЛогирования(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылкаФорматированнойСтроки = "ВключитьЛогЗапросов" Тогда
		...
		ОповещениеОВыбора = Новый ОписаниеОповещения("ВыборПродолжительностьЛогаЗавершение", ЭтаФорма, ПараметрыВыбораПродолжительности);
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ОчиститьЛогЗапросов" Тогда
		...
		ОписаниеОповещенияВопросОчиститьЛогЗапросовЗавершение = Новый ОписаниеОповещения("ОписаниеОповещенияВопросОчиститьЛогЗапросовЗавершение", ЭтаФорма);
...
Функция ТекстЗапросаОтработайтеИсходящиеДокументыЭДО()
	...
	|				ИЛИ НЕ ЭлектронныйДокументИсходящий.СостояниеЭДО В (ЗНАЧЕНИЕ(Перечисление.СостоянияВерсийЭД.ЗакрытПринудительно), ИСТИНА)
	|					И ЭДПрисоединенныеФайлы.ТипЭлементаВерсииЭД В (ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.ИП_ПДП_ИП_УПД_УКД), ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.ИП_ПДП_ИП_ЭСФ), ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.ИППДОЭСФ), ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.ИППДПЭСФ), ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.ИПУУЭСФ), ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.ИОП), ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.ИПЭСФ))
...
Функция ТекстЗапросаОжидайтеВходящиеДокументыЭДО()
	...
	|			ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.КСЧФДИСУКД), ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.КСЧФУКД),
	|			ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.ДИСУКД), ЗНАЧЕНИЕ(Перечисление.ТипыЭлементовВерсииЭД.ДОП))
	|		И ЭлектронныйДокументВходящий.СостояниеЭДО В (
	|			ЗНАЧЕНИЕ(Перечисление.СостоянияВерсийЭД.ОжидаетсяАннулирование),
	|			ЗНАЧЕНИЕ(Перечисление.СостоянияВерсийЭД.ОжидаетсяИзвещениеОПолучении),
	|			
	|			ЗНАЧЕНИЕ(Перечисление.СостоянияВерсийЭД.ОжидаетсяОтправка),
...
Процедура ОбновитьСпискиДокументовИСМП()
	...
	ДобавитьДокумент(
		...
		ОпределяемыеТипы().ОснованиеМаркировкаТоваровИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	...
	ДобавитьДокумент(
		...
		ОпределяемыеТипы().ОснованиеПеремаркировкиТоваровИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	...
	ДобавитьДокумент(
		...
		ОпределяемыеТипы().ОснованиеСписаниеКодовМаркировкиИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	...
	ДобавитьДокумент(
		...
		ОпределяемыеТипы().ОснованиеУточненияСведенийОКодахМаркировкиИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	...
	ДобавитьДокумент(
		...
		ОпределяемыеТипы().ОснованиеОтчетИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	...
	ДобавитьДокумент(
		...
		ОпределяемыеТипы().ОснованиеВыводаИзОборотаИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	...
	ДобавитьДокумент(
		...
		ОпределяемыеТипы().ОснованиеВозвратВОборотИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
...
Функция ОповещениеВыбораОрганизаций()
	...
	Возврат Новый ОписаниеОповещения("ПослеВыбораОрганизации", ЭтаФорма);
