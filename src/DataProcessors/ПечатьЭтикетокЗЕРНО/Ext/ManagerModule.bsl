...
Процедура ЗаполнитьРеквизитыШапкиСДИЗРасширеннаяЭтикетка(ДанныеПечати, Макет, ТабличныйДокумент)
	...
	РеквизитыОтправителя = ИнтеграцияИСВызовСервера.ИННКПППоОрганизацииКонтрагенту(ДанныеПечати.Отправитель);
	РеквизитыПолучателя  = ИнтеграцияИСВызовСервера.ИННКПППоОрганизацииКонтрагенту(ДанныеПечати.Получатель);
