...
Функция СкорректироватьСтавкуНДС(СтавкаНДС, Дата) Экспорт
	...
	Если СтавкаНДС = Перечисления.СтавкиНДС.НДС20 Или СтавкаНДС = Перечисления.СтавкиНДС.НДС20_120
		Или СтавкаНДС = Перечисления.СтавкиНДС.НДС22 Или СтавкаНДС = Перечисления.СтавкиНДС.НДС22_122 Тогда
		СтавкаНДСПоУмолчанию = СтавкаНДСПоУмолчанию(Дата, СтавкаНДС = Перечисления.СтавкиНДС.НДС20_120
	...
	Попытка
		...
		Для Каждого Ссылка Из ОбрабатываемыеОбъекты Цикл
			...
			Попытка
				...
				СкорректироватьСтавкуНДС(ИзменяемыйОбъект.СтавкаНДС, '20260101');
