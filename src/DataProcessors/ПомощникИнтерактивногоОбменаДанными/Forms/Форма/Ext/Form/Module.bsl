...
Процедура ИнициализироватьДополнениеВыгрузки()
	...
	ДополнениеВыгрузки.КомпоновщикОтбораВсехДокументов = Данные;
	ДополнениеВыгрузки.АдресКомпоновщикаВсехДокументов = Данные.АдресКомпоновщикаВсехДокументов;
...
Процедура ДополнениеВыгрузкиОткрытьПодборВсехДокументов()
    ...
    ОткрытьФорму("Обработка.ИнтерактивноеИзменениеВыгрузки.Форма.РедактированиеПериодаИОтбора",
        Новый Структура(
            "Заголовок, ДействиеВыбора, ВыборПериода, КомпоновщикНастроек, ПериодДанных, АдресКомпоновщикаНастроек",
...
Функция АдресОбъектаДополнительнойВыгрузки()
	...
	ОбъектРезультат = Новый Структура("УзелИнформационнойБазы, ВариантВыгрузки, КомпоновщикОтбораВсехДокументов, ПериодОтбораВсехДокументов, АдресКомпоновщикаВсехДокументов, АдресХранилищаФормы");
	ЗаполнитьЗначенияСвойств(ОбъектРезультат, ДополнениеВыгрузки,,"АдресКомпоновщикаВсехДокументов");
