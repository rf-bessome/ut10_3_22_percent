...
Процедура ПровестиДокументыПоРегистрамНДС()
	...
	Перем ТаблицаПоТоварам, ТаблицаПоТоварамВалюта, ТаблицаПоПрочее, ТаблицаПоУслугам, ТаблицаПоТаре, ТаблицаПоТоварамВозврат, ТаблицаПоТоварамВзаиморасчеты, ТаблицаПоПрослеживаемымТоварам;
	...
	Пока ДокументВыборка.Следующий() Цикл
		...
		ДокументОбъект.ПодготовитьТаблицыДокумента(СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаПоУслугам, ТаблицаПоТаре, ТаблицаПоПрослеживаемымТоварам);
