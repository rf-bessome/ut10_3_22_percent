...
Процедура ДекорацияФоноваяПроверкаЭДНажатие(Элемент)
	...
	ОписаниеОповещенияОЗакрытии = Новый ОписаниеОповещения("ПослеЗакрытияПанелиАдминистрирования", ЭтаФорма);
	
	ОткрытьФорму("Обработка.ПанельАдминистрированияИСМП.Форма.НастройкиИСМП",, ЭтаФорма,,,, ОписаниеОповещенияОЗакрытии);
...
Процедура ВыполнитьПовторнуюПроверку(Команда)
	...
	ПараметрыОповещения.Вставить("ФормаОшибок", ЭтаФорма);
...
Процедура ЗаполнитьРезультатыПроверок(РезультатПроверки)
	...
	НастроитьВидимостьФоновойПроверкиЭД(ЭтаФорма);
