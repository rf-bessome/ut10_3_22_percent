...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытияФормИСКлиентСерверПереопределяемый.УстановитьПараметрыВыбораНоменклатуры(ЭтаФорма, ВидМаркируемойПродукции,
	...
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСХарактеристикой(ЭтаФорма,
...
Процедура ПриОткрытии(Отказ)
	...
	Если ВосстановленыСохраненныеРезультатыПроверки Тогда
		...
		УправлениеДоступностьюКомандыУточнитьДанныеПодобраннойПродукции(ЭтаФорма);
	...
	УстановитьЗаголовокКомандыПроверкиПоВладельцу(ЭтаФорма);
	УстановитьЗаголовокКомандыПроверкиСтатусовКодовМаркировки(ЭтаФорма);
	УстановитьЗаголовокКомандыОбратноеСканирование(ЭтаФорма);
...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	Если ЗначениеЗаполнено(РежимПроверкиИзНастроек) Тогда
		...
		СформироватьПредставлениеНастроек(ЭтаФорма);
	КонецЕсли;
...
Процедура ПередЗакрытием(Отказ,  СтандартнаяОбработка)
	...
	Если Не ВыполняетсяЗакрытие Тогда
		...
		Если Модифицированность Тогда
			...
			ОписаниеОповещенияПослеВопросаПриЗакрытииФормы = Новый ОписаниеОповещения("ПослеВопросаПриЗакрытииФормы", ЭтаФорма);
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ИспользоватьХарактеристикиНоменклатуры Тогда
		СобытияФормИСМПКлиентПереопределяемый.ОбработкаВыбораХарактеристики(
			Новый ОписаниеОповещения("ПриВыбореХарактеристики", ЭтаФорма), ВыбранноеЗначение, ИсточникВыбора);
	КонецЕсли;
...
Процедура ОбработкаЗаписиНового(НовыйОбъект, Источник, СтандартнаяОбработка)
	...
	Если ИспользоватьХарактеристикиНоменклатуры Тогда
		СобытияФормИСМПКлиентПереопределяемый.ОбработкаВыбораХарактеристики(
			Новый ОписаниеОповещения("ПриВыбореХарактеристики", ЭтаФорма), НовыйОбъект, Источник);
	КонецЕсли;
...
Процедура ПредставлениеСохраненногоВыбораОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИнтеграцияИСКлиент.ПредставлениеСохраненногоВыбораОбработкаНавигационнойСсылки(ЭтаФорма, НавигационнаяСсылкаФорматированнойСтроки);
...
Процедура ДекорацияИнформацияТребуетсяПеремаркировкаОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылкаФорматированнойСтроки = "ИзменитьОтборТребуетсяПеремаркировка" Тогда
		...
		Иначе
			ПроверитьПризнакУстановкиОтбораВДереве(ЭтаФорма);
		КонецЕсли;
		
		ПроверкаИПодборПродукцииИСМПКлиентСервер.ОтобразитьИнформациюОНеобходимостиПеремаркировки(ЭтаФорма);
...
Процедура ДекорацияНедопустимыеКодыМаркировкиОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылкаФорматированнойСтроки = "ИзменитьОтборНедопустимыеКодыМаркировки" Тогда
		...
		ПроверкаИПодборПродукцииИСМПКлиентСервер.ОтобразитьИнформациюОНедопустимыхКодахМаркировки(ЭтаФорма);
...
Процедура ПредставлениеРежимаПроверкиОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылкаФорматированнойСтроки = "ИзменитьРежимПроверки" Тогда
		...
		ОповещениеОИзмененииРежимаПроверки = Новый ОписаниеОповещения("ПослеИзмененияРежимаПроверки", ЭтаФорма);
		
		ОткрытьФорму(
			"Обработка.ПроверкаИПодборПродукцииИСМП.Форма.ИзменениеРежимаПроверки", ПараметрыОткрытия, ЭтаФорма,
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ИзменитьДетализацию" Тогда
		...
		ОповещениеОИзмененииРежимаДетализации = Новый ОписаниеОповещения("ПослеИзмененияРежимаДетализации", ЭтаФорма);
		
		ОткрытьФорму(
			"Обработка.ПроверкаИПодборПродукцииИСМП.Форма.ИзменениеДетализации", ПараметрыОткрытия, ЭтаФорма,
			УникальныйИдентификатор,,,
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ИзменитьРежимДобавленияКодовМаркировки" Тогда
		...
		ПараметрыОткрытия.Вставить("ДопустимыеРежимыДобавления",     ПроверкаИПодборПродукцииИСМПКлиентСервер.ДопустимыеРежимыДобавленияКодовМаркировки(ЭтаФорма));
		ПараметрыОткрытия.Вставить("РекомендуемыйРежимДобавления",   ПроверкаИПодборПродукцииИСМПКлиентСервер.РекомендуемыйРежимДобавленияКодовМаркировки(ЭтаФорма));
		
		ОповещениеОИзмененииРежимаДобавленияКМ = Новый ОписаниеОповещения("ПослеИзмененияРежимаДобавленияКодовМаркировки", ЭтаФорма);
		
		ОткрытьФорму(
			"Обработка.ПроверкаИПодборПродукцииИСМП.Форма.ИзменениеРежимаДобавленияКодовМаркировки", ПараметрыОткрытия, ЭтаФорма,
			УникальныйИдентификатор,,,
...
Процедура ДеревоМаркированнойПродукцииПриАктивизацииСтроки(Элемент)
	...
	ПроверкаИПодборПродукцииИСМПКлиентСервер.ОбновитьВыводимоеПредставлениеПроверкиСодержимого(ЭтаФорма, ТекущиеДанные);
...
Процедура ДеревоМаркированнойПродукцииСтатусПроверкиПриИзменении(Элемент)
	...
	Если ТекущиеДанные.СтатусПроверки = ПредопределенноеЗначение("Перечисление.СтатусыПроверкиНаличияПродукцииИС.Отсутствует") Тогда
		УстановитьСтатусОтсутствуетДляПодчиненных(ЭтаФорма, ТекущиеДанные);
	...
	Если ТаблицаИзмененийПодобраннойПродукции.Количество() > 0 Тогда
		ОбработатьТаблицуИзмененийПодобраннойПродукции(ЭтаФорма, КэшированныеЗначения);
	КонецЕсли;
...
Процедура ПодобраннаяМаркируемаяПродукцияНоменклатураПриИзменении(Элемент)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриИзмененииНоменклатуры(ЭтаФорма,
...
Процедура ПодобраннаяМаркируемаяПродукцияНоменклатураСоздание(Элемент, СтандартнаяОбработка)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриСозданииНоменклатуры(ЭтаФорма,
...
Процедура ПодобраннаяМаркируемаяПродукцияХарактеристикаПриИзменении(Элемент)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриИзмененииХарактеристики(ЭтаФорма,
...
Процедура ПодобраннаяМаркируемаяПродукцияХарактеристикаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриНачалеВыбораХарактеристики(ЭтаФорма,
...
Процедура ПодобраннаяМаркируемаяПродукцияХарактеристикаСоздание(Элемент, СтандартнаяОбработка)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриСозданииХарактеристики(ЭтаФорма,
...
Процедура МаркироватьУпаковку(Команда)
	...
	ОткрытьФорму("Обработка.ГенерацияШтрихкодовУпаковок.Форма.Форма", ДанныеУпаковки, ЭтаФорма,,,,
...
Процедура ЗагрузитьИзВнешнегоФайла(Команда)
	...
	ДоступнаИерархия = (ЭтоДокументМаркировка(ЭтаФорма) Или ЭтоДокументПриобретения);
	
	ИнтеграцияИСКлиент.ОткрытьФормуЗагрузкиКодовМаркировки(
		ЭтаФорма,
		ДоступнаИерархия,
		ИнтеграцияИСМПКлиент.ЗаголовокФормыЗагрузкиКодовМаркировки(
			ЭтаФорма, Истина)); // ДоступнаИерархия Истина - для упрощения заголовка
...
Процедура ВыгрузитьВТСД(Команда)
	...
	МенеджерОборудованияИСКлиент.НачатьВыгрузкуДанныеВТСД(
		Новый ОписаниеОповещения("ВыгрузитьВТСДЗавершение", ЭтаФорма),
		УникальныйИдентификатор,
		Неопределено,
...
Процедура РазобратьУпаковку(Команда)
	...
	ПроверкаИПодборПродукцииИСМПКлиент.ПересчитатьХешСуммыВсехУпаковок(ЭтаФорма);
...
Процедура НачатьПроверкуЗаново(Команда)
	...
	ОписаниеОповещенияПослеОтвета = Новый ОписаниеОповещения("ПослеВопросаОНачалеПроверкиЗаново", ЭтаФорма);
	...
	Если ВариантыЗаполнения.Количество() Тогда
		...
		ПоказатьВопрос(
			Новый ОписаниеОповещения(
				"Подключаемый_ПослеВопросаЗагрузкиКодовПоОснованию", ЭтаФорма),
...
Процедура ПечатьКодовМаркировки(Команда)
	...
	Если ДанныеДляПечати.АдресВременногоХранилища <> Неопределено Тогда
		...
		ОткрытьФорму("РегистрСведений.ПулКодовМаркировкиСУЗ.Форма.ФормаПечати",
			ПараметрыФормыПечати, ЭтаФорма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура Подключаемый_ВыполнитьПереопределяемуюКоманду(Команда) Экспорт
	СобытияФормИСМПКлиент.ВыполнитьПереопределяемуюКоманду(ЭтаФорма, Команда, Неопределено);
КонецПроцедуры

&НаСервере
Процедура Подключаемый_ВыполнитьПереопределяемуюКомандуНаСервере(Контекст, Результат) Экспорт
	СобытияФормИСМП.ВыполнитьПереопределяемуюКоманду(ЭтаФорма, Контекст, Неопределено, Результат);
КонецПроцедуры
...
Процедура ПроверитьСостояниеКодовМаркировкиНемедленно(Команда)
	...
	Если ОшибкаКлюча Тогда
		ЗапроситьКлючСессииНачало(
			Ложь,
			Новый ОписаниеОповещения("ПроверитьСтатусыКодовМаркировкиПослеПолученияКлючаСессии", ЭтаФорма, ПараметрыПроверки));
	КонецЕсли;
...
Процедура ДобавитьОСУ(Команда)
	...
	ОповещениеОЗавершении = Новый ОписаниеОповещения("УточнитьДанныеПодобраннойПродукцииЗавершение", ЭтаФорма, ПараметрыОповещения);
	...
	ОткрытьФорму("ОбщаяФорма.ФормаУточненияПодобраннойПродукцииИСМП", ПараметрыОткрытияФормы, ЭтаФорма,,,, ОповещениеОЗавершении);
...
Процедура СчитатьRFID(Команда)
	...
	СобытияФормИСКлиент.ОткрытьСессиюСчитывателяRFID(ЭтаФорма);
...
Процедура ДеревоМаркированнойПродукцииПередУдалениемДействие(ЭлементИлиВыделенныеСтроки, Отказ, ЭтоВосстановлениеДетализации)
			...
			Иначе
				...
				ИначеЕсли ИнтеграцияИСКлиентСервер.ЭтоУпаковка(УдаляемыйЭлемент.ТипУпаковки) Тогда
					...
					ИначеЕсли ИнтеграцияИСКлиентСервер.ЭтоУпаковка(УдаляемыйЭлемент.ТипУпаковки) Тогда
						...
						КонецЕсли;
					Иначе
						Если Не ЭтоДокументМаркировка(ЭтаФорма) Тогда
							ЕстьОшибка = Истина;
						КонецЕсли;
					КонецЕсли;
	...
	Если ИдентификаторТекущейПроверяемойУпаковки <> -1 Тогда
		...
		Если ИдентификаторСтрокиГрупповыеУпаковкиБезКоробки <> -1 И ИдентификаторТекущейПроверяемойУпаковки = ИдентификаторСтрокиГрупповыеУпаковкиБезКоробки Тогда
			ИдентификаторТекущейПроверяемойУпаковки = -1;
			СтрокаГрупповыеУпаковкиБезКоробки(ЭтаФорма).ИдетПроверкаДаннойУпаковки = Ложь;
		КонецЕсли;
	КонецЕсли;
...
Процедура ДеревоМаркированнойПродукцииПослеУдаленияДействие()
	...
	Если ИдентификаторСтрокиПотребительскиеУпаковкиБезУпаковки <> - 1
		И СтрокаПотребительскиеУпаковкиБезУпаковки(ЭтаФорма) = Неопределено Тогда
	...
	Если ИдентификаторСтрокиГрупповыеУпаковкиБезКоробки <> - 1
		И СтрокаГрупповыеУпаковкиБезКоробки(ЭтаФорма) = Неопределено Тогда
...
Процедура СгенерироватьСерииПодобраннойМаркируемойПродукции()
	...
	ПроверкаИПодборПродукцииИСМПКлиент.ЗаполнитьСерииВПодобраннойМаркируемойПродукции(ЭтаФорма,
...
Процедура УстановитьСтатусДляВыделенныхСтрок(ВыделенныеСтроки, НовыйСтатус, ЭтоВосстановлениеДетализации = Ложь, ДляНепроверенных = Ложь)
	...
	Для Каждого ИдентификаторВыделеннойСтроки Из ВыделенныеСтроки Цикл
		...
		Иначе
			...
			Если НовыйСтатус = ПредопределенноеЗначение("Перечисление.СтатусыПроверкиНаличияПродукцииИС.Отсутствует") Тогда
				УстановитьСтатусОтсутствуетДляПодчиненных(ЭтаФорма, ДанныеСтроки, Ложь);
			КонецЕсли;
...
Процедура ПриИзмененииСтатусаПроверкиСтрокиОСУ(СтрокаОбъемноСортовогоКода, НовыйСтатусПроверки, ДляНепроверенных)
	...
	Если НовыйСтатусПроверки = ПредопределенноеЗначение("Перечисление.СтатусыПроверкиНаличияПродукцииИС.ВНаличии")
		...
		ПроверкаИПодборПродукцииИСМПКлиентСервер.ПодобраннаяПродукцияПриДобавленииСтроки(
			ЭтаФорма, СтрокаИзменений, СтрокаИзменений.КоличествоПотребительскихУпаковок, ПроверкаИПодборПродукцииИСМПКлиент, ДополнительныеПараметры, КэшированныеЗначения);
	...
	ИначеЕсли НеобходимоУменьшитьКоличествоПодобраннойПродукции(РежимПодбораСуществующихУпаковок, СтрокаОбъемноСортовогоКода, НовыйСтатусПроверки) Тогда
		...
		Иначе
			...
			Если СтрокаОбъемноСортовогоКода.КоличествоПодчиненныхНеЧислилось > 0 Тогда
				...
				ПроверкаИПодборПродукцииИСМПКлиентСервер.ПодобраннаяПродукцияПриУдаленииСтроки(
					ЭтаФорма, СтрокаИзменений, КоличествоУпаковокКИзменению, ПроверкаИПодборПродукцииИСМПКлиент, ДополнительныеПараметры, КэшированныеЗначения);
	...
	НормализироватьШтрихкодУпаковкиПоСоставуВложенныхУпаковок(ЭтаФорма, СтрокаОбъемноСортовогоКода, СоответствиеШтрихкодовСтрокДерева);
...
Процедура ПересчитатьВсеИтогиФормыНаСервере()
	...
	ПроверкаИПодборПродукцииИСМП.ПересчитатьХешСуммыВсехУпаковок(ЭтаФорма);
	
	ПересчитатьВсеИтогиФормы(ЭтаФорма);
...
Процедура ПеремаркироватьУпаковку(Штрихкод, ИдентификаторСтрокиУпаковки)
	...
	ЗаменитьШтрихКодВСпискахУпаковок(ЭтаФорма,СтрокаСУпаковкой.Штрихкод, Штрихкод);
...
Процедура ПриИзмененииМаркировкиСоставаУпаковкиНаКлиенте(ИдентификаторСтрокиУпаковки, ПроверятьТипУпаковки, ДополнительныеПараметры = Неопределено)
	...
	ОбработатьТаблицуИзмененийПодобраннойПродукции(ЭтаФорма, КэшированныеЗначения, ДополнительныеПараметры);
...
Процедура ПроверитьНеобходимостьМаркировкиПриИзмененииСтроки(ИдентификаторИзмененойСтроки)
	...
	ПроверкаИПодборПродукцииИС.ОбработататьТаблицуПеремаркировкиСУчетомДетализации(ЭтаФорма, ТаблицаПеремаркировки, ШтрихкодИДанныеУпаковки);
	
	ПроверкаИПодборПродукцииИСМПКлиентСервер.ПроверитьНеобходимостьПеремаркировки(ЭтаФорма, ТаблицаПеремаркировки, Истина);
...
Процедура ЗапроситьКлючСессииНачало(ПовторныйЗапрос = Ложь, ОповещениеПриЗавершении = Неопределено, ЭтоВосстановлениеДетализации = Ложь)
	...
	Иначе
		ОповещениеПриЗапросеКлючаСессии = Новый ОписаниеОповещения("ЗапроситьКлючСессииЗавершение", ЭтаФорма, ДополнительныеПараметры);
	КонецЕсли;
	...
	Если ТребуетсяОбновлениеКлючаСессииРозница Тогда
		...
		Если ТребуетсяОбновлениеКлючаСессии Тогда
			...
			ОповещениеПриВыполнении = Новый ОписаниеОповещения("ЗапроситьКлючСессииРозницы", ЭтаФорма, ДополнительныеПараметры);
...
Процедура ПриПодключенииКСервисуИСМП()
	...
	УправлениеЭлементамиКонтроляСтатусаКодовМаркировки(ЭтаФорма);
...
Процедура ПриОшибкеПодключенияКСервисуИСМП(ТекстОшибки, ЭтоВосстановлениеДетализации)
	...
	ИначеЕсли Открыта() Тогда
		ПоказатьПредупреждение(Новый ОписаниеОповещения("ЗакрытьФорму", ЭтаФорма), ТекстОшибки);
	КонецЕсли;
...
Процедура ОбработатьИПроверитьПереданныеПараметры(Отказ)
	...
	ИнтеграцияИСПереопределяемый.ЗаполнитьПараметрыУказанияСерий(ПараметрыУказанияСерий, Метаданные.Обработки.ПроверкаИПодборПродукцииИСМП, ЭтаФорма);
	...
	РежимДобавленияКодовМаркировки = ПроверкаИПодборПродукцииИСМПКлиентСервер.РекомендуемыйРежимДобавленияКодовМаркировки(ЭтаФорма);
...
Процедура ЗаполнитьПараметрыПроверкиКодовМаркировки(Отказ)
	...
	Если Не Отказ Тогда
		...
		Если ЭтоДокументМаркировка(ЭтаФорма)
...
Процедура ВывестиДанныеПроверкиИПодбораНаФорму(ДанныеПроверкиИПодбора)
	...
	ПроверкаИПодборПродукцииИСМППереопределяемый.ЗаполнитьСлужебныеРеквизитыВКоллекции(ЭтаФорма, ПодобраннаяМаркируемаяПродукция);
	ПроверкаИПодборПродукцииИСМППереопределяемый.ЗаполнитьСтатусыУказанияСерий(ЭтаФорма, ПараметрыУказанияСерий);
	...
	Если ДанныеПроверкиИПодбора.Свойство("РежимДобавленияКодовМаркировки") Тогда
		ДопустимыеРежимыДобавленияКМ = ПроверкаИПодборПродукцииИСМПКлиентСервер.ДопустимыеРежимыДобавленияКодовМаркировки(ЭтаФорма);
	...
	Если ДанныеПроверкиИПодбора.Свойство("ШтрихкодТекущейПроверяемойУпаковки") Тогда
		...
		Если ЗначениеЗаполнено(ШтрихкодТекущейПроверяемойУпаковки) Тогда
			...
			Если ИдентификаторСтроки <> Неопределено Тогда
				...
				ПроверкаИПодборПродукцииИСМПКлиентСервер.ОбновитьВыводимоеПредставлениеПроверкиСодержимого(ЭтаФорма, ДанныеТекущейСтроки);
			Иначе
				ИдентификаторТекущейПроверяемойУпаковки = -1;
			КонецЕсли;
		КонецЕсли;
...
Процедура ДобавитьИЗаполнитьКолонкиПриВосстановленииПодобраннойМаркируемойПродукции(ПодобраннаяМаркируемаяПродукцияОбъект, СоответствиеПараметров)
	...
	ДополнитьОписаниеКолонок(Коллекция, "ИдентификаторПроисхожденияВЕТИС",                       ОпределяемыеТипы().ИдентификаторПроисхожденияВЕТИС.Тип);
...
Процедура ДобавитьИЗаполнитьКолонкиПриВосстановленииДерева(ДеревоМаркированнойПродукцииОбъект, СоответствиеПараметров)
	...
	ДополнитьОписаниеКолонок(Коллекция, "ЧастичноеВыбытиеНоменклатура",                     ОпределяемыеТипы().Номенклатура.Тип);
	ДополнитьОписаниеКолонок(Коллекция, "ЧастичноеВыбытиеХарактеристика",                   ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	...
	Если ОбщегоНазначенияКлиентСервер.СравнитьВерсии(ИнтеграцияИС.ВерсияБиблиотеки(), "1.1.28.16") >= 0 Тогда
		...
		ДополнитьОписаниеКолонок(Коллекция, "РазрешительныйРежимИдентификаторЗапросаГИСМТ", ОпределяемыеТипы().УникальныйИдентификаторИС.Тип);
	Иначе
		...
		ДополнитьОписаниеКолонок(Коллекция, "ИдентификаторЗапросаГИСМТ",                    ОпределяемыеТипы().УникальныйИдентификаторИС.Тип);
	КонецЕсли;
...
Процедура ЗагрузитьДанныеДокумента(ЭтоВосстановлениеДетализации = Ложь)
	...
	Если ДлительнаяОперация <> Неопределено Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения("ЗагрузкаДанныхДокументаЗавершение", ЭтаФорма);
	...
	Иначе
		...
		ИначеЕсли ЭтоДокументМаркировка(ЭтаФорма)
			И (ДетализацияСтруктурыХранения = ПредопределенноеЗначение("Перечисление.ДетализацияСтруктурыХраненияИС.КоробаСГрупповымиУпаковками")
				Или ДетализацияСтруктурыХранения = ПредопределенноеЗначение("Перечисление.ДетализацияСтруктурыХраненияИС.ПалетыСМонотоварнымиКоробами")) Тогда
...
Процедура ЗагрузкаДанныхДокументаЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Результат.Статус = "Ошибка" Тогда
		ПоказатьПредупреждение(Новый ОписаниеОповещения("ЗакрытьФорму", ЭтаФорма), Результат.КраткоеПредставлениеОшибки);
	ИначеЕсли Результат.Статус = "Выполнено" Тогда
		...
		ИначеЕсли РезультатЗагрузкиДанных.Действие = "УточнитьКоэффициентыУпаковок" Тогда
			...
			УточнениеКоэффициентовУпаковокБезПодключенияЗавершение = Новый ОписаниеОповещения(
				"УточнениеКоэффициентовУпаковокБезПодключенияЗавершение", ЭтаФорма, ДополнительныеПараметры);
			...
			ИнтеграцияИСМПКлиент.ОткрытьФормуНастройкиВидовУпаковокПоGTIN(
				ПараметрыОткрытия, ЭтаФорма, УточнениеКоэффициентовУпаковокБезПодключенияЗавершение);
		Иначе
...
Процедура РассчитатьИтогиУстановитьВидимость()
	...
	УправлениеДоступностьюКомандУпаковок(ЭтаФорма);
	УправлениеДоступностьюКомандыУточнитьДанныеПодобраннойПродукции(ЭтаФорма);
...
Процедура УправлениеЭлементамиФормыПриСоздании()
	...
	Если ЭтоДокументМаркировка(ЭтаФорма) Тогда
...
Функция ТребуетсяВопросПередЗавершениемПроверки(ПропуститьПроверкуКоличества = Ложь)
	...
	Если ЭтоДокументМаркировка(ЭтаФорма) И КоличествоНедопустимыхКодовМаркировки > 0 Тогда
	...
	ИначеЕсли ТребуетсяВопросПоНепровереннымОтложенным Тогда
		...
		ОписаниеОповещенияПослеОтветаНаВопрос = Новый ОписаниеОповещения(
			"ОтветНаВопросПриЗавершенииПроверки", ЭтаФорма, ДополнительныеПараметры);
		
		ОткрытьФорму("Обработка.ПроверкаИПодборПродукцииИСМП.Форма.ВопросПередСохранениемРезультатовПроверки",
		             ПараметрыОткрытияФормы, ЭтаФорма, УникальныйИдентификатор,,,
...
Функция ИтогиПроверкиПриЗавершении()
	...
	Если ДопустимаПроизвольнаяЕдиницаУчета
		...
		СтрокаОбъемноСортовогоУчета = СтрокаОбъемноСортовойУчет(ЭтаФорма);
...
Процедура ЗавершитьПроверку(СоздаватьАктОРасхождениях)
	...
	ОповещениеОЗавершении = Новый ОписаниеОповещения("ЗавершениеПроверкиОкончание", ЭтаФорма);
...
Функция НачатьЗавершениеПроверки(ПараметрыОкончанияПроверки)
	...
	Если ПриЗавершенииСохранятьРезультатыПроверки Тогда
		ДанныеРезультатовПроверки = ПроверкаИПодборПродукцииИСМП.ДанныеРезультатовПроверки(ЭтаФорма);
...
Функция РезультатыПроверкиУспешноСохранены()
	...
	Если ПроверкаИПодборПродукцииИСМП.РезультатыПроверкиУспешноСохранены(
		ЭтаФорма, ВидМаркируемойПродукции, ТекстОшибки) Тогда
		Возврат Истина;
	КонецЕсли;
...
Функция ИдентификаторСтрокиДереваПоШтрихкоду(Штрихкод, Нормализовать = Ложь)
	...
	Если Нормализовать Тогда
		...
		ПользовательскиеПараметрыРазбораКодаМаркировки.ВалидироватьШтрихкодЛогистическойУпаковкиGS1128СОшибками = (Не ЭтоДокументМаркировка(ЭтаФорма));
...
Процедура ИнициализироватьПараметрыСканирования(НачальнаяИнициализация = Ложь)
	...
	ИначеЕсли ПроверкаНеПоДокументу Тогда
		Если ПроверкаИПодборПродукцииИСМПКлиентСервер.ЭтоЧекККМ(ВладелецФормы)
			...
			КонтрольСоставаУпаковок = Ложь;
		КонецЕсли;
	ИначеЕсли ЭтоДокументМаркировка(ЭтаФорма) Тогда
		КонтрольСоставаУпаковок = Ложь;
	КонецЕсли;
...
Функция ОбработатьСобытиеПотоковойПечати(ДанныеШтрихкода, ПараметрыСканирования, ДополнительныеПараметры)
	...
	Если ШтрихкодированиеИСМПКлиент.ЭтоСобытиеПотоковойПечати(ЭтаФорма, ДанныеШтрихкода, ПараметрыСканирования) Тогда
		Если ПараметрыСканирования.ДанныеВыбораПоМаркируемойПродукции.ТребуетВзвешивания
			...
			И (ДополнительныеПараметры = Неопределено Или Не ДополнительныеПараметры.Свойство("РезультатВзвешивания"))Тогда
				...
				Возврат Истина;
		Иначе
			ШтрихкодированиеИСМПКлиент.ОбработатьСобытиеПотоковойПечати(ЭтаФорма, ДанныеШтрихкода, ПараметрыСканирования, ДополнительныеПараметры);
		КонецЕсли;
	КонецЕсли;
...
Процедура РучнойВводШтрихкодаЗавершение(ДанныеШтрихкода, ДополнительныеПараметры) Экспорт
	...
	ШтрихкодированиеИСМПКлиент.ОбработатьСобытиеСканированияGTINДляОСУ(ЭтаФорма, ДанныеШтрихкода, ПараметрыСканирования);
	...
	Если ОбработатьДанныеШтрихкода Тогда
		...
		ШтрихкодированиеИСКлиент.ОбработатьДанныеШтрихкода(
			"ПоискПоШтрихкодуЗавершение", ЭтаФорма, ДанныеШтрихкода, ПараметрыСканирования, ДанныеРазбора, ДополнительныеПараметры);
	...
	Иначе
		...
		ОповещениеПриЗавершении = Новый ОписаниеОповещения("ПоискПоШтрихкодуЗавершение", ЭтаФорма, ДополнительныеПараметры);
...
Процедура ОбработатьСканированиеИмеющегосяВДеревеШтрихкода(ДанныеШтрихкода, ТекущаяСтрокаДерева, ИдентификаторНайденнойСтроки)
	...
	Иначе
		...
		ЗаполнитьСтрокуДереваПоДаннымШтрихкода(ЭтаФорма, НайденнаяСтрокаДерева, ДанныеШтрихкода, ТаблицаИзмененийПодобраннойПродукции, КэшированныеЗначения);
...
Функция ТребуетсяОткрытиеФормыВыбораДействия(НайденнаяСтрокаДерева, ТекущаяСтрокаДерева, ТипУпаковкиГдеНашли)
	...
	ИначеЕсли ИнтеграцияИСКлиентСервер.ЭтоУпаковка(НайденнаяСтрокаДерева.ТипУпаковки) Тогда
		...
		СтрокаПроверяемойУпаковки = СтрокаТекущейПроверяемойУпаковки(ЭтаФорма, Истина, ЭтоГрупповаяУпаковка);
	...
	Иначе
		...
		СтрокаПроверяемойУпаковки = СтрокаТекущейПроверяемойУпаковки(ЭтаФорма, Ложь, Ложь);
...
Процедура ОбработатьНайденныйВДеревеШтрихкод(НайденнаяСтрокаДерева, ТекущаяСтрокаДерева, ДанныеШтрихкода = Неопределено)
	...
	Если ИнтеграцияИСКлиентСервер.ЭтоУпаковка(НайденнаяСтрокаДерева.ТипУпаковки) Тогда
		...
		Если НайденнаяСтрокаДерева.ИдетПроверкаДаннойУпаковки Тогда
			...
			СнятьПризнакПроверкиУпаковки(ЭтаФорма, НайденнаяСтрокаДерева, СнятьПризнакПроверкиУРодителя, СоответствиеШтрихкодовСтрокДерева);
			СпозиционироватьсяНаСтрокеДерева(ЭтаФорма, НайденнаяСтрокаДерева);
		...
		ИначеЕсли РодительНайденнойСтроки = СтрокаПроверяемойУпаковки
			...
			Если НайденнаяСтрокаДерева = ТекущаяСтрокаДерева Тогда
				...
				Если ИсходныйСтатусПроверки = ПредопределенноеЗначение("Перечисление.СтатусыПроверкиНаличияПродукцииИС.ВНаличии")
					...
					ИзменитьСостояниеПроверкиУпаковки(ЭтаФорма, НайденнаяСтрокаДерева, СоответствиеШтрихкодовСтрокДерева);
				КонецЕсли;
				
			Иначе
				
				Если РодительНайденнойСтроки = Неопределено Тогда
					СнятьПризнакПроверкиУпаковки(ЭтаФорма, ТекущаяСтрокаДерева,, СоответствиеШтрихкодовСтрокДерева);
				КонецЕсли;
		...
		ИначеЕсли ДетализацияСтруктурыХранения = ПредопределенноеЗначение("Перечисление.ДетализацияСтруктурыХраненияИС.КоробаСГрупповымиУпаковками")
			...
			ОтметитьСтрокуКакНайденную(НайденнаяСтрокаДерева);
			СнятьПризнакПроверкиУпаковки(ЭтаФорма, СтрокаПроверяемойУпаковки,, СоответствиеШтрихкодовСтрокДерева);
			СпозиционироватьсяНаСтрокеДерева(ЭтаФорма, НайденнаяСтрокаДерева);
...
Процедура ОткрытьФормуВыбораДействия(ДанныеШтрихкода, НайденнаяСтрокаДерева, ТипУпаковкиГдеНашли)
	...
	ОповещениеПослеВыбораДействия = Новый ОписаниеОповещения("ВыборДействияПоРезультатамВводаШтрихкодаПриЗавершении", ЭтаФорма, ДополнительныеПараметры);
	...
	ОткрытьФорму("Обработка.ПроверкаИПодборПродукцииИСМП.Форма.ВыборДействияПоРезультатамВводаШтрихкода", ПараметрыОткрытияФормы,
		ЭтаФорма, УникальныйИдентификатор,,, ОповещениеПослеВыбораДействия, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ОбработатьНеНайденныйВДеревеШтрихКод(ДанныеШтрихкода, ТекущаяСтрокаДерева)
	...
	ИначеЕсли ЭтоГрупповаяУпаковкаИлиНабор(ДанныеШтрихкода.ВидУпаковки) Тогда
		ЭтоШтрихкодЛогистическойУпаковки   = ЭтоДокументМаркировка(ЭтаФорма);
	...
	ИначеЕсли ДанныеШтрихкода.ВидУпаковки = ПредопределенноеЗначение("Перечисление.ВидыУпаковокИС.Логистическая") Тогда
		...
		ЭтоШтрихкодПотребительскойУпаковки = Не ЭтоДокументМаркировка(ЭтаФорма)
	...
	Если РежимПодбораСуществующихУпаковок И ЭтоШтрихкодПотребительскойУпаковки Тогда
		...
		Если Не ПродукцияСоответствуетДокументуОснованию(ЭтаФорма, ДанныеШтрихкода) Тогда
			...
			ОповещениеЗакрытияФормы = Новый ОписаниеОповещения("ИнформацияОНевозможностиДобавленияОтсканированногоПослеЗакрытия", ЭтаФорма);
			
			ШтрихкодированиеИСМПКлиент.ОткрытьФормуНевозможностиДобавленияОтсканированного(ЭтаФорма, ДанныеШтрихкода, ОповещениеЗакрытияФормы);
		...
		ИначеЕсли Не (ЗначениеЗаполнено(ДанныеШтрихкода.Номенклатура)
			...
			ШтрихкодированиеИСМПКлиент.ОткрытьФормуНевозможностиДобавленияОтсканированного(ЭтаФорма, ДанныеШтрихкода);
	...
	Если ДанныеШтрихкода.МаркируемаяПродукция = Истина
		...
		ШтрихкодированиеИСКлиент.ОткрытьФормуСчитыванияКодаМаркировки(
			ЭтаФорма, ПараметрыОткрытияФормы);
	...
	Если ЭтоШтрихкодЛогистическойУпаковки Тогда
		...
		Если СохраненВыборПоМаркируемойПродукции
			...
			Или ЭтоДокументМаркировка(ЭтаФорма) Тогда
			...
			Если Не ДанныеШтрихкода.Свойство("ЭтоГенерацияШтрихкодовУпаковок")
				...
				ТекущаяПроверяемаяУпаковка = НайтиПоИдентификатору(ДеревоМаркированнойПродукции, ИдентификаторТекущейПроверяемойУпаковки);
				СнятьПризнакПроверкиУпаковки(ЭтаФорма, ТекущаяПроверяемаяУпаковка, Истина, СоответствиеШтрихкодовСтрокДерева);
			КонецЕсли;
		...
		Иначе
			...
			ОткрытьФорму("Обработка.ПроверкаИПодборПродукцииИСМП.Форма.ВыборДействияПоРезультатамВводаШтрихкода",
				...
				ЭтаФорма, УникальныйИдентификатор,,, ОповещениеПослеВыбораДействия,
...
Процедура ПроверитьШтрихкодВДеревеМаркированнойПродукции(ДанныеШтрихкода)
	...
	ИначеЕсли ЭтоАдресВременногоХранилища(ДанныеШтрихкода.АдресДереваУпаковок)
		...
		Если Результат.ЕстьОшибки Тогда
			...
			ШтрихкодированиеИСМПКлиент.ОткрытьФормуНевозможностиДобавленияОтсканированного(ЭтаФорма, ПараметрыОткрытияФормы);
...
Процедура ОткрытьФормуУточненияДанных(ИдентификаторСтрокиДерева, ТекущаяСтрокаДерева, ПроизвольноеРедактированиеРеквизитов = Ложь)
	...
	ОповещениеПоЗавершениюУточненияДанных = Новый ОписаниеОповещения("УточнитьДанныеУПользователяЗавершение", ЭтаФорма, ДополнительныеПараметры);
	
	ШтрихкодированиеИСКлиент.УточнитьДанныеУПользователя(ЭтаФорма, ПараметрыОткрытияФормы, ОповещениеПоЗавершениюУточненияДанных);
...
Процедура УточнитьДанныеУПользователяЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ШтрихкодированиеИСКлиентСервер.ОбработатьСохраненныйВыборДанныхПоМаркируемойПродукции(
		ЭтаФорма, Результат.ДанныеВыбора, Результат.ЗапомнитьВыбор);
...
Процедура ОтметитьСтрокуКакНайденную(СтрокаДерева)
	...
	СпозиционироватьсяНаСтрокеДерева(ЭтаФорма, СтрокаДерева);
...
Процедура ДобавитьНовуюУпаковку(ДанныеШтрихкода, ТипУпаковки, СпозиционироватьсяНаДобавленной = Истина)
	...
	Иначе
		ВидУпаковки = ВидУпаковкиПоВходящимДанным(ДанныеШтрихкода, ВидМаркируемойПродукции, ЭтоДокументМаркировка(ЭтаФорма));
	КонецЕсли;
	...
	Если ДетализацияСтруктурыХранения = ПредопределенноеЗначение("Перечисление.ДетализацияСтруктурыХраненияИС.ПотребительскиеУпаковки") Тогда
		...
		ШтрихкодированиеМОТПКлиент.ОткрытьФормуНевозможностиДобавленияОтсканированного(ЭтаФорма, ДанныеШтрихкода);
		Возврат;
	ИначеЕсли ДетализацияСтруктурыХранения = ПредопределенноеЗначение("Перечисление.ДетализацияСтруктурыХраненияИС.ГрупповыеУпаковкиСПотребительскими")
	...
	ТекущаяПроверяемаяУпаковка = СтрокаТекущейПроверяемойУпаковки(ЭтаФорма, Истина, ЭтоГрупповаяУпаковкаИлиНабор);
	...
	Если ПоддерживаетсяОбъемноСортовойУчет
		...
		Если РежимДобавленияКодовМаркировки = ПредопределенноеЗначение("Перечисление.РежимДобавленияКодовМаркировкиИСМП.ОСУ") Тогда
			ТекущаяПроверяемаяУпаковка = СтрокаОбъемноСортовогоУчетаПоGTIN(ЭтаФорма, ДанныеШтрихкода);
	...
	Иначе
		Если ЭтоГрупповаяУпаковкаИлиНабор(ТекущаяПроверяемаяУпаковка.ВидУпаковки) Тогда
			СнятьПризнакПроверкиУпаковки(
				ЭтаФорма, ТекущаяПроверяемаяУпаковка, Ложь, СоответствиеШтрихкодовСтрокДерева);
			ТекущаяПроверяемаяУпаковка = СтрокаТекущейПроверяемойУпаковки(ЭтаФорма, Истина, ЭтоГрупповаяУпаковкаИлиНабор);
		КонецЕсли;
	...
	ИзменитьСостояниеПроверкиУпаковки(ЭтаФорма, НоваяСтрока, СоответствиеШтрихкодовСтрокДерева);
	...
	Если СпозиционироватьсяНаДобавленной Тогда
		СпозиционироватьсяНаСтрокеДерева(ЭтаФорма, НоваяСтрока);
	КонецЕсли;
...
Процедура ПоместитьНовуюВПродукциюБезУпаковки(ДанныеШтрихкода)
	...
	СтрокаПродукцияБезУпаковки = СтрокаПотребительскиеУпаковкиБезУпаковки(ЭтаФорма);
...
Процедура ДобавитьНовуюМаркируемуюПродукциюВДерево(ДанныеШтрихкода, ДобавлятьВУпаковку = Неопределено)
	...
	Если ДобавлятьВУпаковку = Неопределено Тогда
		...
		Если СтрокаПроверяемойУпаковки = Неопределено
			...
			Если РежимДобавленияКодовМаркировки = ПредопределенноеЗначение("Перечисление.РежимДобавленияКодовМаркировкиИСМП.ОСУ") Тогда
				ДобавлятьВУпаковку = СтрокаОбъемноСортовогоУчетаПоGTIN(ЭтаФорма, ДанныеШтрихкода);
	...
	ИначеЕсли НоваяСтрока = Неопределено Тогда
		...
		Если ДобавлятьВУпаковку = Неопределено Тогда
			...
			Если ИдентификаторТекущейПроверяемойУпаковки = - 1 Тогда
				Если ЭтоКодМаркировкиГрупповойУпаковкиИлиНабора Тогда
					ДобавлятьВУпаковку = СтрокаГрупповыеУпаковкиБезКоробки(ЭтаФорма);
				ИначеЕсли ЭтоКодЛогистическойУпаковки Тогда
					ДобавлятьВУпаковку = Неопределено;
				Иначе
					ДобавлятьВУпаковку = СтрокаПотребительскиеУпаковкиБезУпаковки(ЭтаФорма);
				КонецЕсли;
			Иначе
		...
		Если ПроверкаИПодборПродукцииИСМПКлиент.НоменклатураОтличаетсяОтНоменклатурыПроверяемойУпаковки(ЭтаФорма, ДобавлятьВУпаковку, ДанныеШтрихкода) Тогда
		...
		Если ПроверкаИПодборПродукцииИСМПКлиент.НоменклатураНеВходитВСоставНабора(ЭтаФорма, ДобавлятьВУпаковку, ДанныеШтрихкода, КомплектующиеНаборов, РезультатКомплектующиеНаборов) Тогда
		...
		Если ПроверкаИПодборПродукцииИСМПКлиент.ТипыШтрихкодаВГрупповойУпаковкеРазличаются(ЭтаФорма, ДобавлятьВУпаковку, ДанныеШтрихкода) Тогда
	...
	Если Не РежимПодбораСуществующихУпаковок Тогда
		...
		ПодобраннаяПродукцияПриДобавленииСтроки(ЭтаФорма, НоваяСтрока, КэшированныеЗначения, ДополнительныеПараметры);
	Иначе
	...
	ДобавленнаяПотребительскаяУпаковка(ЭтаФорма, НоваяСтрока, "Добавить");
...
Процедура ДобавитьОбъемноСортовойКод(ДанныеШтрихкода, СтрокаОбъемноСортовогоКода = Неопределено, УстанавливатьСтатусПроверки = Истина)
	...
	ЭлементыИзГруппировкиПоGTIN = СтрокаОбъемноСортовогоУчетаПоGTIN(ЭтаФорма, ДанныеШтрихкода).ПолучитьЭлементы();
	...
	ПроверкаИПодборПродукцииИСМПКлиентСервер.УстановитьДоступностьУпаковкиДляПроверки(СтрокаОбъемноСортовогоКода, ДоступныеДляПроверкиУпаковки);
	ПроверкаИПодборПродукцииИСМПКлиентСервер.ПересчитатьИтогиПоПроверкеСодержимогоУпаковкиПриИзмененииСтроки(СтрокаОбъемноСортовогоКода);
	СпозиционироватьсяНаСтрокеДерева(ЭтаФорма, СтрокаОбъемноСортовогоКода);
	ПроверкаИПодборПродукцииИСМПКлиентСервер.СформироватьПредставлениеСодержимогоУпаковки(СтрокаОбъемноСортовогоКода);
	...
	Если РежимПодбораСуществующихУпаковок
		...
		Если КоличествоПотребительскихУпаковокКИзменению > 0 Тогда
			...
			ПроверкаИПодборПродукцииИСМПКлиентСервер.ПодобраннаяПродукцияПриДобавленииСтроки(
				ЭтаФорма, СтрокаИзменений, КоличествоПотребительскихУпаковокКИзменению, ПроверкаИПодборПродукцииИСМПКлиент, ДополнительныеПараметры, КэшированныеЗначения);
...
Процедура ДобавитьОбъемноСортовойКодНаСервере(ДанныеШтрихкода, СоответствиеШтрихкодов, ПараметрыСканирования, КэшированныеЗначения)
	...
	НормализироватьШтрихкодУпаковкиПоСоставуВложенныхУпаковок(ЭтаФорма, СтрокаОбъемноСортовогоКода, СоответствиеШтрихкодов);
	ПроверкаИПодборПродукцииИСМПКлиентСервер.СформироватьПредставлениеДляСтрокиДереваМаркированнойПродукции(СтрокаОбъемноСортовогоКода, ВидМаркируемойПродукции);
	ПроверкаИПодборПродукцииИСМПКлиентСервер.УстановитьДоступностьУпаковкиДляПроверки(СтрокаОбъемноСортовогоКода, ДоступныеДляПроверкиУпаковки);
	...
	Если РежимПодбораСуществующихУпаковок
		...
		Если Не РежимПодбораСуществующихУпаковок Тогда
			...
			Если КоличествоУпаковокКИзменению > 0 Тогда
				...
				ПроверкаИПодборПродукцииИСМПКлиентСервер.ПодобраннаяПродукцияПриДобавленииСтроки(
					ЭтаФорма, СтрокаИзменений, КоличествоУпаковокКИзменению, ОбщийМодульКонтекстаПиП(), ДополнительныеПараметры, КэшированныеЗначения);
		...
		Если КоличествоПотребительскихУпаковокКИзменению > 0 Тогда
			...
			ПроверкаИПодборПродукцииИСМПКлиентСервер.ПодобраннаяПродукцияПриДобавленииСтроки(
				ЭтаФорма, СтрокаИзменений, КоличествоПотребительскихУпаковокКИзменению, ОбщийМодульКонтекстаПиП(), ДополнительныеПараметры, КэшированныеЗначения);
...
Процедура УдалитьОбъемноСортовойКод(ДанныеШтрихкода, СтрокаОбъемноСортовогоКода = Неопределено, ИзменятьПодобраннуюПродукцию = Истина)
	...
	ЭлементГруппировкиПоGTIN = СтрокаОбъемноСортовогоУчетаПоGTIN(ЭтаФорма, ДанныеШтрихкода, Ложь);
...
Процедура ПереместитьВПродукциюБезУпаковки(ИдентификаторСтрокиПеремещаемойПродукции, СтатусПроверки = Неопределено, ИзменятьКонтекстПроверки = Ложь)
	...
	СтрокаНазначения   = СтрокаПотребительскиеУпаковкиБезУпаковки(ЭтаФорма);
...
Процедура ПеренестиСтрокуСуществующейУпаковкиВДеревоМаркированнойПродукции(СтрокаИсточника,
	...
	Если ДанныеШтрихкода <> Неопределено
		...
		Если ЭтоУпаковка И НоваяСтрока.КоличествоПодчиненныхВсего = 0 Тогда
			СтрокаПроверяемойУпаковки = СтрокаТекущейПроверяемойУпаковки(ЭтаФорма, ЭтоУпаковка, ЭтоГрупповаяУпаковка);
...
Функция РезультатДобавленияСуществующейУпаковкиВДеревоМаркированнойПродукции(ДанныеШтрихкода, СоответствиеШтрихкодовСтрокДерева, ВходящийКешСтрокДереваУпаковок, ПараметрыСканирования, КэшированныеЗначения)
	...
	Иначе
		...
		Если СтрокаПроверяемойУпаковки = Неопределено
			Или СтрокаПроверяемойУпаковки = СтрокаПотребительскиеУпаковкиБезУпаковки(ЭтаФорма)
			Или СтрокаПроверяемойУпаковки = СтрокаГрупповыеУпаковкиБезКоробки(ЭтаФорма) Тогда
			Если РежимДобавленияКодовМаркировки = ПредопределенноеЗначение("Перечисление.РежимДобавленияКодовМаркировкиИСМП.ОСУ") Тогда
				СтрокаПроверяемойУпаковки = СтрокаОбъемноСортовогоУчетаПоGTIN(ЭтаФорма, ДанныеШтрихкода);
			ИначеЕсли РежимДобавленияКодовМаркировки = ПредопределенноеЗначение("Перечисление.РежимДобавленияКодовМаркировкиИСМП.ПоВладельцу") Тогда
				Если ПараметрыПроверкиКодовМаркировки.ИННВладельца <> ДанныеШтрихкода.ИННВладельца Тогда
					СтрокаПроверяемойУпаковки = СтрокаОбъемноСортовогоУчетаПоGTIN(ЭтаФорма, ДанныеШтрихкода);
				КонецЕсли;
		...
		СтрокаПачкиБезБлока = СтрокаПотребительскиеУпаковкиБезУпаковки(ЭтаФорма);
		СтрокаБлокиБезКоробки = СтрокаГрупповыеУпаковкиБезКоробки(ЭтаФорма);
...
Процедура ОбработатьСтрокуДереваПриУдалении(ТаблицаИзмененийПодобраннойПродукции, УдаляемыйЭлемент)
	...
	Если ДополнитьТаблицуИзменений Тогда
		Если Не РежимПодбораСуществующихУпаковок
			...
			ДополнительныеПараметры = ПроверкаИПодборПродукцииИСМПКлиентСервер.ПараметрыДобавленияСтрокиПодобраннойПродукции();
			ДополнительныеПараметры.УточнитьКоличествоИС = Истина;
			ПодобраннаяПродукцияПриУдаленииСтроки(ЭтаФорма, УдаляемыйЭлемент, КэшированныеЗначения, ДополнительныеПараметры);
		Иначе
	...
	Если ИнтеграцияИСКлиентСервер.ЭтоУпаковка(УдаляемыйЭлемент.ТипУпаковки) Тогда
		...
		КонецЕсли;
	Иначе
		ДобавленнаяПотребительскаяУпаковка(ЭтаФорма, УдаляемыйЭлемент.Штрихкод, "Удалить");
	КонецЕсли;
...
Процедура ЗавершитьРегистрациюИзмененийНоменклатурыВСтроке()
	...
	Если КоличествоИзменений > 0 Тогда
		...
		ОбработатьТаблицуИзмененийНоменклатуры(ЭтаФорма);
	КонецЕсли;
...
Процедура ИзменитьКонтекстПроверки(НоваяПроверяемаяУпаковка)
	...
	УстановитьПризнакПроверкиУпаковки(ЭтаФорма, НоваяПроверяемаяУпаковка);
...
Процедура Подключаемый_ПослеВопросаЗагрузкиКодовПоОснованию(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВопроса = "ПоЗаказамНаЭмиссию" Тогда
		...
		Если КодыМаркировки.Количество() = 0 Тогда
			...
			ОповещениеОЗавершении = Новый ОписаниеОповещения(
				"Подключаемый_ПослеВыбораЗаказовНаЭмиссию", ЭтаФорма);
	...
	ИначеЕсли РезультатВопроса = "ПоОтчетамОНанесении" Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения(
			"Подключаемый_ПослеВыбораМаркировкиТоваровИСМП", ЭтаФорма);
	...
	Иначе
		...
		ПроверкаИПодборПродукцииИСМПКлиентПереопределяемый.ПриОбработкеВариантаЗаполненияКодовМаркировки(
			ЭтаФорма, РезультатВопроса, ПараметрыОбработкиТСД);
...
Функция ШтрихкодыУпаковокДокументаСоответствуютВидуПродукции()
	...
	ПользовательскиеПараметрыРазбора.ВалидироватьШтрихкодЛогистическойУпаковкиGS1128СОшибками = Не ЭтоДокументМаркировка(ЭтаФорма);
...
Процедура Подключаемый_ПолученыДанныеИзТСД(Штрихкоды, ПараметрыОбработкиТСД) Экспорт
	...
	Если ЗагрузкаДанныхТСД.ПредложитьЗагрузитьВУпаковке Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения("ПредложитьЗагрузитьВУпаковке", ЭтаФорма, Штрихкоды);
	...
	Если ЗагрузкаДанныхТСД.ПредложитьИзменитьДетализацию Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения("ПредложитьИзменитьДетализациюЗавершение", ЭтаФорма, Штрихкоды);
	...
	Если ЗагрузкаДанныхТСД.ТребуетсяАвторизация Тогда
		...
		ИнтерфейсАвторизацииИСМПКлиент.ЗапроситьКлючСессииСУчетомВидаТокена(
			...
			Новый ОписаниеОповещения("ЗагрузитьИзТСДПослеАвторизации", ЭтаФорма, ПараметрыОповещения));
	...
	Если ЗагрузкаДанныхТСД.ОтсутствуютCDNПлощадки Тогда
		...
		Если ПараметрыОбработкиТСД.ЭтоПолучениеCDNПлощадок Тогда
			...
			ПоказатьПредупреждение(, НСтр("ru = 'Загрузка CDN-площадок завершена неуспешна: получение данных невозможно'"));
		...
		ПараметрыЗапроса.ОповещениеОЗавершении   = Новый ОписаниеОповещения("ЗагрузитьИзТСДПослеЗагрузкиПлощадок", ЭтаФорма, ПараметрыОповещения);
	...
	Если ЗначениеЗаполнено(ЗагрузкаДанныхТСД.АдресУточнениеКоэффициентовУпаковок) Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения("УточнениеКоэффициентовУпаковокЗавершение", ЭтаФорма, ДополнительныеПараметры);
		
		ПараметрыОткрытия = ИнтеграцияИСМПКлиент.ПараметрыОткрытияФормыУточненияУпаковокПоGTIN();
		ПараметрыОткрытия.АдресУточнениеКоэффициентовУпаковок = ЗагрузкаДанныхТСД.АдресУточнениеКоэффициентовУпаковок;

		ИнтеграцияИСМПКлиент.ОткрытьФормуНастройкиВидовУпаковокПоGTIN(ПараметрыОткрытия, ЭтаФорма, ОписаниеОповещения);
...
Процедура ОбработатьПолученныеДанныеТСДНаСервере(ДанныеДляТСД, КэшированныеЗначения)
	...
	ПроверитьДоступнуюИерархиюШтрихкодов = (ДанныеДляТСД.ДополнительныеПараметры.Состояние <> "ИерархияПроверена")
	                                     ...
	                                     И ЭтоДокументМаркировка(ЭтаФорма)
	...
	РезультатОбработкиШтрихкодов = ШтрихкодированиеИС.ОбработатьШтрихкоды(
		...
		Неопределено, ЭтаФорма, КешДанныхРазбора, ДанныеПоШтрихкодам);
	...
	ГрупповаяОбработкаШтрихкодовИС.ПроверитьНаОшибкиРезультатОбработкиДанныхТСД(
		Результат, ЭтаФорма, ДанныеДляТСД.ПараметрыСканирования);
...
Процедура ОбработатьПолученныеДанныеТСД() Экспорт
	...
	Если ЗначениеЗаполнено(СтрокаШтрихкод.Штрихкод) Тогда
		...
		Если ТребуетсяУточнениеДанных Тогда
			...
			ПараметрыЗавершенияОбработкиШтрихкода.Форма                         = ЭтаФорма;
...
Процедура Спозиционироваться(СтрокаШтрихкод, ДанныеШтрихкода)
	...
	Если Штрихкод = "" Тогда
		Если ДанныеШтрихкода.ВидУпаковки = ПредопределенноеЗначение("Перечисление.ВидыУпаковокИС.Потребительская") Тогда
			ИзменитьКонтекстПроверки(СтрокаПотребительскиеУпаковкиБезУпаковки(ЭтаФорма));
		ИначеЕсли ЭтоГрупповаяУпаковкаИлиНабор(ДанныеШтрихкода.ВидУпаковки) Тогда
			ИзменитьКонтекстПроверки(СтрокаГрупповыеУпаковкиБезКоробки(ЭтаФорма));
		Иначе
			ИзменитьКонтекстПроверки(Неопределено);
		КонецЕсли;
		Возврат;
...
Процедура ЗагрузитьИзТСДЗавершение(РезультатВыполнения, ДополнительныеПараметры) Экспорт
	...
	СобытияФормИСКлиентПереопределяемый.ПриПолученииДанныхИзТСД(
		Новый ОписаниеОповещения("Подключаемый_ПолученыДанныеИзТСД", ЭтаФорма, ПараметрыОбработкиТСД),
...
Процедура ИзменитьКонтекстПроверкиНаСервере(НоваяПроверяемаяУпаковка, СоответствиеШтрихкодов)
	...
	ТекущаяПроверяемаяУпаковка = НайтиПоИдентификатору(ДеревоМаркированнойПродукции, ИдентификаторТекущейПроверяемойУпаковки);
	Если ТекущаяПроверяемаяУпаковка <> Неопределено Тогда
		СнятьПризнакПроверкиУпаковки(ЭтаФорма, ТекущаяПроверяемаяУпаковка, Истина, СоответствиеШтрихкодов);
	КонецЕсли;
...
Функция ОбработатьНеНайденныйВДеревеШтрихКодНаСервере(ДанныеШтрихкода, СоответствиеШтрихкодов, КэшированныеЗначения)
	...
	Если РежимПодбораСуществующихУпаковок И ЭтоШтрихкодПотребительскойУпаковки Тогда
		...
		Если Не ЗначениеЗаполнено(ДанныеШтрихкода.Номенклатура)
			Или Не ПродукцияСоответствуетДокументуОснованию(ЭтаФорма, ДанныеШтрихкода) Тогда
...
Процедура ПослеУспешногоОбнаруженияОтсканированногоШтрихкодаВДеревеНаСервере(
	...
	Если ЭтоУпаковка Тогда
		...
		СтрокаПроверяемойУпаковки = СтрокаТекущейПроверяемойУпаковки(ЭтаФорма, ЭтоУпаковка, ЭтоГрупповаяУпаковкаИлиНабор);
		...
		Если НайденнаяСтрокаДерева.ИдетПроверкаДаннойУпаковки Тогда
			...
			СнятьПризнакПроверкиУпаковки(ЭтаФорма, НайденнаяСтрокаДерева,, СоответствиеШтрихкодов);
			СпозиционироватьсяНаСтрокеДерева(ЭтаФорма, НайденнаяСтрокаДерева);
		...
		ИначеЕсли РодительНайденнойСтроки = СтрокаПроверяемойУпаковки
			...
			Если НайденнаяСтрокаДерева = ТекущаяСтрокаДерева Тогда
				...
				ИзменитьСостояниеПроверкиУпаковки(ЭтаФорма, НайденнаяСтрокаДерева, СоответствиеШтрихкодов);
				
			Иначе
				
				Если ТекущаяСтрокаДерева <> Неопределено Тогда
					СнятьПризнакПроверкиУпаковки(ЭтаФорма, ТекущаяСтрокаДерева,, СоответствиеШтрихкодов);
				КонецЕсли;
				ОтметитьСтрокуКакНайденнуюНаСервере(НайденнаяСтрокаДерева);
	...
	Иначе
		...
		Иначе
			...
			СтрокаПроверяемойУпаковки = СтрокаТекущейПроверяемойУпаковки(ЭтаФорма, ЭтоУпаковка, Ложь);
...
Функция ДобавитьНовуюУпаковкуНаСервере(ДанныеШтрихкода, ТипУпаковки, СоответствиеШтрихкодов, КэшированныеЗначения)
	...
	Иначе
		...
		Если РодительскаяСтрока = Неопределено
			Или ЭтоГрупповаяУпаковкаИлиНабор И РодительскаяСтрока = СтрокаГрупповыеУпаковкиБезКоробки(ЭтаФорма) Тогда
			НоваяСтрока.СтатусПроверки = Перечисления.СтатусыПроверкиНаличияПродукцииИС.ВНаличии;
		Иначе
			НоваяСтрока.СтатусПроверки = Перечисления.СтатусыПроверкиНаличияПродукцииИС.НеЧислилась;
		КонецЕсли;
...
Процедура СпозиционироватьсяНаСервере(СтрокаШтрихкод, ДанныеШтрихкода, СоответствиеШтрихкодов, ДанныеПоШтрихкодам = Неопределено)
	...
	Если ПустаяСтрока(Штрихкод) Тогда
		Если ДанныеШтрихкода.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская Тогда
			ИзменитьКонтекстПроверкиНаСервере(СтрокаПотребительскиеУпаковкиБезУпаковки(ЭтаФорма), СоответствиеШтрихкодов);
		ИначеЕсли ЭтоГрупповаяУпаковкаИлиНабор(ДанныеШтрихкода.ВидУпаковки) Тогда
			ИзменитьКонтекстПроверкиНаСервере(СтрокаГрупповыеУпаковкиБезКоробки(ЭтаФорма), СоответствиеШтрихкодов);
		Иначе
			ИзменитьКонтекстПроверкиНаСервере(Неопределено, СоответствиеШтрихкодов);
		КонецЕсли;
		Возврат;
...
Процедура ПослеИзмененияРежимаДетализации(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ШтрихкодыВерхнегоУровня.Количество() = 0 Тогда
		...
		Если Результат = ПредопределенноеЗначение("Перечисление.ДетализацияСтруктурыХраненияИС.ПотребительскиеУпаковки")
			...
			ОповещениеПриОтвете = Новый ОписаниеОповещения("ПриОтветеНаВопросИзменениеРежимаДетализации", ЭтаФорма, Результат);
	...
	ИначеЕсли Не РежимПодбораСуществующихУпаковок И ЭтоДокументПриобретения И ПроверкаЭлектронногоДокумента Тогда
		...
		ОписаниеОповещенияПослеОтвета = Новый ОписаниеОповещения("ПослеВопросаОНачалеПроверкиЗаново", ЭтаФорма, ПараметрыОповещения);
	...
	ИначеЕсли ИспользоватьЗагрузкуИзТСДПриСменеДетализации(Результат) Тогда
		...
		ОписаниеОповещенияПослеОтвета = Новый ОписаниеОповещения("ПослеВопросаОСменеДетализацииСПоследующимВосстановлениемИзТСД", ЭтаФорма, ПараметрыОповещения);
...
Процедура ПереместитьВложенныеУпаковкиПриРазборкеУпаковки(СтрокиДерева, НовыйРодитель = Неопределено)
	...
	Для Каждого СтрокаДерева Из СтрокиДерева Цикл
		...
		ИначеЕсли СтрокаДерева.ТипУпаковки = ПредопределенноеЗначение("Перечисление.ТипыУпаковок.МаркированныйТовар") Тогда
			РодительДобавляемойСтроки = СтрокаПотребительскиеУпаковкиБезУпаковки(ЭтаФорма);
		ИначеЕсли ЭтоГрупповаяУпаковкаИлиНабор(СтрокаДерева.ВидУпаковки) Тогда
			РодительДобавляемойСтроки = СтрокаГрупповыеУпаковкиБезКоробки(ЭтаФорма);
		Иначе
...
Процедура ОткрытьФормуГенерацииУпаковки()
	...
	ОповещениеПослеГенерацииШтрихкодаУпаковки = Новый ОписаниеОповещения("ПослеГенерацииШтрихкодаДляНовойУпаковки", ЭтаФорма);
	
	ОткрытьФорму("Обработка.ГенерацияШтрихкодовУпаковок.Форма.Форма", ПараметрыОткрытияФормы, ЭтаФорма,,,,
...
Процедура НапечататьШтрихкодТекущейУпаковки()
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("НапечататьШтрихкодТекущейУпаковкиПослеЗакрытияУпаковки", ЭтаФорма, ТребуетсяЗакрытиеУпаковки);
...
Процедура НапечататьШтрихкодТекущейУпаковкиПослеЗакрытияУпаковки(Результат, ТребуетсяЗакрытиеУпаковки) Экспорт
	...
	НормализироватьШтрихкодУпаковкиПоСоставуВложенныхУпаковок(ЭтаФорма, ТекущиеДанные, СоответствиеШтрихкодовСтрокДерева);
...
Процедура ОчиститьСопоставлениеНаСервере(ВыделенныеСтроки, КэшированныеЗначения)
	...
	ПроверкаИПодборПродукцииИСМП.ПриОчисткеСопоставленияМаркированнойПродукции(ЭтаФорма, ВыделенныеСтроки, КэшированныеЗначения);
...
Процедура УдалениеПодобраннойПродукцииПриСменеДетализации(СтрокиДерева, ВидУпаковки)
	...
	Если ВидУпаковки = ПредопределенноеЗначение("Перечисление.ВидыУпаковокИС.Потребительская") Тогда
		...
		Для Каждого СтрокаДерева Из СтрокиДерева Цикл
			ПроверкаИПодборПродукцииИСМПКлиентСервер.ПодобраннаяПродукцияПриУдаленииСтроки(
				ЭтаФорма, СтрокаДерева, 1, ПроверкаИПодборПродукцииИСМПКлиент,, КэшированныеЗначения);
		КонецЦикла;
	...
	ИначеЕсли ЭтоГрупповаяУпаковкаИлиНабор(ВидУпаковки) Тогда
		...
		Для Каждого СтрокаДерева Из СтрокиДерева Цикл
			ПроверкаИПодборПродукцииИСМПКлиентСервер.ПодобраннаяПродукцияПриУдаленииСтроки(
				ЭтаФорма, СтрокаДерева, СтрокаДерева.КоличествоПодчиненныхПотребительскихУпаковок, ПроверкаИПодборПродукцииИСМПКлиент,, КэшированныеЗначения);
		КонецЦикла;
...
Процедура ВыполнитьУточнениеПоОСУ(ТекущиеДанные, ДанныеВыбора, СтрокаИзмененийДо,
	...
	ДанныеДляОСУ = ДанныеДляАнализаИРаспределенияОСУ(ЭтаФорма, ИнициализироватьДанныеОСУ(СтрокаИзмененийПосле));
	...
	Если СтрокаОбъемноСортовогоКода <> Неопределено Тогда
		...
		Если Не РежимПодбораСуществующихУпаковок Тогда
			...
			Если СтрокаОбъемноСортовогоКода.КоличествоПодчиненныхНеПроверялось > 0 
				...
				ПроверкаИПодборПродукцииИСМПКлиентСервер.ПодобраннаяПродукцияПерераспределитьКоличествоОСУ(ЭтаФорма,
...
Процедура ИзменитьСтатусСтрокиМерногоТовараСНулевымКоличествомПриВключенииЗапросаКоличестваМерногоТовара()
	...
	Иначе
		...
		ОписаниеОповещения = Новый ОписаниеОповещения("ОбработатьУстановкуСвойстваЗапрашиватьКоличествоМерногоТовара", ЭтаФорма, ДополнительныеПараметры);
...
Процедура ОбработатьСопоставлениеНоменклатурыШтрихкодам(ТоварныеПозицииGTIN)
	...
	Для Каждого ИсходныеДанные Из ТоварныеПозицииGTIN Цикл
		...
		ПроверкаИПодборПродукцииИСМПКлиентСервер.ПодобраннаяПродукцияПриСопоставлениеНоменклатурыШтрихкодам(
			ЭтаФорма, ИсходныеДанные, ПроверкаИПодборПродукцииИСМПКлиент,, КэшированныеЗначения);
...
Процедура ДобавитьОбъемноСортовойКодУпрощенно(ДанныеШтрихкода)
	...
	ДанныеДляОСУ = ДанныеДляАнализаИРаспределенияОСУ(ЭтаФорма, ДанныеШтрихкода);
	...
	Если ПереносимоеКоличествоУпаковок > 0 Тогда
		...
		ПроверкаИПодборПродукцииИСМПКлиентСервер.ПеренестиКоличествоКодов(ЭтаФорма, СтрокиПоВозрастаниюВеса[0], СтрокаОбъемноСортовогоКода, ПереносимоеКоличествоКодов);
	КонецЕсли;
	...
	Если КоличествоДоступныхУпаковок < ДанныеШтрихкода.КоличествоПотребительскихУпаковок Тогда
		...
		Пока Сч >= 0 И КоличествоУпаковокКДобавлению > 0 Цикл
			...
			Иначе
				...
				НормализироватьШтрихкодУпаковкиПоСоставуВложенныхУпаковок(ЭтаФорма, СтрокаДерева, СоответствиеШтрихкодовСтрокДерева);
...
Процедура УточнитьТоварВСтрокеДерева(СтрокаДерева, СтрокаИзмененийДо, СтрокаИзмененийПосле, ДанныеВыбора, ТекущиеДанные, ДополнительныеПараметры)
	...
	Если СтрокаДерева.Номенклатура = СтрокаИзмененийДо.Номенклатура
		...
		ИначеЕсли СтрокаДерева.СтатусПроверки = ПредопределенноеЗначение("Перечисление.СтатусыПроверкиНаличияПродукцииИС.ВНаличии")
			...
			ДополнительныеПараметры = ПроверкаИПодборПродукцииИСМПКлиентСервер.ПараметрыДобавленияСтрокиПодобраннойПродукции();
			ДополнительныеПараметры.УточнитьКоличествоИС = Не РежимПодбораСуществующихУпаковок;
			ПодобраннаяПродукцияПриУдаленииСтроки(ЭтаФорма, СтрокаДерева, КэшированныеЗначения, ДополнительныеПараметры);
			...
			ПодобраннаяПродукцияПриДобавленииСтроки(ЭтаФорма, СтрокаДерева, КэшированныеЗначения, ДополнительныеПараметры);
...
Процедура ПроверкаЗавершенаКлиент(ПропуститьПроверкуКоличества = Ложь)
	...
	Если ДействияПередЗаверешениемПроверки.ТребуетсяУказаниеКоличества Тогда
		...
		ОписаниеОповещенияПослеОтвета = Новый ОписаниеОповещения("ПослеВопросаТребуетсяУказаниеКоличества", ЭтаФорма);
