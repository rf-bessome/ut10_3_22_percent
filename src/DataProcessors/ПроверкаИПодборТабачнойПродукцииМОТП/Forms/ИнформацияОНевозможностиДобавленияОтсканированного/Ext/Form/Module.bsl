...
Процедура ДекорацияОшибкаДобавленияТабачнойПродукцииОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "РаспечататьКодМаркировки" Тогда
		...
		ОткрытьФорму(
			...
			ЭтаФорма,,,,
			Новый ОписаниеОповещения("ПечатьКодаМаркировкиЗавершение", ЭтаФорма),
...
Процедура Подключаемый_ОткрытьФормуПроверкиИПодбора(Команда)
	...
	ПроверкаИПодборПродукцииИСМПКлиент.ОткрытьФормуПроверкиИПодбораПоВыделеннойСтроке(ЭтаФорма, Команда);
