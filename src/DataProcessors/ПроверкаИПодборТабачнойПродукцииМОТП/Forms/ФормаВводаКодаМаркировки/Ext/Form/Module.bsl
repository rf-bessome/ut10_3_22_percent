...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьВидимостьЭтементовДобавитьБезКодаМаркировки(ЭтаФорма, ДобавлятьБезКодаМаркировки);
...
Процедура ПриОткрытии(Отказ)
	...
	Если ВладелецФормы <> Неопределено
		...
		УстановитьВидимостьЭтементовДобавитьБезКодаМаркировки(ЭтаФорма, Ложь);
	КонецЕсли;
