...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытияФормИСКлиентСерверПереопределяемый.УстановитьПараметрыВыбораНоменклатуры(ЭтаФорма, Перечисления.ВидыПродукцииИС.Алкогольная, "Номенклатура");
...
Процедура ПриЗакрытии()
	...
	МенеджерОборудованияКлиент.НачатьОтключениеОборудованиеПриЗакрытииФормы(
		ОповещениеПриОтключении, ЭтаФорма);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	СобытияФормИСКлиентПереопределяемый.ОбработкаОповещенияОбработаныНеизвестныеШтрихкоды(
		Новый ОписаниеОповещения("Подключаемый_ОбработаныНеизвестныеШтрихкоды", ЭтаФорма),
...
Процедура ПоясняющийТекстОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "КомандаЗапроситьАлкогольнуюПродукциюЕГАИС" Тогда
		...
		ОткрытьФорму(
			...
			ПараметрыФормы,
			ЭтаФорма,,,,
			Новый ОписаниеОповещения("ПослеЗакрытияФормыФормированиеИсходящегоЗапроса", ЭтаФорма),
...
Процедура СерияПриИзменении(Элемент)
	...
	ОпределитьДоступностьГотово(ЭтаФорма);
	ОтключитьОтметкуНезаполненного();
...
Процедура ПоказатьТребуетсяУточнениеДанных()
	...
	ЗаполнитьСписокВыбораНоменклатуры(ЭтаФорма);
	ПриИзмененииНоменклатуры();
...
Процедура НоменклатураНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если Не Элементы.Номенклатура.РежимВыбораИзСписка Тогда
		...
		СобытияФормИСКлиентПереопределяемый.ПриНачалеВыбораНоменклатуры(
			ЭтаФорма, ИнтеграцияИСКлиентСервер.ВидыПродукцииЕГАИС(),
