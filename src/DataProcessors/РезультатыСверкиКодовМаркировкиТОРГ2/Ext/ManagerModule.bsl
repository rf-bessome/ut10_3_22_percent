...
Процедура ЗагрузитьДанныеДокументаДлительнаяОперация(Параметры, АдресРезультата) Экспорт
	...
	Иначе
		...
		Иначе
			...
			ТоварыПринятыеБезРасхождений.Колонки.Добавить("Номенклатура", ОпределяемыеТипы().Номенклатура.Тип);
...
Функция ДеревоМаркированнойПродукции() Экспорт
	...
	ДеревоМаркированнойПродукции.Колонки.Добавить("ДействиеПоРасхождениям",              ОпределяемыеТипы().ВариантДействийПоРасхождениямКодовМаркировкиИСМП.Тип);
