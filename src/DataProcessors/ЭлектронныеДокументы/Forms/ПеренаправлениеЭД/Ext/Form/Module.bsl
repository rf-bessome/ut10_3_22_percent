...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.СертификатыЭЦП.СписокПользователей КАК ПользователиСертификатов
	|				ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Пользователи КАК Пользователи
	|				ПО ПользователиСертификатов.Пользователь = Пользователи.Ссылка
	|			ПО ПрофилиНастроекЭДОСертификатыПодписейОрганизации.Сертификат = ПользователиСертификатов.Ссылка
