...
Функция АктСписанияЕГАИСXML(ДокументСсылка)
	...
	Если Шапка.Операция = Перечисления.ВидыДокументовЕГАИС.АктСписанияИзРегистра1 Тогда
		...
		АкцизныеМарки.Колонки.Добавить("Количество",       ОпределяемыеТипы().КоличествоЕГАИСНеотрицательное.Тип);
		...
		АкцизныеМарки.Колонки.Добавить("Номенклатура",     ОпределяемыеТипы().Номенклатура.Тип);
		АкцизныеМарки.Колонки.Добавить("Характеристика",   ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
		...
		ТоварыИтоги.Колонки.Добавить("НомерСправки2",        ОпределяемыеТипы().СтрокаЕГАИС.Тип);
		ТоварыИтоги.Колонки.Добавить("Номенклатура",         ОпределяемыеТипы().Номенклатура.Тип);
		ТоварыИтоги.Колонки.Добавить("Характеристика",       ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
		ТоварыИтоги.Колонки.Добавить("Количество",           ОпределяемыеТипы().КоличествоЕГАИСНеотрицательное.Тип);
		ТоварыИтоги.Колонки.Добавить("Сумма",                ОпределяемыеТипы().ДенежнаяСуммаГосИСНеотрицательная.Тип);
		...
		Иначе
			...
			ТоварыИтоги.Колонки.Добавить("КоличествоЕГАИС",  ОпределяемыеТипы().КоличествоЕГАИСНеотрицательное.Тип);
			ТоварыИтоги.Колонки.Добавить("СуммаЕГАИС",       ОпределяемыеТипы().ДенежнаяСуммаГосИСНеотрицательная.Тип);
