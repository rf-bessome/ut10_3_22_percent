...
Процедура ЗаполнитьТоварыПоОснованиюУпр(ДокументОснование, СтруктураПолученияСделок, СкладИзШапки = Истина) Экспорт
	...
	|	Док.Номенклатура.КодТНВЭД КАК КодТНВЭД,"
	...
	Если ОснованиеПоступление Тогда
		КолонкиСвертки = "Номенклатура,ХарактеристикаНоменклатуры,Склад,ПрослеживаемыйТовар,СтранаПроисхождения,КоличествоОстаток,КоличествоРезервОстаток";
	КонецЕсли;
...
Процедура ДвиженияПоРегистрам(РежимПроведения, СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаПоТаре, ТаблицаПоВзаиморасчетам, ТаблицаПоРасчетам, Отказ, Заголовок);
	...
	//УсловияПрослеживаемости.Вставить("ЭтоВозвратИзПереработки",
	//	СтруктураШапкиДокумента.ВидОперации = Перечисления.ВидыОперацийВозвратТоваровПоставщику.ИзПереработки);
...
Процедура ДвиженияПоРегистрамПрослеживаемыхТоваров(УсловияПрослеживаемости, СтруктураШапкиДокумента)
	...
	Запрос.УстановитьПараметр("ЭтоДоговорСКомитентом", СтруктураШапкиДокумента.ВидДоговора = Перечисления.ВидыДоговоровКонтрагентов.СКомитентом);
		
	НомераТаблиц = Новый Структура;
	ПараметрыПроведения = Новый Структура;
	
	Запрос.Текст = Документы.ВозвратТоваровПоставщику.ТекстЗапросаПрослеживаемыеТовары(НомераТаблиц, ПараметрыПроведения, УсловияПрослеживаемости);
