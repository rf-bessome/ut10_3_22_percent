...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДокументОснование.ДоступныеТипы = ОпределяемыеТипы().ОснованиеЗапросОстатковПартийЗЕРНО.Тип;
	...
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСНоменклатурой(
		ЭтаФорма, "ОстаткиПоДаннымЗЕРНОХарактеристика", "Элементы.ОстаткиПоДаннымЗЕРНО.ТекущиеДанные.Номенклатура");
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСНоменклатурой(
		ЭтаФорма, "ОстаткиПоДаннымЗЕРНОСерия", "Элементы.ОстаткиПоДаннымЗЕРНО.ТекущиеДанные.Номенклатура");
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСХарактеристикой(
		ЭтаФорма, "ОстаткиПоДаннымЗЕРНОСерия", "Элементы.ОстаткиПоДаннымЗЕРНО.ТекущиеДанные.Характеристика");
...
Процедура ВидПродукцииПриИзменении(Элемент)
	...
	ИнтеграцияЗЕРНОКлиентСервер.УстановитьПараметрыВыбораНоменклатуры(
		ЭтаФорма, Объект.ВидПродукции, "ОстаткиПоДаннымЗЕРНОНоменклатура");
...
Процедура ОстаткиПоДаннымЗЕРНОСерияПриИзменении(Элемент)
	...
	СобытияФормЗЕРНОКлиентПереопределяемый.ПриИзмененииСерии(
		ЭтаФорма, Элементы.ОстаткиПоДаннымЗЕРНО.ТекущиеДанные, КэшированныеЗначения, ПараметрыУказанияСерий);
...
Процедура СопоставитьНоменклатуру(Команда)
	...
	ОповещениеОЗавершении = Новый ОписаниеОповещения("ПриЗавершенииСопоставленияНоменклатурыСтрок", ЭтаФорма);
	ИнтеграцияИСКлиент.ОткрытьФормуУказанияНоменклатуры(
		ЭтаФорма, ОповещениеОЗавершении, ИнтеграцияЗЕРНОКлиентСервер.РасширенныеВидыПродукции(Объект.ВидПродукции));
...
Процедура УстановитьУсловноеОформление()
	...
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(
		ЭтаФорма, "ОстаткиПоДаннымЗЕРНОХарактеристика", "Объект.ОстаткиПоДаннымЗЕРНО.ХарактеристикиИспользуются");
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеСерийНоменклатуры(
		ЭтаФорма, "ОстаткиПоДаннымЗЕРНОСерия", "Объект.ОстаткиПоДаннымЗЕРНО.СтатусУказанияСерий", "Объект.ОстаткиПоДаннымЗЕРНО.ТипНоменклатуры");
	
	СобытияФормЗЕРНО.УстановитьУсловноеОформлениеОКПД2(ЭтаФорма, "ОстаткиПоДаннымЗЕРНОПартияОКПД2", "Объект.ОстаткиПоДаннымЗЕРНО.ОКПД2Представление");
...
Процедура ПриСозданииЧтенииНаСервере()
	...
	ИнтеграцияЗЕРНОКлиентСервер.УстановитьПараметрыВыбораНоменклатуры(ЭтаФорма, Объект.ВидПродукции, "ОстаткиПоДаннымЗЕРНОНоменклатура");
...
Процедура ПриЗавершенииСопоставленияНоменклатурыСтрок(Результат, ДополнительныеПараметры) Экспорт
	...
	Для Каждого СтрокаСписка Из Элементы.ОстаткиПоДаннымЗЕРНО.ВыделенныеСтроки Цикл
		...
		СобытияФормЗЕРНОКлиентПереопределяемый.ПриИзмененииНоменклатуры(
			ЭтаФорма, ДанныеСтроки, КэшированныеЗначения, ПараметрыУказанияСерий);
		ДанныеСтроки.Серия = ДанныеВыбора.Серия;
...
Процедура ИнициализироватьСлужебныеРеквизитыТаблицыОстаткиПоДаннымЗЕРНО()
	...
	ИнтеграцияИСПереопределяемый.ЗаполнитьСлужебныеРеквизитыВКоллекции(ЭтаФорма, Объект.ОстаткиПоДаннымЗЕРНО);
