...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Для Каждого СтрокаДанных Из СуммыДолга Цикл
		
		Если СтрокаДанных.ВидЗадолженности = Перечисления.ВидыЗадолженности.Дебиторская Тогда
			СтрокаДанных.ИдентификаторФискальнойЗаписи = Документы.КорректировкаДолга.ИдентификаторФискальнойЗаписи(Ссылка, СтрокаДанных);
		Иначе
			СтрокаДанных.ИдентификаторФискальнойЗаписи = "";
		КонецЕсли;
