...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДокументОснование.ДоступныеТипы = ОпределяемыеТипы().ОснованиеМаркировкаТоваровИСМП.Тип;
...
Процедура ВнешнееСобытие(Источник, Событие, Данные)
	...
	ДанныеСоСканераСтруктура = СобытияФормИСКлиент.ВнешнееСобытиеПреобразоватьДанныеСоСканераВСтруктуру(
		ЭтаФорма, Источник, Событие, Данные);
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если Объект.Операция = ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ПодтверждениеПоступленияКИЗ")
		И ИнтеграцияИСКлиент.ЭтоЗагрузкаКодовМаркировки(ИсточникВыбора, ЭтаФорма) Тогда
	...
	Иначе
		...
		Если Объект.ОтчетПроизводственнойЛинии И ИнтеграцияИСКлиент.ЭтоФормаУказанияСерий(ИсточникВыбора, ВыбранноеЗначение) Тогда
			...
			Если ЗначениеЗаполнено(Объект.ДокументОснование) И ИспользуетсяУказаниеИдентификатораВЕТИС(ЭтаФорма) Тогда
				СерияПриИзмененииСервер(Истина);
			КонецЕсли;

		ИначеЕсли ИнтеграцияИСКлиент.ЭтоЗагрузкаКодовМаркировки(ИсточникВыбора, ЭтаФорма) Тогда
			...
			Если Объект.ОтчетПроизводственнойЛинии Тогда
				...
				НастроитьВидимостьНомерСтрокиОтчетПроизводственнойЛинии(ЭтаФорма);
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ТребуетсяУказатьДанныеДекларации(ЭтаФорма)
...
Процедура ВариантФормированияАТКИСМППриИзменении(Элемент)
	...
	Если Объект.ВариантФормированияАТКИСМП <> ПредыдущийВариантФормированияАТКИСМП Тогда
		...
		ОписаниеОповещенияОЗавершении = Новый ОписаниеОповещения("ВопросПриИзмененииВариантФормированияАТКЗавершение", ЭтаФорма, Действия);
...
Процедура ОперацияНанесенияПриИзменении(Элемент)
	...
	ОписаниеОповещенияОЗавершении = Новый ОписаниеОповещения("ВопросПриИзмененииОперацииНанесенияЗавершение", ЭтаФорма, Действия);
...
Процедура ВариантЗаполненияДекларацииПриИзменении(Элемент)
	...
	ОписаниеОповещенияОЗавершении = Новый ОписаниеОповещения("ВопросПриИзмененииВариантЗаполненияДекларацииЗавершение", ЭтаФорма, Действия);
...
Процедура ВидПродукцииПриИзменении(Элемент, ПерезаполнитьПоОснованию = Ложь)
	...
	СобытияФормИСКлиентСерверПереопределяемый.УстановитьПараметрыВыбораНоменклатуры(ЭтаФорма, Объект.ВидПродукции, "Номенклатура");
	
	Если Объект.Операция = ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ВводВОборотТрансграничнаяТорговля") Тогда
		СобытияФормИСМПКлиентПереопределяемый.УстановитьПараметрыВыбораКонтрагента(ЭтаФорма, Истина, "Контрагент");
		УстановитьПараметрыВыбораКлассификаторСтранМира(ЭтаФорма, Истина, "СтранаПроисхожденияПолеВвода");
	Иначе
		СобытияФормИСМПКлиентПереопределяемый.УстановитьПараметрыВыбораКонтрагента(ЭтаФорма, Неопределено, "Контрагент");
		УстановитьПараметрыВыбораКлассификаторСтранМира(ЭтаФорма, Неопределено, "СтранаПроисхожденияПолеВвода");
	КонецЕсли;
...
Процедура ТребуетсяИндивидуализацияПриИзменении(Элемент)
	...
	ОписаниеОповещенияОЗавершении = Новый ОписаниеОповещения("ВопросПриИзмененииТребуетсяИндивидуализацияЗавершение", ЭтаФорма, Действия);
...
Процедура ХарактеристикаПриИзменении(Элемент)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриИзмененииХарактеристики(ЭтаФорма, ЭтаФорма, КэшированныеЗначения);
...
Процедура ХарактеристикаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СобытияФормИСМПКлиентПереопределяемый.ПриНачалеВыбораХарактеристики(
		Элемент, ЭтаФорма, СтандартнаяОбработка);
...
Процедура СерияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ПараметрыУказанияСерий <> Неопределено Тогда
		ИнтеграцияИСКлиент.ОткрытьПодборСерий(ЭтаФорма, ПараметрыУказанияСерий, Элемент.ТекстРедактирования, СтандартнаяОбработка, ЭтаФорма);
	КонецЕсли;
...
Процедура ИдентификаторПроисхожденияВЕТИСНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ПараметрыОткрытия, ЭтаФорма, "Номенклатура, Характеристика, Серия, ХарактеристикиИспользуются");
...
Процедура СертификацияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ИспользоватьНомерСкважины = ИнтеграцияИСМПКлиентСервер.ИспользоватьНомерСкважины(ЭтаФорма);
...
Процедура ТоварыПриАктивизацииЯчейки(Элемент)
	...
	ИначеЕсли Элемент.ТекущийЭлемент = Элементы.ТоварыЛицензияНаПользованиеНедрами Тогда
		...
		ИнтеграцияИСМПКлиент.ОбновитьСписокВыбораСертификации(ЭтаФорма, НастройкиРаботыССертификацией);
...
Процедура ДанныеОтчетаПроизводственнойЛинииПередУдалением(Элемент, Отказ)
	...
	Если СтрокиКОбработке.Количество() Тогда
		...
		Если ЕстьИерархия Тогда
			...
			ОписаниеОповещения = Новый ОписаниеОповещения("ПослеИзмененияРежимУдаленияСтрокиОтчета", ЭтаФорма, ДополнительныеПараметры);
...
Процедура ЗаполнитьПараметрыТовары(Команда)
	...
	ОповещениеЗакрытияФормыЗаполненияТовары = Новый ОписаниеОповещения(
		"Подключаемый_ЗаполнениеПараметровТовары", ЭтаФорма, Элементы.Товары.ВыделенныеСтроки);
...
Процедура ЗаполнитьВидМеха(Команда)
	...
	ОткрытьФорму("Справочник.ВидыМехаГИСМ.Форма.ФормаВыбора", ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения);
...
Процедура ЗапроситьКлючСессииНачало(ПараметрыПроверки)
	...
	ОповещениеПриЗапросеКлючаСессии = Новый ОписаниеОповещения("ЗапроситьКлючСессииЗавершение", ЭтаФорма, ПараметрыПроверки);
...
Процедура ОбработатьНажатиеНавигационнойСсылки(НавигационнаяСсылкаФорматированнойСтроки)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "СоздатьШтрихкодыУпаковок" Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения("СозданиеШтрихкодовУпаковокЗавершение", ЭтаФорма);
...
Процедура ОбработкаРезультатаПодбораНоменклатуры(ВыбранноеЗначение, КэшированныеЗначения)
	...
	Если ДобавленныеСтроки.Количество() Тогда
		...
		Если ВременнаяТаблица.Количество() Тогда
			ИнтеграцияИСМПКлиентСервер.ОбновитьКешСертификацииПоСтатистике(ЭтаФорма, ВременнаяТаблица);
		КонецЕсли;
		
		ИнтеграцияИСМПКлиентСервер.ДобавитьСертификатыНоменклатурыВКэш(ЭтаФорма, СписокНоменклатуры);
		ИнтеграцияИСМПКлиентСервер.ЗаполнитьСертификациюЛицензииНоменклатурыПоСтроке(ЭтаФорма, ДобавленныеСтроки);
...
Процедура ПриСозданииЧтенииНаСервере()
	...
	ОбновитьПредставлениеТребуетсяИндивидуализация(ЭтаФорма);
	
	ЗаполнитьСлужебныеРеквизитыНоменклатуры(ЭтаФорма, Ложь);
	ЗаполнитьСлужебныеРеквизитыВЕТИСВКоллекции();
	...
	ЗаполнитьДоступныеВариантыЗаполненияДекларации(ЭтаФорма);
	...
	ИнтеграцияИСМП.СоздатьКэшСертификацииЛицензии(ЭтаФорма);
	...
	Если Объект.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотТрансграничнаяТорговля Тогда
		...
		УстановитьПараметрыВыбораКлассификаторСтранМира(ЭтаФорма, Истина, "СтранаПроисхожденияПолеВвода");
	Иначе
		СобытияФормИСМППереопределяемый.УстановитьПараметрыВыбораКонтрагента(ЭтаФорма, Неопределено, "Контрагент");
		УстановитьПараметрыВыбораКлассификаторСтранМира(ЭтаФорма, Неопределено, "СтранаПроисхожденияПолеВвода");
	КонецЕсли;
	...
	Если Не РедактированиеФормыНедоступно Тогда
		...
		ПроверкаИПодборПродукцииИС.ЗаполнитьКешШтрихкодовУпаковок(ЭтаФорма, Настройки);
		ПроверкаИПодборПродукцииИС.ПрименитьКешШтрихкодовУпаковок(ЭтаФорма, Настройки,, КлючСвязиСтатусаСтрок(ЭтаФорма));
	КонецЕсли;
...
Процедура ОткрытьФормуРедактированияТаможеннойДекларации(ИдентификаторыСтрок)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ЗаполнениеТаможеннойДекларацииЗавершение", ЭтаФорма, ДополнительныеПараметры);
...
Процедура СоздатьКэшТаможеннойДекларации()
	...
	Для Каждого СтрокаТовары Из Объект.Товары Цикл
		...
		ОбновитьКэшТаможеннойДекларацииКлиентСервер(
			ЭтаФорма, СтрокаТовары.РегистрационныйНомерДекларации,
	...
	ДобавитьРегистрациюДТВКэш(ЭтаФорма, СписокНоменклатуры);
...
Процедура ЗаполнениеСертификацииЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если ВариантУточненияДанных = "Лицензия" Тогда
		...
		Иначе
			...
			Для Каждого ИдентификаторСтроки Из ДополнительныеПараметры.ИдентификаторыСтрок Цикл
				...
				ИнтеграцияИСМПКлиентСервер.ОбновитьКэшЛицензииНаПользованиеНедрами(ЭтаФорма, ДанныеЗаполнения);
	...
	Иначе
		...
		ДанныеЗаполненияСертификации.ИспользоватьНомерСкважины = ИнтеграцияИСМПКлиентСервер.ИспользоватьНомерСкважины(ЭтаФорма);
		...
		Иначе
			...
			Для Каждого ИдентификаторСтроки Из ДополнительныеПараметры.ИдентификаторыСтрок Цикл
				...
				ИнтеграцияИСМПКлиентСервер.ОбновитьКэшСертификации(ЭтаФорма, ДанныеЗаполненияСертификации, ДанныеСтроки.Номенклатура);
...
Процедура ЗаполнениеТаможеннойДекларацииЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	ОбновитьКэшТаможеннойДекларацииКлиентСервер(
		ЭтаФорма, ДанныеСтроки.РегистрационныйНомерДекларации, ДанныеСтроки.ДатаДекларации);
...
Процедура ОбработатьКодМаркировки(ИсходныеДанные, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ШтрихкодированиеИСМПКлиент.ОбработатьСобытиеПотоковойПечати(ЭтаФорма, ИсходныеДанные, ПараметрыСканирования);
...
Процедура ОбработатьДобавленныеИзмененныеСтроки(ДобавленныеСтроки, ИзмененныеСтроки, КэшированныеЗначения)
	...
	Для Каждого ДобавленнаяСтрока Из ДобавленныеСтроки Цикл
		...
		СобытияФормИСМППереопределяемый.ПриИзмененииНоменклатуры(
			ЭтаФорма, ДобавленнаяСтрока, КэшированныеЗначения, ПараметрыУказанияСерий);
	...
	Для Каждого ИзмененнаяСтрока Из ИзмененныеСтроки Цикл
		...
		Иначе
			СобытияФормИСМППереопределяемый.ПриИзмененииКоличестваЕдиниц(
				ЭтаФорма, ИзмененнаяСтрока, КэшированныеЗначения, ПараметрыУказанияСерий);
		КонецЕсли;
	КонецЦикла;
...
Процедура ВопросПриИзмененииОперацииЗавершение(РезультатВопроса, Действия) Экспорт
	...
	ИначеЕсли Действия.ОчиститьТНВЭД Или Действия.ОчиститьВидМеха Тогда
		ОчиститьНеиспользуемыеКолонкиТаблицыТовары(ЭтаФорма, Действия);
	КонецЕсли;
...
Процедура ОперацияНанесенияПриИзмененииНаСервере()
	...
	ОчиститьНеиспользуемыеКолонкиТаблицыТовары(ЭтаФорма);
...
Процедура НоменклатураПриИзмененииСервер(ЗаполнитьЗначения = Истина, ЗаполнитьКодТНВЭД = Истина)
	...
	ЗаполнитьСлужебныеРеквизитыНоменклатуры(ЭтаФорма, ЗаполнитьКодТНВЭД);
	
	Если ЗначениеЗаполнено(Номенклатура) Тогда
		
		ЕстьИдентификаторВЕТИС = ИспользуетсяУказаниеИдентификатораВЕТИС(ЭтаФорма);
		Если ЗначениеЗаполнено(Объект.ДокументОснование) Тогда
...
Процедура ОткрытьФормуНастройкиВидовУпаковокПоGTIN(АдресУточнениеКоэффициентовУпаковок)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("УточнениеКоэффициентовУпаковокЗавершение", ЭтаФорма);
		...
		Если ЗначениеЗаполнено(EAN) Тогда
				...
				Если НайденныеСтрокиНоменклатура.Количество() > 0 Тогда
					...
					Если ЗначениеЗаполнено(Характеристика) Тогда
						...
						Если НайденныеСтрокиНоменклатураХарактеристика.Количество() = 0 Тогда
							ЗаполнитьЗначенияСвойств(ЭтаФорма, НайденныеСтрокиНоменклатура[0],"Характеристика");
			...
			Если НайденныеСтроки <> Неопределено 
				...
				ИначеЕсли (Номенклатура <> НайденныеСтроки[0].Номенклатура
					...
					ЗаполнитьЗначенияСвойств(ЭтаФорма, НайденныеСтроки[0],"Номенклатура, Характеристика, Серия");
					НоменклатураПриИзмененииСервер(Ложь);
...
//
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьПараметрыВыбораКлассификаторСтранМира(Форма, ТолькоСтраныУчастникиЕАЭС = Неопределено, ИмяПоляВвода = "Страна")
...
Процедура ЗаполнитьТаблицуДанныхДокументаОснования()
	...
	Если ЗаполнятьДанныеВЕТИС Тогда
		...
		Если ЭтоПродукцияПодконтрольнаяВЕТИС И ТаблицаДанныхДокументаОснования.Колонки.Найти("ДанныеИдентификатораПроисхожденияВЕТИС") <> Неопределено Тогда
			...
			ТаблицаДанныхДокументаОснования.Колонки.Добавить("ИдентификаторПроисхожденияВЕТИС", ОпределяемыеТипы().ИдентификаторПроисхожденияВЕТИС.Тип);
...
Процедура ЗаполнитьДанныеФормыПриСозданииНаСервере()
	...
	ЗаполнитьЗначенияСвойств(ЭтаФорма, Объект, "Номенклатура, Характеристика, Серия, КодТНВЭД, ИдентификаторПроисхожденияВЕТИССтрокой");
...
Процедура ЗаполнитьСписокВыбораПриСозданииНаСервере()
	...
	Если ЗначениеЗаполнено(Объект.ДокументОснование) Тогда
		...
		Если Объект.ОтчетПроизводственнойЛинии Тогда
			...
			ЗаполнитьСписокВыбораЭлементовШапки(Истина, ИспользуетсяУказаниеИдентификатораВЕТИС(ЭтаФорма));
...
Процедура ЗаполнитьСписокВыбораЭлементаФорма(ИмяЭлемента, СтруктураОтбора = Неопределено, ЗаполнитьЗначения = Истина)
	...
	Если ЗаполнитьЗначения Тогда
		...
		Если СгруппированнаяТаблица.Количество() = 1 Тогда
			...
			Иначе
				ЭтаФорма[ИмяЭлемента] = СгруппированнаяТаблица[0][ИмяЭлемента];
			КонецЕсли;
		КонецЕсли;
...
Процедура ТоварыНоменклатураПриИзмененииСервер(ТребуетсяОбновитьКэшУпаковок)
	...
	Если ЗначениеЗаполнено(ДанныеСтроки.Номенклатура) Тогда
		...
		Если ВременнаяТаблица.Количество() Тогда
			...
			Если ИнтеграцияИСМПКлиентСервер.ИспользоватьНомерСкважины(ЭтаФорма) Тогда
		...
		ИнтеграцияИСМПКлиентСервер.ДобавитьСертификатыНоменклатурыВКэш(ЭтаФорма, СписокНоменклатуры);
		ИнтеграцияИСМПКлиентСервер.ЗаполнитьСертификациюЛицензииНоменклатурыПоСтроке(ЭтаФорма, ТекущаяСтрока);
