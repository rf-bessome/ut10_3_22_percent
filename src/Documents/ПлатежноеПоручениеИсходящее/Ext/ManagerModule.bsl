...
Функция РеквизитыПлатежаВБюджет(Объект) Экспорт
	...
	Если ТипЗнч(РеквизитыПлатежаВБюджет.ДатаДокумента) = Тип("Дата") Тогда
		...
		Иначе
			...
			Реквизиты = ОбщегоНазначения.СкопироватьРекурсивно(РеквизитыПлатежаВБюджет, Ложь);
			Изменения = ПлатежиВБюджетКлиентСервер.ИсправитьЗначенияРеквизитов("ОснованиеПлатежа", Реквизиты, Контекст);
			Если Изменения.Свойство("ДатаДокумента") Тогда
				РеквизитыПлатежаВБюджет.ДатаДокумента = Изменения.ДатаДокумента;
			Иначе
