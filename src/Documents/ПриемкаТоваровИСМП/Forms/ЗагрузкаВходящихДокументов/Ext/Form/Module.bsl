...
Процедура ОрганизацияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыОткрытияФормы.Вставить("Организации", ЭтаФорма.Организации.ВыгрузитьЗначения());
	
	ОткрытьФорму(
		"ОбщаяФорма.ФормаВыбораСпискаОрганизацийИСМП",
		ПараметрыОткрытияФормы,
		ЭтаФорма,,,,
		Новый ОписаниеОповещения("ПослеЗавершенияВыбораОрганизаций", ЭтаФорма));
КонецПроцедуры

&НаКлиенте
Процедура ОрганизацияОчистка(Элемент, СтандартнаяОбработка)
	ЭтаФорма.Организации.Очистить();
	ОбновитьПредставлениеОрганизации(Организации, ОрганизацииПредставление);
КонецПроцедуры
...
Процедура ЗагрузитьВходящиеДокументы(Команда)
	...
	Если ПроверитьЗаполнение() Тогда
		...
		ПараметрыОтбора.Вставить("Организация",   ИнтеграцияИСМПКлиент.ОрганизацииДляОбмена(ЭтаФорма));
