...
Функция ПечатьТОРГ4()
	...
	|		Количество * ЕдиницаИзмерения.Вес КАК МассаНетто,
	|		Количество * ЕдиницаИзмерения.Вес КАК МассаБрутто,
	...
	|		Количество КАК КоличествоШтук,
	|		Количество * Номенклатура.ЕдиницаХраненияОстатков.Вес КАК МассаНетто,
	|		Количество * Номенклатура.ЕдиницаХраненияОстатков.Вес КАК МассаБрутто,
	...
	Пока ВыборкаСтрокТара.Следующий() Цикл
		...
		ИтогоМассаБруттоПоСтранице = ИтогоМассаБруттоПоСтранице + ВыборкаСтрокТара.МассаБрутто;
		ИтогоМассаНеттоПоСтранице  = ИтогоМассаНеттоПоСтранице  + ВыборкаСтрокТара.МассаНетто;

		// Обновим итогов по документу
		ИтогоМест        = ИтогоМест        + ВыборкаСтрокТара.КоличествоМест;
		ИтогоШтук        = ИтогоШтук        + ВыборкаСтрокТара.КоличествоШтук;
		ИтогоМассаБрутто = ИтогоМассаБрутто + ВыборкаСтрокТара.МассаБрутто;
		ИтогоМассаНетто  = ИтогоМассаНетто  + ВыборкаСтрокТара.МассаНетто;
