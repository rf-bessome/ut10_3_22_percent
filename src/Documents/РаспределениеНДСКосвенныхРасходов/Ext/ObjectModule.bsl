...
Процедура РассчитатьВыручку() Экспорт
	...
	Если Не Отказ Тогда
		УчетНДС.РассчитатьВыручкуДляНДС(
			...
			ВыручкаЕНВД, ВыручкаБезНДС, ВыручкаНДС0, ВыручкаНДС, ВыручкаНДС0ТоварыНесырьевые, ВыручкаУслугиНеНаТерриторииРФ);
	КонецЕсли;
...
Процедура ПроверитьЗаполнениеТабличнойЧастиСоставКосвенныхРасходов(ТаблицаКосвенныхРасходов, Отказ, Заголовок)
	...
	ВыручкаНДС0ТоварыНесырьевыеПоРегистру   = 0;
	ВыручкаУслугиНеНаТерриторииРФПоРегистру = 0;
	...
	Если Не Отказ Тогда
		УчетНДС.РассчитатьВыручкуДляНДС(
			Организация, НачалоПериода, КонецПериода, 
			ВыручкаЕНВДПоРегистру, ВыручкаБезНДСПоРегистру, ВыручкаНДС0ПоРегистру, ВыручкаНДСПоРегистру, ВыручкаНДС0ТоварыНесырьевыеПоРегистру, ВыручкаУслугиНеНаТерриторииРФПоРегистру);
	КонецЕсли;
