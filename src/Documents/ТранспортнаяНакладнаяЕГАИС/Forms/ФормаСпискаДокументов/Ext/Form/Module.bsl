...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияЕГАИС.УстановитьВидимостьКомандыОформленияДокумента(ЭтаФорма, Метаданные.Документы.ТранспортнаяНакладнаяЕГАИС, "СписокКОформлениюОформитьТранспортнаяНакладнаяЕГАИС");
	
	ИнтеграцияЕГАИС.УстановитьВидимостьКомандыВыполнитьОбмен(ЭтаФорма, "СписокГруппаОбменЕГАИСВыполнитьОбмен");
