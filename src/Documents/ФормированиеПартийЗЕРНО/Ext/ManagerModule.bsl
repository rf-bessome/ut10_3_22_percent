	...
	Если ЭтоПереработчик Тогда
		...
		Для Каждого СтрокаПартии Из Товары Цикл
			...
			Если Шапка.Операция = Перечисления.ВидыОперацийЗЕРНО.ФормированиеПартииИзОстатков Тогда
				...
				ЭлементПартииXDTO = ИнтеграцияИС.ОбъектXDTOПоИмениСвойства(ПространствоИмен, "GpbFromResidues", ФормированиеПартииXDTO);
			...
			ИначеЕсли Шапка.Операция = Перечисления.ВидыОперацийЗЕРНО.ФормированиеПартииИмпорт Тогда
				...
				ЭлементПартииXDTO = ИнтеграцияИС.ОбъектXDTOПоИмениСвойства(ПространствоИмен, "GpbFromImport", ФормированиеПартииXDTO);
				
				ПроисхождениеXDTO = ИнтеграцияИС.ОбъектXDTOПоИмениСвойства(
	...
	Иначе
		...
		Для Каждого СтрокаПартии Из Товары Цикл
			...
			Если Шапка.Операция = Перечисления.ВидыОперацийЗЕРНО.ФормированиеПартииИзОстатков Тогда
				...
				ЭлементПартииXDTO = ИнтеграцияИС.ОбъектXDTOПоИмениСвойства(ПространствоИмен, "LotFromResidues", ФормированиеПартииXDTO);
			...
			ИначеЕсли Шапка.Операция = Перечисления.ВидыОперацийЗЕРНО.ФормированиеПартииПоРезультатамГосмониторинга Тогда
				...
				ЭлементПартииXDTO = ИнтеграцияИС.ОбъектXDTOПоИмениСвойства(ПространствоИмен, "LotFromField", ФормированиеПартииXDTO);
			...
			ИначеЕсли Шапка.Операция = Перечисления.ВидыОперацийЗЕРНО.ФормированиеПартииИмпорт Тогда
				...
				ЭлементПартииXDTO = ИнтеграцияИС.ОбъектXDTOПоИмениСвойства(ПространствоИмен, "LotFromImport", ФормированиеПартииXDTO);
			...
			ИначеЕсли Шапка.Операция = Перечисления.ВидыОперацийЗЕРНО.ФормированиеПартииПриСбореУрожая Тогда
				...
				ЭлементПартииXDTO = ИнтеграцияИС.ОбъектXDTOПоИмениСвойства(ПространствоИмен, "LotFromHarvestedCrop", ФормированиеПартииXDTO);
