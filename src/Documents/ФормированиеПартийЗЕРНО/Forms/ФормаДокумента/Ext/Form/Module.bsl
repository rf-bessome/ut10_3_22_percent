...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДокументОснование.ДоступныеТипы = ОпределяемыеТипы().ОснованиеФормированиеПартииЗЕРНО.Тип;
	...
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСНоменклатурой(
		ЭтаФорма, "ТоварыБезРазбиенияХарактеристика", "Номенклатура");
	СобытияФормИСПереопределяемый.УстановитьСвязиПараметровВыбораСНоменклатурой(
		ЭтаФорма, "ТоварыБезРазбиенияСерия", "Номенклатура");
...
Процедура ВидПродукцииОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если Объект.Товары.Количество() > 0 И ВыбранноеЗначение <> Объект.ВидПродукции Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения("ВопросПриИзмененииВидПродукцииПриЗавершении", ЭтаФорма, ВыбранноеЗначение);
...
Процедура ТоварыБезРазбиенияНоменклатураПриИзменении(Элемент)
	...
	ЗаполнитьЗначенияСвойств(ТекущиеДанные, ЭтаФорма, СтрСоединить(СлужебныеРеквизиты, ","));
...
Процедура ТоварыБезРазбиенияМестоположениеПриИзменении(Элемент)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаПриИзменении(ЭтаФорма, Элемент, "Товары.Местоположение");
...
Процедура ТоварыБезРазбиенияМестоположениеОчистка(Элемент, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаОчистка(ЭтаФорма, Элемент, СтандартнаяОбработка, ДополнительныеПоля, "Товары.Местоположение");
...
Процедура ТоварыБезРазбиенияМестоположениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаНачалоВыбора(ЭтаФорма, Элемент, ДанныеВыбора, СтандартнаяОбработка, "Товары.Местоположение");
...
Процедура ТоварыБезРазбиенияМестоположениеОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаОбработкаВыбора(
		ЭтаФорма, Элемент, ВыбранноеЗначение, СтандартнаяОбработка, ДополнительныеПоля, "Товары.Местоположение");
...
Процедура ТоварыБезРазбиенияПроисхождениеПриИзменении(Элемент)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаПриИзменении(ЭтаФорма, Элемент, "Товары.Происхождение");
...
Процедура ТоварыБезРазбиенияПроисхождениеОчистка(Элемент, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаОчистка(ЭтаФорма, Элемент, СтандартнаяОбработка, , "Товары.Происхождение");
...
Процедура ТоварыБезРазбиенияПроисхождениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаНачалоВыбора(ЭтаФорма, Элемент, ДанныеВыбора, СтандартнаяОбработка, "Товары.Происхождение");
...
Процедура ТоварыБезРазбиенияПроисхождениеОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаОбработкаВыбора(
		ЭтаФорма, Элемент, ВыбранноеЗначение, СтандартнаяОбработка, , "Товары.Происхождение");
...
Процедура ТоварыБезРазбиенияПроисхождениеАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаАвтоПодбор(ЭтаФорма, "ЗемельныйУчастокИС",
		Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка);
		...
		Если Не ЗначениеЗаполнено(ТекущиеДанные.Идентификатор) Или Копирование Тогда
			Если Копирование Тогда
				...
				ИнтеграцияЗЕРНОКлиентСервер.СкопироватьДанныеТабличныхЧастейПоСтроке(
					ЭтаФорма, ТекущиеДанные.Идентификатор, "ИдентификаторСтрокиТоваров", НовыйИдентификаторСтроки);
...
Процедура ТоварыПередУдалением(Элемент, Отказ)
	...
	ИнтеграцияЗЕРНОКлиентСервер.ОчиститьДанныеТабличныхЧастейПоСтроке(ЭтаФорма, ТекущиеДанные.Идентификатор, "ИдентификаторСтрокиТоваров");
...
Процедура ТоварыПриАктивизацииЯчейки(Элемент)
	...
	Если Элемент.ТекущийЭлемент = Элементы.ТоварыКодТНВЭД Тогда
		ИнтеграцияЗЕРНОКлиентСервер.ОбновитьСписокВыбораКодаТНВЭД(ЭтаФорма, Элементы.Товары.ТекущиеДанные.ОКПД2);
	КонецЕсли;
...
Процедура ТоварыПроисхождениеОчистка(Элемент, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ПолеАдресаОчистка(ЭтаФорма, Элемент, СтандартнаяОбработка)
...
Процедура СвернутьРазвернутьПанель(Команда)
	...
	НастроитьЗависимыеЭлементыФормы(ЭтаФорма, Элементы.Товары.ТекущаяСтрока, "ПанельДополнительныеСвойстваСвернута");
...
Процедура ОткрытьПодбор(Команда)
	...
	СобытияФормЗЕРНОКлиентПереопределяемый.ОткрытьФормуПодбораНоменклатуры(ЭтаФорма, ОписаниеОповещения);
...
Процедура ЗаполнитьМестоположение(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ЗаполнениеМестоположенияЗавершение", ЭтаФорма, ДополнительныеПараметры);
...
Процедура СкопироватьСвойстваПартии(Команда)
	...
	ОткрытьФорму("Справочник.РеестрПартийЗЕРНО.Форма.ФормаВыбора",
		...
		Новый ОписаниеОповещения("ВыборПартииЗавершение", ЭтаФорма, ДополнительныеПараметры)
		, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура УстановитьУсловноеОформление()
	...
	СобытияФормЗЕРНО.УстановитьУсловноеОформлениеКоличестваДляПустойНоменклатуры(ЭтаФорма);
	
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(
		ЭтаФорма, "ТоварыБезРазбиенияХарактеристика", "ХарактеристикиИспользуются"); 
	СобытияФормИСПереопределяемый.УстановитьУсловноеОформлениеСерийНоменклатуры(
		ЭтаФорма, "ТоварыБезРазбиенияСерия", "СтатусУказанияСерий", "ТипНоменклатуры");
	СобытияФормЗЕРНО.УстановитьУсловноеОформлениеКоличестваДляПустойНоменклатуры(
		ЭтаФорма, "ТоварыБезРазбиенияКоличество");
	
	СобытияФормЗЕРНО.УстановитьУсловноеОформлениеОКПД2(ЭтаФорма);
	
	СобытияФормЗЕРНО.УстановитьУсловноеОформлениеПотребительскогоСвойства(ЭтаФорма);
	СобытияФормЗЕРНО.УстановитьУсловноеОформлениеПотребительскогоСвойства(ЭтаФорма, "ПотребительскиеСвойстваПоСтрокеЗначение");
	
	СобытияФормЗЕРНО.УстановитьУсловноеОформлениеПотребительскогоСвойстваДиапазон(ЭтаФорма);
	СобытияФормЗЕРНО.УстановитьУсловноеОформлениеПотребительскогоСвойстваДиапазон(ЭтаФорма, "ПотребительскиеСвойстваПоСтрокеЗначение");
...
Процедура ПриСозданииЧтенииНаСервере()
	...
	ИнтеграцияЗЕРНОКлиентСервер.УстановитьПараметрыВыбораНоменклатуры(ЭтаФорма, Объект.ВидПродукции);
	ИнтеграцияЗЕРНОКлиентСервер.УстановитьПараметрыВыбораНоменклатуры(ЭтаФорма, Объект.ВидПродукции, "ТоварыБезРазбиенияНоменклатура");
	
	ЗаполнитьДоступныеОперации();
	ЗаполнитьДоступныеЦелиИспользования(ЭтаФорма);
	ЗаполнитьНазначениеПартии(ЭтаФорма);
	ЗаполнитьГодУрожая(ЭтаФорма);
	...
	ОбновитьПодсказкуВводаВладелецПартииТоваропроизводитель(ЭтаФорма);
	ОбновитьПодсказкуВводаПодразделения(ЭтаФорма);
...
Процедура ОткрытьФормуЗаполненияКонтактнойИнформации(ИдентификаторыСтрок, ВариантУточненияДанных)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ЗаполнениеКонтактнойИнформацииЗавершение", ЭтаФорма, ДополнительныеПараметры);
	
	УправлениеКонтактнойИнформациейКлиент.ОткрытьФормуКонтактнойИнформации(ПараметрыОткрытия, ЭтаФорма, ОписаниеОповещения);
...
Процедура ОбновитьДанные(Результат = Неопределено, ДополнительныеПараметры) Экспорт
	...
	Если ИмяОбновляемогоПоля = "ТоварыНоменклатура" Или ИмяОбновляемогоПоля = "Номенклатура" Тогда
		...
		Если ИмяОбновляемогоПоля = "Номенклатура" Тогда
			СлужебныеРеквизиты = МассивСлужебныхРеквизитыФормыДляСинхронизации();
			ЗаполнитьЗначенияСвойств(ЭтаФорма, ИзменяемаяСтрока, СтрСоединить(СлужебныеРеквизиты, ","));
		КонецЕсли;
	...
	Если ИмяОбновляемогоПоля = "НазначениеПартии" Тогда
		...
		Если ИнтеграцияЗЕРНОКлиентСервер.ТребуетсяЗаполнениеКодаТНВЭД(Объект.НазначениеПартии) Тогда
			...
			Для Каждого СтрокаТовары Из Объект.Товары Цикл
				НайденноеЗначениеТНВЭД = ИнтеграцияЗЕРНОКлиент.КодТНВЭДПоДаннымКеша(СтрокаТовары.ОКПД2, СтрокаТовары.КодТНВЭД, ЭтаФорма);
	...
	Если ДополнительныеПараметры.Свойство("ИдентификаторСтроки") Тогда
		НастроитьЗависимыеЭлементыФормы(ЭтаФорма, ДополнительныеПараметры.ИдентификаторСтроки, СтрСоединить(МассивПолейДляНастройки, ","));
	Иначе
		НастроитьЗависимыеЭлементыФормы(ЭтаФорма, Элементы.Товары.ТекущаяСтрока, СтрСоединить(МассивПолейДляНастройки, ","));
	КонецЕсли;
...
Процедура ОбновитьДанныеНаСервере(Результат, ДополнительныеПараметры, КэшированныеЗначения)
		...
		Если Не ЗначениеЗаполнено(ТекущаяСтрока.ОКПД2) Тогда
			...
			Если ДанныеРезультатовИсследования.ОКПД2 <> ТекущаяСтрока.ОКПД2 Тогда
				...
				Если ПотребительскиеСвойства <> Неопределено Тогда
					ИнтеграцияЗЕРНО.ОбновитьКэшПотребительскихСвойств(ЭтаФорма, ПотребительскиеСвойства, ТекущаяСтрока.ОКПД2);
				КонецЕсли;
				
				ЗаполнитьПотребительскиеСвойстваПродукции(ЭтаФорма, ТекущаяСтрока.Идентификатор, ПотребительскиеСвойства);
	...
	Если ДополнительныеПараметры.Свойство("ОбновитьПотребительскиеСвойства", ОбновитьПотребительскиеСвойства)
		...
		Если ИмяОбновляемогоПоля = "Операция" Или ИмяОбновляемогоПоля = "НазначениеПартии"
			...
			Если ПотребительскиеСвойства <> Неопределено Тогда
				Отбор = Новый Структура("ОКПД2");
				ИнтеграцияЗЕРНО.ОбновитьКэшПотребительскихСвойств(ЭтаФорма, ПотребительскиеСвойства, КодыОКПД2);
				Для Каждого ТекущаяСтрока Из Объект.Товары Цикл
					Отбор.ОКПД2 = ТекущаяСтрока.ОКПД2;
					ПотребительскиеСвойстваТекущейСтроки = ПотребительскиеСвойства.НайтиСтроки(Отбор);
					ЗаполнитьПотребительскиеСвойстваПродукции(ЭтаФорма, ТекущаяСтрока.Идентификатор, ПотребительскиеСвойстваТекущейСтроки);
				КонецЦикла;
		...
		Иначе
			...
			Иначе
				ИнтеграцияЗЕРНОКлиентСервер.ОчиститьДанныеТабличнойЧастиПоСтроке(
					ЭтаФорма, ТекущаяСтрока.Идентификатор, "ИдентификаторСтрокиТоваров", "ПотребительскиеСвойства");
			КонецЕсли;
	...
	Для Каждого СтрокаПотребительскогоСвойства Из Объект.ПотребительскиеСвойства Цикл
		...
		Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
			...
			Если ИнициализироватьТип И СтрокаПотребительскогоСвойства.Значение = Неопределено Тогда
				ИнтеграцияЗЕРНОКлиентСервер.ЗаполнитьСтрокуПотребительскогоСвойства(ЭтаФорма, СтрокаПотребительскогоСвойства, НайденнаяСтрока);
			Иначе
...
Процедура ОбработкаРезультатаПодбораНоменклатуры(ВыбранноеЗначение, КэшированныеЗначения)
	...
	Для Каждого СтрокаТовара Из ДобавленныеСтроки Цикл
		...
		Если ЗначениеЗаполнено(СтрокаТовара.ОКПД2) Тогда
			...
			Если ПотребительскиеСвойстваТекущейСтроки.Количество() Тогда
				ЗаполнитьПотребительскиеСвойстваПродукции(ЭтаФорма, СтрокаТовара.Идентификатор, ПотребительскиеСвойстваТекущейСтроки);
			Иначе
	...
	НастроитьЗависимыеЭлементыФормы(ЭтаФорма, Элементы.Товары.ТекущаяСтрока, "ТоварыНоменклатура");
...
Процедура ОКПД2ПриИзмененииНаКлиенте(ОКПД2, ИзменяемаяСтрока, ДополнительныеПараметры)
	...
	Если ЗначениеЗаполнено(ОКПД2) Тогда
		...
		СвойстваЗаполненыПоДаннымКэша = ИнтеграцияЗЕРНОКлиентСервер.ЗаполнитьПотребительскиеСвойстваПоДаннымКеша(
			ЭтаФорма, ИзменяемаяСтрока.ОКПД2, ИзменяемаяСтрока.Идентификатор);
		ДополнительныеПараметры.Вставить("ОбновитьПотребительскиеСвойства", Не СвойстваЗаполненыПоДаннымКэша);
		
		Если ИнтеграцияЗЕРНОКлиентСервер.ТребуетсяЗаполнениеКодаТНВЭД(Объект.НазначениеПартии) Тогда
			НайденноеЗначениеТНВЭД = ИнтеграцияЗЕРНОКлиент.КодТНВЭДПоДаннымКеша(ИзменяемаяСтрока.ОКПД2, ИзменяемаяСтрока.КодТНВЭД, ЭтаФорма);
			Если НайденноеЗначениеТНВЭД = Неопределено Тогда
				ДополнительныеПараметры.Вставить("ОбновитьКэшВидовСельхозКультур", Истина);
			Иначе
	...
	Иначе
		...
		ИнтеграцияЗЕРНОКлиентСервер.ОчиститьДанныеТабличнойЧастиПоСтроке(
			ЭтаФорма, ИзменяемаяСтрока.Идентификатор, "ИдентификаторСтрокиТоваров", "ПотребительскиеСвойства");
...
Процедура ВопросПриИзмененииВидПродукцииПриЗавершении(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВопроса = КодВозвратаДиалога.Да Тогда
		...
		ОчиститьСлужебныеРеквизитыФормы(ЭтаФорма);
