...
Процедура ДобавитьПолучателя(Команда)
	...
	ОписаниеДобавитьПолучателя_Закрытие = Новый ОписаниеОповещения("ДобавитьПолучателя_Закрытие", ЭтаФорма);
	
	ОткрытьФорму("Справочник." + ЭлектронныеДокументыСлужебныйВызовСервера.ПолучитьИмяПрикладногоСправочника("Контрагенты") + ".ФормаВыбора", 
...
Процедура ДобавитьПолучателя_Закрытие(ЗначениеВыбора, ДополнительныеПараметры) Экспорт
	...
	ОписаниеНастроитьОбменСКонтрагентом_Завершение = Новый ОписаниеОповещения("НастроитьОбменСКонтрагентом_Завершение", ЭтаФорма);
