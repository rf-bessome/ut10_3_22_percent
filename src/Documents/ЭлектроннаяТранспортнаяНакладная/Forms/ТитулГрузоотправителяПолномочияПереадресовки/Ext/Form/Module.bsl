...
Процедура ХранимыеДанныеТитулГрузоотправителяСторонаДокументаПолномочийПереадресовкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтаФорма, Элемент.Имя, Элементы.ТитулГрузоотправителяДокументПолномочийПереадресовкиРеквизитыСторон.ТекущиеДанные);
