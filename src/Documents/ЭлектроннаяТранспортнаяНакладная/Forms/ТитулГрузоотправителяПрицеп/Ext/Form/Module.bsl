...
Процедура ЗаполнитьТитулГрузоотправителяОснованиеВладенияПрицепомРеквизитыСторонНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтаФорма, Элемент.Имя, Элементы.ТитулГрузоотправителяОснованияВладенияПрицепом.ТекущиеДанные);
...
Процедура ТитулГрузоотправителяОснованияВладенияПрицепомВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ЗаполнитьТитулГрузоотправителяОснованиеВладенияПрицепомРеквизитыСторон" Тогда
...
//	ТекущиеДанные = Элемент.ТекущиеДанные;
//	ТекущиеДанные.ЗаполнитьТитулГрузоотправителяОснованиеВладенияПрицепомРеквизитыСторон = "Заполнить";
