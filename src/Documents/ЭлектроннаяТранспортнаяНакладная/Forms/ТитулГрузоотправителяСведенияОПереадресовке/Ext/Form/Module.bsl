...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбменСГИСЭПД.СоздатьЭлементыВводаЗначенийСписка(ЭтаФорма, "ТитулГрузоотправителяОтветственныйЗаПереадресовкуНомераТелефонов", "Телефон");
	ОбменСГИСЭПД.СоздатьЭлементыВводаЗначенийСписка(ЭтаФорма, "ТитулГрузоотправителяОтветственныйЗаПереадресовкуАдресаЭлектроннойПочты", "АдресЭлектроннойПочты");
