...
&НаКлиенте
Процедура ТитулПеревозчикаЗаменыОснованияВладенияПрицепомПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ЗаполнитьТитулПеревозчикаЗаменыОснованиеВладенияПрицепомРеквизитыСторонНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтаФорма, Элемент.Имя, Элементы.ТитулПеревозчикаЗаменыОснованияВладенияПрицепом.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ТитулПеревозчикаЗаменыОснованияВладенияПрицепомВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	Если Поле.Имя = "ЗаполнитьТитулПеревозчикаЗаменыОснованиеВладенияПрицепомРеквизитыСторон" Тогда
...
&НаКлиенте
Процедура ТитулПеревозчикаЗаменыОснованияВладенияПрицепомПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)

	ОбменСГИСЭПДКлиент.ТаблицаПриНачалеРедактирования(Элемент, ЭтаФорма, НоваяСтрока, Копирование);

	ТекущиеДанные = Элемент.ТекущиеДанные;
	//ТекущиеДанные.ЗаполнитьТитулПеревозчикаЗаменыОснованиеВладенияПрицепомРеквизитыСторон = "Заполнить";
