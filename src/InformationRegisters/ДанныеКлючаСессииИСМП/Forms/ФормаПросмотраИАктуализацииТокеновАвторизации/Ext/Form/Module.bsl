	...
	Если Актуализация Тогда
		...
		Если ПредупреждатьОЗакрытии = Истина Тогда
			...
			ПоказатьПредупреждение(
				Новый ОписаниеОповещения("ПослеПредупрежденияОЗакрытии", ЭтаФорма),
...
Процедура ОткрытьФормуТокенаАвторизации(ПараметрыОткрытия)
	...
	ОткрытьФорму(
		...
		ПараметрыОткрытия,
		ЭтаФорма,,,,
		Новый ОписаниеОповещения("ПослеИзмененияТокена", ЭтаФорма));
...
Процедура ДополнитьТокеныДляОбновленияДаннымиСУЗ(ТокеныДляОбновления)
	...
	Таблица.Колонки.Добавить("Организация",            ОпределяемыеТипы().Организация.Тип);
	Таблица.Колонки.Добавить("ПроизводственныйОбъект", ОпределяемыеТипы().ПроизводственныйОбъектИС.Тип);
