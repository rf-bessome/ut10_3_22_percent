...
Функция ИнициализироватьСоставУпаковки() Экспорт
	...
	СоставУпаковки.Колонки.Добавить("Упаковка",           ОпределяемыеТипы().Упаковка.Тип);
...
Функция ИнициализироватьТаблицуДляЗаписиИстории() Экспорт
	...
	ТаблицаДляЗаписиИстории.Колонки.Добавить("Номенклатура",     ОпределяемыеТипы().Номенклатура.Тип);
	ТаблицаДляЗаписиИстории.Колонки.Добавить("Характеристика",   ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	ТаблицаДляЗаписиИстории.Колонки.Добавить("GTIN",             ОпределяемыеТипы().GTIN.Тип);
...
Функция ИнициализироватьТаблицуДляУдаленияИстории(ВключатьХешСумму = Истина) Экспорт
	...
	ТаблицаДляУдаленияИстории.Колонки.Добавить("Номенклатура",   ОпределяемыеТипы().Номенклатура.Тип);
	ТаблицаДляУдаленияИстории.Колонки.Добавить("Характеристика", ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	ТаблицаДляУдаленияИстории.Колонки.Добавить("GTIN",           ОпределяемыеТипы().GTIN.Тип);
