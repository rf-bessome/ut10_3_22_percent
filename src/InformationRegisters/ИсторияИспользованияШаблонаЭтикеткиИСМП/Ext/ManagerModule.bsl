...
Функция ИнициализироватьТаблицуДляЗаписиДанных() Экспорт
	...
	ТаблицаДляЗаписиДанных.Колонки.Добавить("Номенклатура",     ОпределяемыеТипы().Номенклатура.Тип);
	ТаблицаДляЗаписиДанных.Колонки.Добавить("Характеристика",   ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	ТаблицаДляЗаписиДанных.Колонки.Добавить("GTIN",             ОпределяемыеТипы().GTIN.Тип);
	ТаблицаДляЗаписиДанных.Колонки.Добавить("Шаблон",           Новый ОписаниеТипов("ПеречислениеСсылка.ШаблоныКодовМаркировкиСУЗ"));
	ТаблицаДляЗаписиДанных.Колонки.Добавить("ШаблонЭтикетки",   ОпределяемыеТипы().ШаблонЭтикеткиИС.Тип);
