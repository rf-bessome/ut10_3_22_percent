...
Процедура ОформленоОрганизацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ВыборОгранизацииЗавершение = Новый ОписаниеОповещения("ВыборОгранизацииЗавершение", ЭтаФорма);
	ИнтеграцияЗЕРНОКлиент.ОткрытьФормуВыбораОрганизаций(ЭтаФорма, "Оформлено",, ВыборОгранизацииЗавершение);
