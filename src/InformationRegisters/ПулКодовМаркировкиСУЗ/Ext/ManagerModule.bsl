...
Функция СтруктураОтбораДокументаПоТипуДокумента(Документ, ВыбиратьСвязанныеОснования = Ложь) Экспорт
	...
	ИначеЕсли ОпределяемыеТипы()["ОснованиеЗаказНаЭмиссиюКодовМаркировкиИСМП"].Тип.СодержитТип(ТипДокумента) Тогда
...
Функция НоваяТаблицаДанныхДляПечатиЭтикеток() Экспорт
	...
	ТаблицаИтог.Колонки.Добавить("Серия",                ОпределяемыеТипы().СерияНоменклатуры.Тип);
	...
	ТаблицаИтог.Колонки.Добавить("ШаблонЭтикетки",       ОпределяемыеТипы().ШаблонЭтикеткиИС.Тип);
	...
	ТаблицаИтог.Колонки.Добавить("Организация",          ОпределяемыеТипы().Организация.Тип);
	...
	ТаблицаИтог.Колонки.Добавить("GTIN",                 ОпределяемыеТипы().GTIN.Тип);
...
Функция НоваяТаблицаРезультатаРезервирования() Экспорт
	...
	ТаблицаИтог.Колонки.Добавить(
		"Номенклатура", ОпределяемыеТипы().Номенклатура.Тип);
	ТаблицаИтог.Колонки.Добавить(
		"Характеристика", ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	ТаблицаИтог.Колонки.Добавить(
...
Функция ВидимостьШаблонаЭтикетки() Экспорт
	...
	ТипыШаблонаЭтикетки = ОпределяемыеТипы()["ШаблонЭтикеткиИС"].Тип.Типы();
...
Функция ЗаполнитьТаблицуПредставленийКИЗ(КодыМаркировки) Экспорт
	...
	Результат.Колонки.Добавить("GTIN",          ОпределяемыеТипы().GTIN.Тип);
...
Функция ЗапросСвободныхКодовПоЗаказу(Заказ, ТаблицаНоменклатуры, МаркировкаОстатков = Неопределено)
	...
	Иначе
		Запрос.УстановитьПараметр("Заказ", ОпределяемыеТипы()["ОснованиеЗаказНаЭмиссиюКодовМаркировкиИСМП"].Тип.ПривестиЗначение(Заказ));
	КонецЕсли;
