...
Процедура ПриОткрытии(Отказ)
	...
	УстановитьВидимостьЭлементовПоРежимуФормирования(ЭтаФорма);
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ЭтоФормированиеЭтикеток(ЭтаФорма) Тогда
...
Процедура Печать(Команда)
	...
	Иначе
		...
		ОповещениеВопросПечатиОкончание = Новый ОписаниеОповещения(
			"ОтветПользователяПродолженияПечатиОкончание", ЭтаФорма, ДанныеПечати);
...
Процедура СвернутьДеревоУпаковок()
	...
	ФормированиеЭтикеток = ЭтоФормированиеЭтикеток(ЭтаФорма);
...
Функция ПолучитьТаблицуСоставаУпаковки(СтрокиСоставаУпаковки, ПоляДерева)
	...
	ТаблицаСостава.Колонки.Добавить("Номенклатура",         ОпределяемыеТипы().Номенклатура.Тип);
	ТаблицаСостава.Колонки.Добавить("Характеристика",       ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
	ТаблицаСостава.Колонки.Добавить("GTIN",                 ОпределяемыеТипы().GTIN.Тип);
...
Функция ДанныеДляПечатиСвободныеКоды()
	...
	ИтоговаяСтруктура.Вставить("КаждаяЭтикеткаНаНовомЛисте", КаждаяЭтикеткаНаНовомЛисте(ЭтаФорма));
...
Процедура ОтветПользователяПродолженияПечатиОкончание(Ответ, ДанныеПечати) Экспорт
	...
	ПечатьЭтикетокИСМПКлиент.НапечататьЭтикеткиИСМП(ДанныеПечати, ЭтаФорма);
