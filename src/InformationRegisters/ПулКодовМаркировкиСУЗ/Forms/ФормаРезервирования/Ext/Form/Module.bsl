...
Процедура Печать(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПриВыполненииКоманды", ЭтаФорма, Команда);
...
Процедура ЗарезервироватьИЗаказать(Команда)
	...
	Если ЕстьКодыДляРезервирования() Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения("РезервированиеКодовЗавершение", ЭтаФорма);
...
Процедура ОбработатьИПроверитьПереданныеПараметры(Отказ)
	...
	Если НЕ ОпределяемыеТипы().ОснованиеЗаказНаЭмиссиюКодовМаркировкиИСМП.Тип.СодержитТип(ТипЗнч(Параметры.Документ)) Тогда
...
Функция ТаблицаДляРезервирования()
	...
	ТаблицаДляРезервирования.Колонки.Добавить("Ссылка",             ОпределяемыеТипы().ОснованиеЗаказНаЭмиссиюКодовМаркировкиИСМП.Тип);
	ТаблицаДляРезервирования.Колонки.Добавить("Организация",        ОпределяемыеТипы().Организация.Тип);
	...
	ТаблицаДляРезервирования.Колонки.Добавить("Номенклатура",       ОпределяемыеТипы().Номенклатура.Тип);
	ТаблицаДляРезервирования.Колонки.Добавить("Характеристика",     ОпределяемыеТипы().ХарактеристикаНоменклатуры.Тип);
...
Процедура ЗаказатьКодыМаркировки()
	...
	Для Каждого КлючИЗначение Из ВидыПродукции Цикл
		...
		ОписаниеОповещения = Новый ОписаниеОповещения("ПриВыполненииКоманды", ЭтаФорма, Команды.ЗарезервироватьИЗаказать);
