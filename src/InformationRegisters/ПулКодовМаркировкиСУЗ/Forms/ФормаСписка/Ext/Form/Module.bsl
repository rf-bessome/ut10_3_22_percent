...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытияФормИСМП.ЗаполнитьСписокВыбораОрганизацииПоСохраненнымНастройкам(ЭтаФорма, "СписокКодов");
...
Процедура СписокКодовОрганизацииПриИзменении(Элемент)
	...
	ИнтеграцияИСМПКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, Организации, Истина, "СписокКодов");
...
Процедура СписокКодовОрганизацииОчистка(Элемент, СтандартнаяОбработка)
	...
	ИнтеграцияИСМПКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, Неопределено, Истина, "СписокКодов");
...
Процедура СписокКодовОрганизацииОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ИнтеграцияИСМПКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, ВыбранноеЗначение, Истина, "СписокКодов");
...
Процедура СписокКодовОрганизацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ИнтеграцияИСМПКлиент.ОткрытьФормуВыбораОрганизаций(ЭтаФорма, "СписокКодов");
...
Процедура СписокКодовОрганизацияПриИзменении(Элемент)
	...
	ИнтеграцияИСМПКлиент.ОбработатьВыборОрганизаций(ЭтаФорма, Организация, Истина, "СписокКодов");
...
Процедура Печать(Команда)
	...
	СобытияФормИСМПКлиент.ОтрытьФормуПечатиКодовМаркировок(ЭтаФорма, ПараметрыФормыПечати, ОповещениеПриЗакрытии);
...
Процедура ВиртуальнаяАгрегация(Команда)
	...
	ОповещениеПриЗакрытии = Новый ОписаниеОповещения("ПриЗакрытииФормыВиртуальнойАгрегации", ЭтаФорма);
	
	ОткрытьФорму("Обработка.ВиртуальнаяАгрегацияУпаковокИСМП.Форма",
		ПараметрыФормыАгрегации, ЭтаФорма,,,, ОповещениеПриЗакрытии, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура УстановитьТекстОтбораПоДоступнымМетаданнымОснования()
	...
	МетаРеквизитОснование      = ОпределяемыеТипы().ОснованиеЗаказНаЭмиссиюКодовМаркировкиИСМП;
