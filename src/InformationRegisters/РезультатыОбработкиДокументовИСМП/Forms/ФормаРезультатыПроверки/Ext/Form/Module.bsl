...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияИСКлиентСервер.НастроитьОтборПоОрганизации(ЭтаФорма, Организации, "Отбор");
	
	УстановитьОтборПоОрганизации(ЭтаФорма);
	УстановитьОтборПоТипуДокумента(ЭтаФорма);
	УстановитьОтборПоСостояниюОтправки(ЭтаФорма);
	УстановитьОтборПоДокументамСОшибки(ЭтаФорма);
...
Процедура Подключаемый_ПроверитьВыполнениеЗаданияИС()
	...
	СоответствиеТребованиямГИСМТКлиент.ПроверитьВыполнениеЗадания(ЭтаФорма);
...
Процедура Проверить(Команда)
	...
	ПараметрыПроверки.Вставить("Форма",                                 ЭтаФорма);
...
Процедура ОткрытьФормуВыбораПоТипуДокумента()
	...
	ОписаниеЗавершения = Новый ОписаниеОповещения("ПослеВыбораТипаДокумента", ЭтаФорма);
...
Процедура ОткрытьФормуВыбораПоСостояниюОтправки()
	...
	ОписаниеЗавершения = Новый ОписаниеОповещения("ПослеВыбораСостоянияОтправки", ЭтаФорма);
...
Процедура ОткрытьФормуВыбораЗначения(ВыбранныеЗначения, ВсеЗначения, ОписаниеЗавершения, ТекстЗаголовка)
	...
	ОткрытьФорму(
		...
		ЭтаФорма,,,,
		Новый ОписаниеОповещения("ПослеЗавершенияВыбораЗначения", ЭтаФорма, ДополнительныеПараметры));
